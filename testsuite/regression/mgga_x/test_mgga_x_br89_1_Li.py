...
def test_mgga_x_br89_1_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.382820457993923e+00, -1.207209722365355e+00, -4.835212014151215e-01, -1.469642357620209e-01, -8.663174096446655e-02, -1.681406638089178e-01, -4.498275941926601e-02])
...
def test_mgga_x_br89_1_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.870072500051874e+00, -1.871845306341474e+00, -1.735707668326732e+00, -1.737315269220272e+00, -4.055995485807161e-01, -4.054730836946405e-01, -2.236285660481611e-01, -7.646448305005019e-02, -8.185585753592392e-02, -6.783089044196874e-03, -7.636357531806412e-02, -7.604712050371570e-02, -3.583135351455155e-03, -1.532172015683444e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
...
def test_mgga_x_br89_1_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([4.009728676968758e-05, 4.020480242967956e-05, 2.145430871034920e-02, 2.145092173752728e-02, 2.425380554203693e-02, 2.421703962881774e-02, 9.889152870198947e-02, 1.211432033224142e-02, 1.906906033947062e-01, 1.882652911645799e-02, 1.239640493060204e-02, 1.225122106274334e-02, 1.747504840282161e-02, 1.923737696186288e-02])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
