...
def test_mgga_x_m06_l_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.030138794878935e+00, -1.309907982594728e+00, -1.349686563002160e-01, -1.821242650172076e-01, -4.527652279359657e-02, -9.115148941378802e-02, -1.552861059737350e-03])
...
def test_mgga_x_m06_l_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([7.583303787564868e-02, 7.556739411332762e-02, 6.243174869358658e-03, 6.154375242591008e-03, 3.346150654244723e-02, 3.511918663359638e-02, -2.012488522129150e+00, -1.803586846019249e-04, 2.278105336318756e-01, -3.696306054933462e-08, -8.973833717667498e-08, -1.946581160160833e-04, -5.029631185970785e-19, -6.136293873515274e-09])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
