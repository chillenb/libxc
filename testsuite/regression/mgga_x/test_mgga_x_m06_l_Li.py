...
def test_mgga_x_m06_l_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.109143554202172e+00, -1.413294972747361e+00, -3.350928079374445e-01, -1.862786958980162e-01, -7.092815182892111e-02, -9.111902697136208e-02, -1.707706780539315e-03])
...
def test_mgga_x_m06_l_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-3.395997377065974e-04, 0.000000000000000e+00, -3.385207899708005e-04, -1.279759140694216e-03, 0.000000000000000e+00, -1.275476986844759e-03, -3.854968972608994e-02, 0.000000000000000e+00, -3.624108539555278e-02, -5.199581131883313e+00, 0.000000000000000e+00, 3.689483856493438e-01, -6.340076297316975e+01, 0.000000000000000e+00, 2.382516687017495e+00, -1.346987378740997e+00, 0.000000000000000e+00, 3.499139806458657e-01, -5.753143997126903e+00, 0.000000000000000e+00, 2.482638524811092e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
