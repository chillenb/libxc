...
def test_mgga_x_regtm_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.853503147548120e+00, -1.210480560597435e+00, -3.509225144681587e-01, -1.715541069091999e-01, -6.637524576604603e-02, -6.558799535747394e-02, -2.689837550171186e-02])
