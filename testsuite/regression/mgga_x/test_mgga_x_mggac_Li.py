...
def test_mgga_x_mggac_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.993773269564785e+00, -1.316756961346107e+00, -2.712651114111688e-01, -1.824808015584055e-01, -5.847095031186642e-02, -1.337844320753615e-02, -1.993622157921318e-04]
...
def test_mgga_x_mggac_Li_2_vrho():
    ...
    ref_tgt = [-2.784160392826116e+00, -2.786676185456102e+00, -2.006346543559511e+00, -2.007818792365019e+00, -3.622703383908150e-01, -3.621578360675692e-01, -2.483472039803630e-01, -1.702440202814498e-02, -7.869901907732445e-02, -5.399358206332810e-04, -1.790231731833781e-02, -1.777211126097943e-02, -2.878122332846294e-04, -2.046047877826202e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
