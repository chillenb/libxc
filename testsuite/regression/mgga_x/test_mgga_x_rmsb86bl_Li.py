...
def test_mgga_x_rmsb86bl_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.905352631572976e+00, -1.342261489519060e+00, -4.032452043841573e-01, -1.711367563349716e-01, -7.847771831744159e-02, -4.193712059716759e-02, -2.592067620134277e-03]
...
def test_mgga_x_rmsb86bl_Li_2_vtau():
    ...
    ref_tgt = [6.889761904937229e-06, 6.678333457989082e-12, 5.052924530921757e-05, 1.008964802574469e-17, 3.050742439301710e-02, 9.474173849572982e-11, 4.519900671854787e-03, 1.331487878863168e-16, 6.647331675301991e-07, 5.084816222724171e-11, 4.508316359962000e-17, 4.877779946328005e-17, 3.753812954446780e-31, 6.420763410066483e-11]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
