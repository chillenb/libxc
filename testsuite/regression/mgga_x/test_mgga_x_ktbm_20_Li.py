...
def test_mgga_x_ktbm_20_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.000908705507028e+00, -1.308507012505415e+00, -2.610540578946680e-01, -1.852308760998566e-01, -5.529549302069900e-02, -1.065101226805570e-02, -1.998910425209877e-04])
...
def test_mgga_x_ktbm_20_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([2.920981733504290e-02, 2.918267759213949e-02, 3.548818548117648e-02, 3.549461029499876e-02, -2.830291510150826e-03, -2.877089949238418e-03, 3.360324811739620e-01, 7.899610796460225e-05, 7.428673246963478e-03, 6.237012245188106e-06, 1.688330598181494e-06, 8.041179621214504e-05, 2.814416972746813e-11, -9.887823405560174e-12])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
