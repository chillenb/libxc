...
def test_mgga_x_ktbm_20_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.178276477228257e+00, -1.524136379945070e+00, -2.927385116042332e-01, -1.949969209442160e-01, -6.815629052316974e-02, -1.077824120699416e-02, -2.028559451334642e-04]
...
def test_mgga_x_ktbm_20_Li_2_vtau():
    ...
    ref_tgt = [3.625455718023374e-02, 3.621680687381496e-02, 5.573462802356222e-02, 5.571079388318293e-02, 1.908339759270557e-02, 2.080452305577595e-02, 3.798283337688566e-01, 7.899610796460225e-05, 3.333237135321692e-01, 6.237011431191482e-06, -1.125495633330031e-07, 8.041179621214504e-05, -7.489592892217848e-16, 3.023083371933442e-06]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
