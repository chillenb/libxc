...
def test_mgga_x_msb86bl_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.847031482842830e+00, -1.235323985383276e+00, -2.672416042321614e-01, -1.685958840076986e-01, -5.839230992630868e-02, -6.015107247412621e-02, -1.964841620305952e-02]
...
def test_mgga_x_msb86bl_Li_2_vtau():
    ...
    ref_tgt = [1.350175977045206e-02, 1.348115262211374e-02, 2.144221351190459e-02, 2.148086194725527e-02, 7.793571466759304e-04, 8.383362067801131e-04, 9.755022235811134e-02, 4.651148124961707e-15, 3.194874561787618e-02, 8.690071040431456e-13, -7.035939259316857e-16, 1.543396654983670e-15, 6.115459726377587e-12, 9.489552485561723e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
