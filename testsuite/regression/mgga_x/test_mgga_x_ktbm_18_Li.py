...
def test_mgga_x_ktbm_18_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.173270022657789e+00, -1.531069700441768e+00, -2.771365340584860e-01, -1.937873185996120e-01, -6.630482555513881e-02, -9.803074428448362e-03, -1.835039426697459e-04]
...
def test_mgga_x_ktbm_18_Li_2_vrho():
    ...
    ref_tgt = [-2.621445910250648e+00, -2.623969332766020e+00, -1.771060536154856e+00, -1.772286710705109e+00, -3.685802681430238e-01, -3.708093052437639e-01, -2.428659123776196e-01, -1.190902798788981e-02, -9.023348760589911e-02, -3.776212803176268e-04, -1.316147684787765e-02, -1.243222993787274e-02, -2.652472963055304e-04, -1.793119340325329e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
