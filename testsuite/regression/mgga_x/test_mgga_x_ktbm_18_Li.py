...
def test_mgga_x_ktbm_18_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.993514778332794e+00, -1.310103619130504e+00, -2.421572605989154e-01, -1.839450410540251e-01, -5.279934648905805e-02, -9.779817031248724e-03, -1.828327213831853e-04]
...
def test_mgga_x_ktbm_18_Li_2_vtau():
    ...
    ref_tgt = [2.561632622479461e-02, 2.558609704315270e-02, 3.396220089537658e-02, 3.395503519818345e-02, -5.174271188398933e-04, -4.622506391002739e-04, 2.833769568153353e-01, 1.770170856524248e-04, 4.204548835300757e-02, 1.408320055428617e-05, 3.811660553547743e-06, 1.801053362153173e-04, 6.355090578489358e-11, -6.081884953856840e-12]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
