...
def test_mgga_x_gdme_nv_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([1.467657737048269e+01, -1.271797086510167e+00, 1.202297303755625e-01, -1.733417610960458e-01, -1.506334539131612e-02, 4.795631080231802e+02, 4.226094874618420e+07])
