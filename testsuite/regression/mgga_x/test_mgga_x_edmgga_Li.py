...
def test_mgga_x_edmgga_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.377240932520893e+00, -1.234905913687411e+00, -4.947455676945538e-01, -1.503655346207629e-01, -8.673677864984147e-02, -1.566142620058618e-01, -4.174868999706228e-02]
...
def test_mgga_x_edmgga_Li_2_vlapl():
    ...
    ref_tgt = [-7.051490768767839e-06, -7.071833860544934e-06, -4.527651016200751e-03, -4.523812921433237e-03, -6.692302445587491e-03, -6.680242488733192e-03, -3.038932917157857e-02, -2.759346603702367e-03, -5.462152674918462e-02, -4.382872317483164e-03, -2.822209153781553e-03, -2.789509455773085e-03, -4.080145006575931e-03, -4.498017986363379e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
