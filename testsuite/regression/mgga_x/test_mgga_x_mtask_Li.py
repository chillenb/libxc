...
def test_mgga_x_mtask_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.042462005003014e+00, -1.337193027796430e+00, -9.969129603860488e-02, -1.895534906925928e-01, -3.665136297108270e-02, -5.292504163495639e-03, -7.198921264329634e-07])
