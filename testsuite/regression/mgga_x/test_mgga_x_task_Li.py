...
def test_mgga_x_task_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.963565655996748e+00, -1.318707048753535e+00, -1.641777123396462e-01, -1.789559392101754e-01, -4.269262876116411e-02, -4.816589056338742e-03, -2.193952037138248e-05])
