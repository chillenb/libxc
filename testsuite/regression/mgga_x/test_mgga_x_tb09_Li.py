...
def test_mgga_x_tb09_Li_2_vrho():
    # Prepare the input
    inp = test_data["Li"]
...
def test_mgga_x_tb09_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
...
def test_mgga_x_tb09_Li_2_vtau():
    # Prepare the input
    inp = test_data["Li"]
