...
def test_mgga_x_revtpss_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.996937807965659e+00, -1.384502134830239e+00, -3.792841441119765e-01, -1.790679594718642e-01, -7.440283338789914e-02, -2.053745905397894e-02, -3.838585904368181e-04])
