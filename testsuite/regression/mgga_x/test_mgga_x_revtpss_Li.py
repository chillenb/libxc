...
def test_mgga_x_revtpss_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.750858459191304e+00, -1.209543471002415e+00, -2.977463914237423e-01, -1.585801908648005e-01, -6.345454625449125e-02, -2.054733655625132e-02, -3.505641557981596e-04]
...
def test_mgga_x_revtpss_Li_2_vrho():
    ...
    ref_tgt = [-2.349541039646137e+00, -2.351673745982466e+00, -1.628193158117273e+00, -1.629613442017412e+00, -3.936157016237703e-01, -3.932657660380642e-01, -2.124450880323105e-01, -2.609111414186119e-02, -8.274698585740911e-02, -8.296413305158503e-04, -2.750646504909760e-02, -2.723266425828722e-02, -5.541564195078383e-04, -2.260030367871350e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
