...
def test_mgga_x_gx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.140022595335194e+00, -1.485698365893895e+00, -3.508474184869329e-01, -1.931668870998599e-01, -7.669328582114858e-02, -1.184576525891439e-02, -1.857135236633666e-04]
...
def test_mgga_x_gx_Li_2_vtau():
    ...
    ref_tgt = [2.107297905427289e-02, 2.105379194513418e-02, 3.035306125412128e-02, 3.032559744526879e-02, 1.290197652751474e-01, 1.263957860834246e-01, 2.331382655494147e-01, 3.362509180130806e+00, 5.877478487225314e-01, 1.064708817317555e+02, 1.104642216543328e-10, 3.221041510522955e+00, 5.938169401791733e-22, 4.090786233411168e+01]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
