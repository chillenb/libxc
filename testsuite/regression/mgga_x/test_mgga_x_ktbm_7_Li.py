...
def test_mgga_x_ktbm_7_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.926831329724589e+00, -1.279174869030424e+00, -2.767931060854950e-01, -1.773743088473230e-01, -5.794203987560835e-02, -1.245707754168807e-02, -2.295745915676966e-04]
...
def test_mgga_x_ktbm_7_Li_2_vrho():
    ...
    ref_tgt = [-2.717887151574599e+00, -2.720508216226289e+00, -1.879700922031071e+00, -1.881403370904043e+00, -3.484409878426437e-01, -3.478889612193946e-01, -2.453090253517100e-01, -1.482519144106904e-02, -7.590820877445166e-02, -4.701911621557202e-04, -1.558984176640292e-02, -1.547630262055204e-02, -3.140606937526585e-04, -2.234355474028027e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
