...
def test_mgga_x_ktbm_13_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.979202132559271e+00, -1.304005287679139e+00, -2.466200484044705e-01, -1.824811615229101e-01, -5.350503695052086e-02, -1.036017093913373e-02, -1.923265959818500e-04])
...
def test_mgga_x_ktbm_13_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-6.943335156487454e-04, 0.000000000000000e+00, -6.919833220981244e-04, -2.569772193476272e-03, 0.000000000000000e+00, -2.563069960363610e-03, -3.769180227725034e-02, 0.000000000000000e+00, -3.959245281776207e-02, -1.091883715881966e+01, 0.000000000000000e+00, -1.942568928889160e+01, -6.738203262534151e+01, 0.000000000000000e+00, -4.865293977734023e+04, -3.612285597107964e-01, 0.000000000000000e+00, -1.736889204403527e+01, -7.367444597062058e-01, 0.000000000000000e+00, 6.588909827450229e+04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
