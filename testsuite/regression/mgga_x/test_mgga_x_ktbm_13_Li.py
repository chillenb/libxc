...
def test_mgga_x_ktbm_13_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.136890845874251e+00, -1.499894017430566e+00, -2.868868506641454e-01, -1.910903953182589e-01, -6.721965986966019e-02, -1.020885674953684e-02, -1.890748295993249e-04]
...
def test_mgga_x_ktbm_13_Li_2_vrho():
    ...
    ref_tgt = [-2.619325927765223e+00, -2.621839037194784e+00, -1.769286264436752e+00, -1.770598056112964e+00, -3.709518485016626e-01, -3.729289522991978e-01, -2.420217167672315e-01, -1.242809782451247e-02, -8.852629022144554e-02, -3.941027702393399e-04, -1.346770232905349e-02, -1.297405858553602e-02, -2.713468293991789e-04, -1.871381225392066e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
...
def test_mgga_x_ktbm_13_Li_2_vtau():
    ...
    ref_tgt = [2.968385469751945e-02, 2.964835939536362e-02, 4.819621565615440e-02, 4.816210257095715e-02, 2.225847398899616e-02, 2.407466124243129e-02, 3.032128504205986e-01, 2.485251823518829e-04, 3.511688448310827e-01, 1.982301621494738e-05, -2.968152927730106e-08, 2.528211264035374e-04, -2.118826602788925e-16, 9.608427487516284e-06]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
