...
def test_mgga_x_ktbm_19_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.985480226802128e+00, -1.309462363664720e+00, -2.316506095793083e-01, -1.828154022489181e-01, -5.144787690649345e-02, -9.043249993897381e-03, -1.695752065156638e-04]
...
def test_mgga_x_ktbm_19_Li_2_vrho():
    ...
    ref_tgt = [-2.808669038230168e+00, -2.811383301985986e+00, -1.967771622671213e+00, -1.969423742468412e+00, -3.134067548123136e-01, -3.138707272147367e-01, -2.526104664052400e-01, -1.119758296640967e-02, -7.600286566590020e-02, -3.550286247565628e-04, -1.177154204377430e-02, -1.168959718722206e-02, -2.371385446082387e-04, -1.769680997525226e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
