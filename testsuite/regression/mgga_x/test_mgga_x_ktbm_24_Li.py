...
def test_mgga_x_ktbm_24_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.998961589622010e+00, -1.317335669955434e+00, -2.158596485679645e-01, -1.839876218607651e-01, -4.917229365578080e-02, -8.539004251506218e-03, -1.589929683433533e-04]
...
def test_mgga_x_ktbm_24_Li_2_vsigma():
    ...
    ref_tgt = [-8.044917105251424e-04, 0.000000000000000e+00, -8.017901206902894e-04, -3.041580844101855e-03, 0.000000000000000e+00, -3.033352029286365e-03, -7.134121645420652e-02, 0.000000000000000e+00, -7.403493916001479e-02, -1.253811752755743e+01, 0.000000000000000e+00, 1.555502924139032e+01, -9.701297184425658e+01, 0.000000000000000e+00, 3.919473376912650e+04, 2.909694753835536e-01, 0.000000000000000e+00, 1.390286141557889e+01, 5.935293414432089e-01, 0.000000000000000e+00, -2.599675038946072e+05]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
