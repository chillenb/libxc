...
def test_mgga_x_ktbm_5_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.965621774221892e+00, -1.384910456312683e+00, -3.528834798432905e-01, -1.763280578527952e-01, -7.592789063871193e-02, -1.328131672001611e-02, -2.425010427169956e-04])
...
def test_mgga_x_ktbm_5_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.465039300492368e+00, -2.467447401828151e+00, -1.641502816723996e+00, -1.642979557298576e+00, -4.101904640192358e-01, -4.103073873692123e-01, -2.273091515657790e-01, -1.609613393103387e-02, -8.372965807861432e-02, -5.105180431958154e-04, -1.710850035093980e-02, -1.680302710184064e-02, -3.445960430841684e-04, -2.424175402376939e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
