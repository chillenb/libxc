...
def test_mgga_x_mcml_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.872822706641400e+00, -1.340381763242511e+00, -3.990012356859167e-01, -1.665369886582610e-01, -7.987883129043548e-02, -9.180541722351176e-03, -1.313484423311580e-04])
...
def test_mgga_x_mcml_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.317488493032238e+00, -2.319504580105652e+00, -1.606964613226028e+00, -1.607552664029965e+00, -3.761463200198222e-02, -4.694241282984792e-01, -2.115596748376916e-01, -1.461282657547056e-02, -8.063660823892752e-02, 5.450937602966838e+01, -9.421823156400352e-03, -1.525697145754277e-02, -1.865453789663485e-04, 4.919796528493407e+01])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
