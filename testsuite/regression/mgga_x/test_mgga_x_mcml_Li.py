...
def test_mgga_x_mcml_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.856814815141000e+00, -1.249975436666831e+00, -2.799159882676440e-01, -1.658315133170946e-01, -6.054242630422493e-02, -1.146238512484021e-02, -2.122256108690134e-04]
...
def test_mgga_x_mcml_Li_2_vtau():
    ...
    ref_tgt = [-3.023587629017960e-03, -3.097190376360163e-03, 3.015849699518557e-02, 3.012134235216896e-02, 3.007578310742484e-04, 3.233618499922603e-04, -2.424626594337699e-01, 8.308842113909050e-12, 1.232740862255159e-02, 1.940822823031599e-07, -2.713427674472172e-11, 2.620517063602107e-12, 3.565564279938416e-02, 3.812346968433121e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
