...
def test_mgga_x_2d_js17_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.946266036862000e+00, -2.276288494485467e+00, -1.994453295810489e-01, -1.068894207136402e-01, -1.149321453655024e-02, -1.035616154371908e+01, -2.636954856239478e+03]
...
def test_mgga_x_2d_js17_Li_2_vrho():
    ...
    ref_tgt = [-5.928801289473816e+00, -5.936028262365340e+00, -3.432822951538366e+00, -3.437189400742700e+00, -4.387879784953173e-01, -4.376767098685226e-01, -1.617169990226911e-01, 6.055499265336556e-01, -4.788514492556539e-02, 9.789090916838943e-01, 6.130173342573007e+00, 6.071858569279993e-01, 1.398001690035674e+03, -9.385354945053629e+02]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
