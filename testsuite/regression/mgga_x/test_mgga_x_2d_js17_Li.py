...
def test_mgga_x_2d_js17_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.817176056637241e+00, -2.231477249161224e+00, -8.034606449040180e-01, -1.111237990470901e-01, -1.239135000126741e-01, -5.923153773784422e-01, 9.717852488840970e+03]
...
def test_mgga_x_2d_js17_Li_2_vsigma():
    ...
    ref_tgt = [1.041857490154147e-04, 0.000000000000000e+00, 1.049936708366101e-04, -1.198925236557998e-03, 0.000000000000000e+00, -1.192411536030763e-03, -5.635520782847684e-01, 0.000000000000000e+00, -5.635629803287692e-01, -1.582180916063197e+01, 0.000000000000000e+00, -2.971239436125520e+04, -4.195442955442442e+02, 0.000000000000000e+00, -3.799588701081567e+09, -4.701860827370946e+04, 0.000000000000000e+00, -2.551515153022634e+04, -3.070495259262504e+13, 0.000000000000000e+00, -4.473892074544984e+10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_mgga_x_2d_js17_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
