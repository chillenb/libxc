...
def test_mgga_x_revm06_l_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.904759644311025e+00, -1.327338450327835e+00, -1.483973868277602e-01, -1.564914116147631e-01, -4.644398146560202e-02, -9.131646074487361e-03, -1.553448575799858e-04]
...
def test_mgga_x_revm06_l_Li_2_vtau():
    ...
    ref_tgt = [-6.148150784902894e-02, -6.193763758754001e-02, 3.328507515751148e-02, 3.317472732687539e-02, 2.402118053404238e-02, 2.532441909761595e-02, -1.513161621210366e+00, -1.089673834831122e-05, 2.384606005388591e-01, -2.238961054695040e-09, -5.435431511330781e-09, -1.175878292231580e-05, -3.044736485371212e-20, 1.415015504808029e-09]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
