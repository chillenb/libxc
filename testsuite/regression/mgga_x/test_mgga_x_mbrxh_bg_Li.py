...
def test_mgga_x_mbrxh_bg_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.720472532085499e+00, -1.366637443034971e+00, -9.870454496753268e-01, -1.523946021804781e-01, -1.411100810281256e-01, -6.727185683065568e+00, -8.893744457891069e+01]
...
def test_mgga_x_mbrxh_bg_Li_2_vrho():
    ...
    ref_tgt = [-1.857444831392968e+00, -1.860326266487682e+00, -9.023505185366951e-01, -9.031376918682585e-01, 2.743102362739376e-01, 2.770519846189390e-01, -1.855575344774963e-01, 7.175649620374538e+00, -9.072018571444811e-04, 5.996070563431758e+01, 6.801948382676692e+00, 7.089268974172984e+00, 9.901101184804547e+01, 1.141996061533276e+02]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
