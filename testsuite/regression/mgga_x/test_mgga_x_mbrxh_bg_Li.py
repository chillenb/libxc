...
def test_mgga_x_mbrxh_bg_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.636698309847121e+00, -1.158258420656382e+00, -4.135811922332200e-01, -1.492431042285663e-01, -7.659750752034372e-02, -1.169705956211836e+02, -4.575387235745384e+06])
