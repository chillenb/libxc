...
def test_mgga_x_ktbm_22_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.189472962294593e+00, -1.537844645798921e+00, -2.797468241375060e-01, -1.954995234209477e-01, -6.659632472771976e-02, -1.003728089831184e-02, -1.887716686838480e-04])
...
def test_mgga_x_ktbm_22_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([3.520171573019153e-02, 3.515990453738502e-02, 5.716663431522365e-02, 5.713125875376646e-02, 2.185681776956431e-02, 2.379440375230195e-02, 3.583981775046480e-01, 1.250430128667067e-04, 3.777386233312455e-01, 9.919119811369006e-06, -1.196476762474303e-07, 1.272473689420676e-04, -7.993466455720744e-16, 4.807849396652597e-06])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
