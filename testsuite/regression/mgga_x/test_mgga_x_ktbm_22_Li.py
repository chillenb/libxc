...
def test_mgga_x_ktbm_22_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.005424854565952e+00, -1.313186018272687e+00, -2.471281201587778e-01, -1.853913734748887e-01, -5.336725766904249e-02, -9.934649235458415e-03, -1.863315350341092e-04])
