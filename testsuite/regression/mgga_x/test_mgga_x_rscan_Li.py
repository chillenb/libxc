...
def test_mgga_x_rscan_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.037422780933269e+00, -1.413111879273508e+00, -3.261586294489217e-01, -1.841702389938188e-01, -7.184056513635365e-02, -6.002007206042661e-03, -1.816354230794169e-05])
