...
def test_mgga_x_th_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.531066012236973e+00, -2.246952286824099e+00, -3.911434595697234e-02, -9.646242372808770e-01, -1.769244501315983e-02, -1.562422520672424e-06, -5.156274692617661e-12]
...
def test_mgga_x_th_Li_2_vtau():
    ...
    ref_tgt = [1.546156974095283e+00, 1.550841158396755e+00, 5.465574292768611e-01, 5.488233315072635e-01, 1.170140132350010e-02, 1.229054713851583e-02, 4.575354692030820e+01, 1.100152557229859e-06, 2.468971935425923e-01, 2.239435368427139e-10, 5.437614747478248e-10, 1.187874358583093e-06, 3.046027737256256e-21, 1.645297314713668e-11]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
