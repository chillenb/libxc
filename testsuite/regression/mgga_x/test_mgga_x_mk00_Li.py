...
def test_mgga_x_mk00_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.466450408318827e-01, -1.441437641079510e+00, -1.140550060198712e-01, -2.043921621660453e-01, -3.503101019089291e-02, -9.764957899397798e-06, -9.326539204259687e-12])
...
def test_mgga_x_mk00_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-4.393388313518456e-01, -4.405298047164972e-01, -4.318883424972702e+00, -4.329728581237196e+00, -3.366032671082976e-01, -3.477338708169111e-01, -6.133804720921006e-01, -6.752636178288011e-05, -1.050930484773618e-01, -1.093868250344993e-09, -3.594922385521421e-07, -5.887089944704629e-05, -2.395520475215477e-15, -1.058483705949570e-10])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
