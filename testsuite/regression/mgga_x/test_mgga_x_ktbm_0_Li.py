...
def test_mgga_x_ktbm_0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.995244848932251e+00, -1.406981859010935e+00, -3.435407881411591e-01, -1.787868175582901e-01, -7.503569627035427e-02, -1.288097607114886e-02, -2.370364538993883e-04])
...
def test_mgga_x_ktbm_0_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.486236463209116e+00, -2.488663582594384e+00, -1.660037303048143e+00, -1.661502927203228e+00, -4.255507429473891e-01, -4.269741489909875e-01, -2.294071051513959e-01, -1.638541502943909e-02, -8.822409314052169e-02, -5.196768930812412e-04, -1.682454645373645e-02, -1.710504557726964e-02, -3.388209681340489e-04, -2.467665670758793e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
