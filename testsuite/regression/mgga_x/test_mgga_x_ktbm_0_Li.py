...
def test_mgga_x_ktbm_0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.879965759719377e+00, -1.259119004864442e+00, -2.951181460314590e-01, -1.725459388140028e-01, -6.075688820406638e-02, -1.318468755840339e-02, -2.438528296959644e-04]
...
def test_mgga_x_ktbm_0_Li_2_vtau():
    ...
    ref_tgt = [1.728457226556758e-02, 1.727381475154757e-02, 1.955561849556358e-02, 1.956566077410962e-02, -5.310253901833638e-03, -5.479625497368179e-03, 2.053863284273668e-01, 1.290662115014003e-04, -3.843699452125288e-02, 1.026612448047202e-05, 2.778569644184977e-06, 1.313195983856130e-04, 4.632619890788233e-11, -1.267111875192943e-11]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
