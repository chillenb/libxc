...
def test_mgga_x_mvsbs_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.038110200317983e+00, -1.414830133240718e+00, -3.236729329362850e-01, -1.844517346928956e-01, -7.214900369517720e-02, -2.745569406055213e-03, -8.206942671049331e-06])
