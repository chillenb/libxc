...
def test_mgga_x_mvsbs_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.206952016306527e+00, -1.430802047308850e+00, -2.854570290532622e-01, -1.909791046253957e-01, -6.048165911402356e-02, -2.025550296220105e-03, -4.369556749392754e-05])
