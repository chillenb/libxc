...
def test_mgga_x_pbe_gx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.119164116982275e+00, -1.456779734439053e+00, -2.762254005967172e-01, -1.920612823000739e-01, -6.785693839428888e-02, -7.018959225327935e-05, -9.009913532723338e-10])
...
def test_mgga_x_pbe_gx_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([2.086739814880790e-02, 2.084876870966884e-02, 2.976190858745893e-02, 2.973565841958481e-02, 1.016204975571006e-01, 9.947265497243082e-02, 2.318092027832028e-01, 1.839183288016973e-02, 5.200294807098370e-01, 1.487805368542436e-03, 6.731926909396663e-13, 1.869836983336668e-02, 3.158395172370137e-27, 1.315728375387277e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
