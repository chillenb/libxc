...
def test_mgga_x_ktbm_15_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.955350305992567e+00, -1.287569444566700e+00, -2.853873470131611e-01, -1.807126731644930e-01, -5.887379976927462e-02, -1.219409072973294e-02, -2.277135609801538e-04])
...
def test_mgga_x_ktbm_15_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([2.617168143390780e-02, 2.615266733726960e-02, 2.976572561542134e-02, 2.978045701316581e-02, -5.178340283719220e-03, -5.333163982714227e-03, 3.096744720690774e-01, 2.111359480655077e-04, -3.075255775803402e-02, 1.683494838866313e-05, 4.556223024835578e-06, 2.147901396954057e-04, 7.596869000226326e-11, -1.331730350303782e-11])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
