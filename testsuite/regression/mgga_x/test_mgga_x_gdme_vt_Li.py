...
def test_mgga_x_gdme_vt_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [1.825048026242298e+01, -1.068141077230531e+00, -6.675853203754948e-01, -1.294263553419180e-01, -8.070862866231260e-02, -1.746210012027619e+01, 1.097349408006111e+02]
...
def test_mgga_x_gdme_vt_Li_2_vrho():
    ...
    ref_tgt = [-1.041272305166874e+01, -1.040958282300169e+01, -2.647572281721347e+00, -2.649502974165002e+00, -4.990414580221365e-01, -4.985756586483984e-01, -3.502048713356274e-01, 6.391004253243717e+00, -1.281868863869572e-01, -8.990310449901544e+00, 5.780708495150582e+00, 5.804139083802250e+00, -3.236378822207131e+01, -4.831057120288847e+01]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
