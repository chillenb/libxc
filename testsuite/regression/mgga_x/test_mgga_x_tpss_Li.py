...
def test_mgga_x_tpss_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.968910313143120e+00, -1.367175144599829e+00, -3.999809100268318e-01, -1.768456266327649e-01, -7.665000786334736e-02, -2.054447947414327e-02, -3.838586978645408e-04]
...
def test_mgga_x_tpss_Li_2_vrho():
    ...
    ref_tgt = [-2.407095380125136e+00, -2.409267794785516e+00, -1.706387075607042e+00, -1.708133825453897e+00, -3.508899280792214e-01, -3.515788134232583e-01, -2.137875858320913e-01, -2.611569207866658e-02, -7.454096060771728e-02, -8.296433204579698e-04, -2.745718545520368e-02, -2.725989618423128e-02, -5.541555286317482e-04, -3.939542015705412e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
