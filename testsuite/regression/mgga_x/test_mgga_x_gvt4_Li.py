...
def test_mgga_x_gvt4_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.900737744303900e+00, -1.305925424998269e+00, 9.480440824327085e-02, -1.722526013862984e-01, -4.293099434239726e-02, -1.236317973756253e-04, 3.414588393735454e-08])
...
def test_mgga_x_gvt4_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-6.715437371220428e-05, 0.000000000000000e+00, -6.680988295523206e-05, -4.041603384933001e-04, 0.000000000000000e+00, -4.022051573361446e-04, -1.341531559666212e+00, 0.000000000000000e+00, -1.309052136149183e+00, -8.555286184251065e-01, 0.000000000000000e+00, 5.124966859315992e-01, -2.774610374989784e+02, 0.000000000000000e+00, 3.446343561952663e+00, 2.293355829543077e-04, 0.000000000000000e+00, 4.848095952365034e-01, 1.573235012845672e-10, 0.000000000000000e+00, -3.352687020214406e+04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
