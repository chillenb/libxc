...
def test_mgga_x_gvt4_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.918589329714595e+00, -1.342181791983931e+00, -4.432677102306765e-01, -1.730161918301601e-01, -8.209913713589218e-02, 1.518898672208433e-05, -5.152880993627944e-10]
...
def test_mgga_x_gvt4_Li_2_vtau():
    ...
    ref_tgt = [2.384108427779690e-03, 2.379766920573585e-03, 4.401126144652333e-03, 4.388657208325944e-03, 4.936357286353484e-02, 4.771603420746456e-02, 2.371880578078179e-02, 6.521970465712590e-05, 1.986323934049740e-01, 1.338424651355186e-08, -1.346233708933799e-06, 7.038473453363094e-05, -1.328192906476808e-17, 1.493231004207085e-09]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
