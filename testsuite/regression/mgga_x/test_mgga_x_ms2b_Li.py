...
def test_mgga_x_ms2b_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.837710796792943e+00, -1.217444633236013e+00, -2.835926880022138e-01, -1.705084517548438e-01, -6.145894354189387e-02, -1.713407509305537e-02, -2.969797531463519e-04]
...
def test_mgga_x_ms2b_Li_2_vtau():
    ...
    ref_tgt = [2.922374569065244e-02, 2.921744714217566e-02, 1.353607569626722e-02, 1.364373382689528e-02, 6.768835553218666e-04, 7.083498410655520e-04, 3.209350571630216e-01, 1.618681424715014e-24, 1.139935079194836e-02, 1.517387124930945e-30, -1.376088501969800e-30, 6.500920864628288e-25, -2.484473852571390e-41, 1.061028777096254e-12]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
