...
def test_mgga_x_rppscan_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.037410948453068e+00, -1.413071631087617e+00, -3.261026581357812e-01, -1.840458117349171e-01, -7.184056188003680e-02, -5.937164977314107e-03, -1.442334962107023e-05]
...
def test_mgga_x_rppscan_Li_2_vsigma():
    ...
    ref_tgt = [-2.073133145434802e-04, 0.000000000000000e+00, -2.065636204707450e-04, -8.116239690247084e-04, 0.000000000000000e+00, -8.080639543183398e-04, -2.510209331105407e-01, 0.000000000000000e+00, -1.844452303254443e-01, -3.311832407365086e+00, 0.000000000000000e+00, -8.200972651164244e+03, -9.010493207395648e+01, 0.000000000000000e+00, -7.088046755258915e+06, 2.043255686462311e+01, 0.000000000000000e+00, -7.331944745012736e+03, 3.271621446842214e+04, 0.000000000000000e+00, 0.000000000000000e+00]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_mgga_x_rppscan_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
