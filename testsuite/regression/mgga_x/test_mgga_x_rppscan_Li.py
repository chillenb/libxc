...
def test_mgga_x_rppscan_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.974920765872153e+00, -1.311268315472403e+00, -2.342832281820834e-01, -1.809544674590481e-01, -5.246927185872651e-02, -4.816589062986531e-03, -1.021140385176983e-06])
...
def test_mgga_x_rppscan_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.757308827267502e+00, -2.759876991369624e+00, -1.960708310085863e+00, -1.962190829457346e+00, -3.254056935755857e-01, -3.259033195562962e-01, -2.474325994771338e-01, 3.100464165747890e-01, -7.766451651481042e-02, 3.397467277111611e-03, 1.841834238653130e-01, 3.235860568481085e-01, 1.015185605952393e-04, -8.607518337074510e-23])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
