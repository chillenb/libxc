...
def test_mgga_x_sa_tpss_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.750850113171398e+00, -1.209542605279631e+00, -2.978605410770948e-01, -1.585790712681438e-01, -6.346118676546005e-02, -2.054985979597249e-02, -3.506166968767713e-04]
...
def test_mgga_x_sa_tpss_Li_2_vtau():
    ...
    ref_tgt = [2.321097835798142e-03, 2.302274766820900e-03, 2.362976817476223e-03, 2.367170267371585e-03, -6.728064687841221e-04, -7.108091305058498e-04, 2.682093493597700e-02, 7.822859259119674e+00, -1.582443924128943e-02, 2.472705694799261e+02, 7.457327716558623e+00, 7.492586586635507e+00, 3.701016078371850e+02, -1.379374666938812e-10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
