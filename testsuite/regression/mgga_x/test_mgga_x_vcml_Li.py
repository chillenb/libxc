...
def test_mgga_x_vcml_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.837450226924592e+00, -1.246418056710312e+00, -2.823823792636329e-01, -1.648717430074303e-01, -6.096516779723388e-02, -1.139347148644794e-02, -2.112035211704329e-04]
...
def test_mgga_x_vcml_Li_2_vrho():
    ...
    ref_tgt = [-2.414397734862857e+00, -2.416328000683913e+00, -1.869062545018601e+00, -1.870542455982624e+00, -3.777365156710282e-01, -3.776554748361297e-01, -2.160986499548712e-01, -1.467591799512432e-02, -8.232198313287312e-02, -4.585853169658289e-04, -1.521066518462952e-02, -1.533420105228328e-02, 7.881348869379073e+02, -2.128252775768312e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
