...
def test_mgga_x_bloc_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.750859186495887e+00, -1.209543471002415e+00, -2.977463914237423e-01, -1.585801929122938e-01, -6.345454625449133e-02, -2.055078483688031e-02, -3.505641557988976e-04]
...
def test_mgga_x_bloc_Li_2_vrho():
    ...
    ref_tgt = [-2.349540698002525e+00, -2.351673745982466e+00, -1.628193158117273e+00, -1.629613442017412e+00, -3.936157016237703e-01, -3.932657660380642e-01, -2.124450880323105e-01, -2.611569208058221e-02, -8.274698585740911e-02, -8.296433204580664e-04, -2.750705699884594e-02, -2.725989618662414e-02, -5.541564195118446e-04, -2.260030367871288e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
