...
def test_mgga_x_bloc_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.968927759386149e+00, -1.367221933918863e+00, -4.000392256019930e-01, -1.770358986477462e-01, -7.665000837653904e-02, -2.054447947414146e-02, -3.838586978645408e-04])
