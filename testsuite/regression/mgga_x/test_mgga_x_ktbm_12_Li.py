...
def test_mgga_x_ktbm_12_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.101487583327224e+00, -1.470627022278618e+00, -3.098166073139247e-01, -1.884867435871463e-01, -7.019917716560013e-02, -1.140257015529293e-02, -2.110937628863581e-04])
...
def test_mgga_x_ktbm_12_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.609837122488210e+00, -2.612359882841651e+00, -1.751931134793646e+00, -1.753347994420102e+00, -3.873880370040303e-01, -3.887756040433612e-01, -2.410126388493669e-01, -1.395175139242141e-02, -8.718524496660630e-02, -4.424650671962358e-04, -1.503286382451870e-02, -1.456455132054160e-02, -3.028682649114963e-04, -2.101028082892448e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
