...
def test_mgga_x_br89_explicit_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.382820109865281e+00, -1.207219819808327e+00, -4.834082114637349e-01, -1.469858898755506e-01, -8.663521731957678e-02, -2.748592977476321e-01, -1.907535500975168e+00]
...
def test_mgga_x_br89_explicit_Li_2_vrho():
    ...
    ref_tgt = [-1.870105475266117e+00, -1.871878320358321e+00, -1.753296076344643e+00, -1.754905270613644e+00, -4.232460088234682e-01, -4.227546040636192e-01, -2.240620127314839e-01, -7.256576645266252e-02, -8.457650497490435e-02, -1.607860264534786e-02, -2.351270757597363e-01, -7.210614463652722e-02, -1.692908792678262e+00, -1.015637364853249e-02]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
