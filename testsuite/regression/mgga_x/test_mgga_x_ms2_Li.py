...
def test_mgga_x_ms2_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.952644425506937e+00, -1.368943866350179e+00, -3.729066555421766e-01, -1.757256866376829e-01, -7.621881199680315e-02, -1.712967268006182e-02, -3.200241284136042e-04]
...
def test_mgga_x_ms2_Li_2_vrho():
    ...
    ref_tgt = [-2.550686104636876e+00, -2.553065247083230e+00, -1.756066852279818e+00, -1.757864287178737e+00, -3.436535821505579e-01, -4.231898918270263e-01, -2.314705962571277e-01, -2.177864852574420e-02, -8.838210576031470e-02, -6.916761182475200e-04, -2.289804952274230e-02, -2.273321947202948e-02, -4.620011818408396e-04, -3.284407897608138e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
