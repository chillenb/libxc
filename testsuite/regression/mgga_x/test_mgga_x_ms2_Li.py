...
def test_mgga_x_ms2_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.890839356852569e+00, -1.244813783515584e+00, -2.816370634950895e-01, -1.732214932593697e-01, -6.085920072318025e-02, -1.713407509232874e-02, -2.969801431810358e-04])
