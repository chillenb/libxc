...
def test_mgga_x_b00_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.710618602228752e+00, -1.486475266894497e+00, -4.233427929364385e-01, -1.697094194520613e-01, -6.533357380016781e-02, -1.681406059767928e-01, -4.498275941926377e-02])
