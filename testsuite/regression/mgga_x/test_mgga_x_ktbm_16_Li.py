...
def test_mgga_x_ktbm_16_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.134596943800216e+00, -1.493480654179448e+00, -3.112491449421522e-01, -1.913800917425063e-01, -7.067839120920545e-02, -1.164255501410962e-02, -2.179744639688859e-04]
...
def test_mgga_x_ktbm_16_Li_2_vrho():
    ...
    ref_tgt = [-2.633326729295082e+00, -2.635888314090309e+00, -1.762661972014900e+00, -1.764072954279788e+00, -3.946633447163337e-01, -3.960418415919668e-01, -2.437266463024530e-01, -1.430258052306268e-02, -8.844282576918890e-02, -4.535958407693190e-04, -1.563787738141097e-02, -1.493078048833553e-02, -3.151323117969620e-04, -2.153882176626742e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
