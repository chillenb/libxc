...
def test_mgga_x_ktbm_16_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.973794539509014e+00, -1.295975626018519e+00, -2.757086709350697e-01, -1.825511669779526e-01, -5.745072603690767e-02, -1.160778613645818e-02, -2.170573326850979e-04])
