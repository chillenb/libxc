...
def test_mgga_x_ms1_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.907442721398207e+00, -1.251652127900726e+00, -2.551759006957331e-01, -1.749553347874425e-01, -5.630709847067722e-02, -1.599607658893805e-02, -2.758346869253733e-04])
...
def test_mgga_x_ms1_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-4.937701137224461e-04, 0.000000000000000e+00, -4.917489266039556e-04, -2.472508854196534e-03, 0.000000000000000e+00, -2.468367412066051e-03, -3.069289227109531e-01, 0.000000000000000e+00, -3.075384063182969e-01, -5.137585258084326e+00, 0.000000000000000e+00, -1.245901098316482e-01, -1.528055229376174e+02, 0.000000000000000e+00, -7.975402546178242e-01, -5.312417540225655e-05, 0.000000000000000e+00, -1.182261644172310e-01, 2.592323196615042e-09, 0.000000000000000e+00, -3.001459541110490e+12])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
