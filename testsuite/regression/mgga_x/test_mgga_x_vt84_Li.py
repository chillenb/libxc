...
def test_mgga_x_vt84_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.750891674124534e+00, -1.209547767302443e+00, -2.978069275945001e-01, -1.585817051688221e-01, -6.346075275880425e-02, -5.550059698020617e-03, -4.481603741388305e-05])
...
def test_mgga_x_vt84_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.349654527773770e+00, -2.351787123923825e+00, -1.628229006377466e+00, -1.629649543151194e+00, -3.936466244987612e-01, -3.932943742571211e-01, -2.124563825657449e-01, -1.528597631044643e-02, -8.273689464235236e-02, -1.189923457218070e-09, -5.420334483280774e-03, -1.590218259885505e-02, -2.395527953715692e-15, -2.260694856305692e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
