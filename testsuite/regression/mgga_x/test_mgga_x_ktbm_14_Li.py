...
def test_mgga_x_ktbm_14_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.979779419785145e+00, -1.307482814130707e+00, -2.314597289971150e-01, -1.821848832972882e-01, -5.145136802411472e-02, -9.154123138598570e-03, -1.711719714075043e-04]
...
def test_mgga_x_ktbm_14_Li_2_vtau():
    ...
    ref_tgt = [2.245121762767259e-02, 2.242040443633486e-02, 3.176375331349660e-02, 3.174813059872752e-02, 8.785301146760059e-04, 9.962102902704188e-04, 2.408348452269022e-01, 1.376944107957849e-04, 6.304592568560645e-02, 1.092908462270819e-05, 2.958131604021148e-06, 1.401167874335459e-04, 4.931755686896820e-11, -3.880961214727259e-12]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
