...
def test_mgga_x_tau_hcth_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.869103723650425e+00, -1.286350131435918e+00, -4.885089292603628e-01, -1.705260103726849e-01, -7.486183259459506e-02, -4.380169430221372e-02, -8.191972192906768e-04])
