...
def test_mgga_x_ktbm_2_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.999912578003352e+00, -1.410550206908387e+00, -3.376853238473614e-01, -1.791444872638165e-01, -7.426282437400758e-02, -1.248599922010074e-02, -2.286944139264936e-04]
...
def test_mgga_x_ktbm_2_Li_2_vsigma():
    ...
    ref_tgt = [-5.345836370376396e-04, 0.000000000000000e+00, -5.327462496787759e-04, -2.126016755828308e-03, 0.000000000000000e+00, -2.119856997862728e-03, -5.887260418466368e-02, 0.000000000000000e+00, -6.081050857252299e-02, -8.163393186768955e+00, 0.000000000000000e+00, -1.518078208158708e+01, -8.182262409989278e+01, 0.000000000000000e+00, -3.798990280568849e+04, -4.349406975428629e-01, 0.000000000000000e+00, -1.357412729964539e+01, -8.935358603191639e-01, 0.000000000000000e+00, -1.719859807085329e+05]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_mgga_x_ktbm_2_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
