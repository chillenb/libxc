...
def test_mgga_x_ktbm_2_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.884484701132983e+00, -1.262071589857396e+00, -2.867090672993631e-01, -1.729043357857303e-01, -5.965582103542147e-02, -1.287660205458152e-02, -2.374378519481467e-04])
...
def test_mgga_x_ktbm_2_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.631132651033855e+00, -2.633686540943354e+00, -1.818689722210555e+00, -1.820331544988113e+00, -3.591967706313013e-01, -3.584998860507762e-01, -2.376491021338107e-01, -1.579478958074326e-02, -7.677191977399933e-02, -5.009326622180990e-04, -1.660912567666929e-02, -1.648850502506565e-02, -3.345942333412974e-04, -2.316307759909905e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
