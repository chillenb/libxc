...
def test_mgga_x_pkzb_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.749708557698871e+00, -1.209129191267948e+00, -3.886042309500469e-01, -1.584900330668411e-01, -6.737859113872846e-02, -2.055685952484587e-02, -3.838588870219928e-04]
...
def test_mgga_x_pkzb_Li_2_vrho():
    ...
    ref_tgt = [-2.347926270158240e+00, -2.350129907641539e+00, -1.625936561360765e+00, -1.627354385230859e+00, -3.005509213462756e-01, -2.971336545035437e-01, -2.123959501978878e-01, -2.615897632319181e-02, -6.828298347640380e-02, -8.296468243197490e-04, -2.750809929932611e-02, -2.730785489448631e-02, -5.541564195188991e-04, -3.939545845218585e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
