...
def test_mgga_x_ktbm_9_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.959284367287674e+00, -1.298774935927952e+00, -2.363127067401932e-01, -1.800973294857226e-01, -5.226056027109279e-02, -1.019014836736854e-02, -1.875396168608170e-04])
