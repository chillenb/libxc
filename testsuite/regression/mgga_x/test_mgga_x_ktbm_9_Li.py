...
def test_mgga_x_ktbm_9_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.083894588632850e+00, -1.456487083737452e+00, -2.802409975225909e-01, -1.868562650227405e-01, -6.539047809526782e-02, -9.826488083325091e-03, -1.795840341338003e-04])
...
def test_mgga_x_ktbm_9_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.603421137343709e+00, -2.605882290403919e+00, -1.768320677584882e+00, -1.769663472661344e+00, -3.522818352401342e-01, -3.538533435994957e-01, -2.394270623113973e-01, -1.167764670132977e-02, -8.510191107675512e-02, -3.703035481531691e-04, -1.267395803542974e-02, -1.219064446190796e-02, -2.553159697670731e-04, -1.758371558405988e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
