...
def test_mgga_x_ktbm_17_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.992133631954269e+00, -1.306151343968379e+00, -2.580856777295974e-01, -1.841758612536754e-01, -5.495265718909636e-02, -1.067548528040690e-02, -1.995554045844567e-04]
...
def test_mgga_x_ktbm_17_Li_2_vrho():
    ...
    ref_tgt = [-2.848337278928107e+00, -2.851106626765580e+00, -1.974399738594100e+00, -1.976183159489376e+00, -3.312046039265744e-01, -3.309823740746331e-01, -2.567087600732602e-01, -1.305863641713966e-02, -7.491067279058061e-02, -4.141153424365291e-04, -1.373060250459091e-02, -1.363226021942187e-02, -2.766051844064642e-04, -2.057056650570502e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
