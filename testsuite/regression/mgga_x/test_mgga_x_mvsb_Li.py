...
def test_mgga_x_mvsb_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.178898063299192e+00, -1.433106351909674e+00, -2.854170856997563e-01, -1.904715062755123e-01, -6.044963444737322e-02, -2.025550296220105e-03, -4.369556749394064e-05]
...
def test_mgga_x_mvsb_Li_2_vrho():
    ...
    ref_tgt = [-2.588495856674344e+00, -2.590414811327204e+00, -2.353008607118316e+00, -2.357250392921372e+00, -3.742503042991869e-01, -3.738092453016924e-01, -2.395824716505078e-01, -5.134101828955713e-03, -7.772673808798629e-02, -3.655839044042635e-05, -2.097895765112826e-03, -5.440379054354206e-03, -1.017461541350270e-06, -2.183783667931084e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
