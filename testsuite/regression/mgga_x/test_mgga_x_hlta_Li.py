...
def test_mgga_x_hlta_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.022017522161497e+00, -9.395659924234036e-01, -6.443819675165481e-01, -7.598696554021021e-02, -1.028900574812577e-01, -9.499158756294306e-01, -8.977718535119708e+00])
...
def test_mgga_x_hlta_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-6.813554179412505e-01, -6.813346396774146e-01, -6.264233679881269e-01, -6.263314059356587e-01, -4.317698666416886e-01, -4.274033039914464e-01, -5.060257715535756e-02, -2.171705082100562e-01, -6.859337053267472e-02, -7.517609222458987e-02, -1.036285997060341e+00, -2.213456819941633e-01, -8.112448878777057e+00, -6.424167851128436e-02])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
