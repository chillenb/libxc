...
def test_mgga_x_lak_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.994254931794011e+00, -1.325657311570214e+00, -2.394683436094193e-01, -1.821720739185917e-01, -5.194706938828260e-02, -4.816589060100795e-03, -3.700486833039759e-05]
...
def test_mgga_x_lak_Li_2_vtau():
    ...
    ref_tgt = [1.513619557724577e-02, 1.511255876992466e-02, 3.345899762439477e-02, 3.340390167359609e-02, 2.922587718020460e-04, 3.174333815865877e-04, 1.248288085556496e-01, 8.990639119150012e-13, 1.951251945989458e-02, 7.239760800208528e-14, 1.957664304543306e-14, 9.141107136030131e-13, 0.000000000000000e+00, 2.489067319268457e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
