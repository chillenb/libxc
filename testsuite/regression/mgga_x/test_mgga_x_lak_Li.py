...
def test_mgga_x_lak_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.037415713190537e+00, -1.413085343588139e+00, -3.261087404612583e-01, -1.841019339613081e-01, -7.184056276152827e-02, -6.620982857770820e-03, -2.726417287219945e-05])
