...
def test_mgga_x_mk00b_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.740593680813345e-01, -1.478501924989560e+00, -1.996802599619640e-01, -2.059008381162861e-01, -4.527301061901178e-02, -1.190360698124814e-01, -5.337789217540026e-02]
...
def test_mgga_x_mk00b_Li_2_vrho():
    ...
    ref_tgt = [-4.056779868234697e-01, -4.068941463454494e-01, -4.275539422380495e+00, -4.286391129492229e+00, -2.743295013279453e-01, -2.853784731222090e-01, -6.115293380479158e-01, -1.703698538972342e-02, -9.600138110120610e-02, -7.196928965816631e-03, -1.678670338132986e-02, -1.719070638463848e-02, -7.113446318604250e-03, -6.207317596699002e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
...
def test_mgga_x_mk00b_Li_2_vsigma():
    ...
    ref_tgt = [-1.203442227636064e-04, 0.000000000000000e+00, -1.199259913458914e-04, -4.887381788060860e-04, 0.000000000000000e+00, -4.871353574556581e-04, -8.551479092689482e-02, 0.000000000000000e+00, -8.554884904510074e-02, -1.854383167779579e+00, 0.000000000000000e+00, -1.347690283898541e+03, -4.977717225998308e+01, 0.000000000000000e+00, -4.851170961207286e+07, -1.172313419604260e+03, 0.000000000000000e+00, -1.174000906457912e+03, -1.440146351758661e+08, 0.000000000000000e+00, -4.289928860780579e+08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
