...
def test_mgga_x_rtpss_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.750937018969491e+00, -1.209552503784155e+00, -2.978985347365386e-01, -1.585913809124163e-01, -6.346993915655115e-02, -2.055687026651119e-02, -3.505974447343526e-04]
...
def test_mgga_x_rtpss_Li_2_vrho():
    ...
    ref_tgt = [-2.349815672350414e+00, -2.351948172516159e+00, -1.628274845459905e+00, -1.629695754002239e+00, -3.936914611892258e-01, -3.933356353826042e-01, -2.124726204801704e-01, -2.615912580860030e-02, -8.272101521976537e-02, -8.296468243503966e-04, -2.750809938117428e-02, -2.730803076839329e-02, -5.541564195188991e-04, -2.261709590429763e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
