...
def test_mgga_x_br89_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.382820466517786e+00, -1.207221334533612e+00, -4.837436607961116e-01, -1.469842897212987e-01, -8.663174149809015e-02, -2.628530496217920e-01, -3.621820110030730e+00])
...
def test_mgga_x_br89_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([3.207789576155275e-05, 3.216384194383160e-05, 1.716496432074618e-02, 1.716073739002180e-02, 1.935651348075736e-02, 1.937363170296324e-02, 7.922815330532153e-02, 9.691456265793137e-03, 1.525524796756495e-01, 1.506122324383486e-02, 3.389453792710385e-03, 9.800976850177385e-03, 5.054625851462057e-05, 1.538990107019123e-02])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
