...
def test_mgga_x_tm_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.749408291250698e+00, -1.209091538850342e+00, -3.514369708800404e-01, -1.584475419556881e-01, -6.642888757717044e-02, -6.558799535747394e-02, -2.689837550186930e-02])
...
def test_mgga_x_tm_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([2.216361831033069e-03, 2.190914954835255e-03, 2.072935860310701e-03, 2.076831130562991e-03, -2.118047097093876e-02, -2.151530734003178e-02, 2.711039958904221e-02, 3.895036744553971e-03, -1.244691425508199e-01, 7.367690545649392e-04, 1.285571263862510e-04, 3.912939835595237e-03, 4.225969770970404e-08, -5.528680090207400e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
