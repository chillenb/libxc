...
def test_mgga_x_mn15_l_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.300412051187539e+00, -1.219640473101470e+00, 4.343669581853517e-02, -1.638311684141456e-01, -2.896246239212740e-02, -2.309148357448394e-02, -3.386121602657094e-04]
...
def test_mgga_x_mn15_l_Li_2_vtau():
    ...
    ref_tgt = [-1.585336906515587e-01, -1.590359079811931e-01, -2.561159300679617e-02, -2.595205743134399e-02, 6.082329574514136e-02, 6.289264508287534e-02, 1.509320766990459e+00, 7.314209482050236e-06, 6.247459526036514e-01, 1.450354763207829e-09, 3.606511271792671e-09, 7.905968280815082e-06, 1.971959110442651e-20, 1.896304964575415e-10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
