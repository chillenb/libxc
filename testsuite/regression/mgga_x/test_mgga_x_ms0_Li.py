...
def test_mgga_x_ms0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.995217476937865e+00, -1.390732561788530e+00, -3.510359427106702e-01, -1.800028930077205e-01, -7.401940112031487e-02, -1.469689152511463e-02, -2.744888499561409e-04]
...
def test_mgga_x_ms0_Li_2_vtau():
    ...
    ref_tgt = [1.153566075011718e-05, 1.118288293653009e-11, 7.976907243514445e-05, 1.593034025786723e-17, 2.136392885661028e-02, 6.626866555597765e-11, 7.762715742432717e-03, 6.370438933669128e-18, 6.596551532443045e-07, 2.061970171548608e-10, 2.406302604472056e-21, 2.270021881361352e-18, -8.846871784847806e-38, 3.445308222741875e-11]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
