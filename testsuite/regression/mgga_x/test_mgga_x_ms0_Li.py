...
def test_mgga_x_ms0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.933682547207351e+00, -1.258744633489178e+00, -2.499348838642552e-01, -1.777209473287758e-01, -5.540133895740799e-02, -1.469835120185761e-02, -2.556820389059564e-04])
