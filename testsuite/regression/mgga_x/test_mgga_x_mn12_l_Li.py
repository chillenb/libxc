...
def test_mgga_x_mn12_l_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.447270563509952e+00, -1.650051559798482e+00, -2.803359015971620e-01, -7.254474697161639e-02, -1.140022025358949e-01, -5.065080468324151e-02, -9.987905130668052e-04])
...
def test_mgga_x_mn12_l_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-4.475611225719283e-03, 0.000000000000000e+00, -4.469514457043474e-03, -7.235440744962645e-03, 0.000000000000000e+00, -7.236174239437957e-03, 8.120117950220671e-03, 0.000000000000000e+00, 9.583976964925548e-03, 4.744643390790914e+01, 0.000000000000000e+00, -3.985522051607108e+00, -2.059547699715242e+02, 0.000000000000000e+00, -2.716518627533277e+01, -4.044441608659973e+00, 0.000000000000000e+00, -3.770934312068575e+00, -1.978796809506917e+01, 0.000000000000000e+00, -2.833485228380944e+01])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
