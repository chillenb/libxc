...
def test_mgga_x_mbeefvdw_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.992858502667971e+00, -1.383768925758582e+00, -3.563410548056445e-01, -1.801421230704198e-01, -7.364443275224271e-02, -1.431923654349070e-02, 0.000000000000000e+00]
...
def test_mgga_x_mbeefvdw_Li_2_vsigma():
    ...
    ref_tgt = [3.029497001279894e-06, 0.000000000000000e+00, 3.106925760094476e-06, -2.359177045222050e-05, 0.000000000000000e+00, -2.184932393750618e-05, -3.006916711565872e-01, 0.000000000000000e+00, -3.215310319705828e-02, 4.062554317973009e-02, 0.000000000000000e+00, 2.692127310799807e-01, -1.982367790380524e+01, 0.000000000000000e+00, 0.000000000000000e+00, 5.675889975002828e-02, 0.000000000000000e+00, 2.552431466735469e-01, 0.000000000000000e+00, 0.000000000000000e+00, 0.000000000000000e+00]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_mgga_x_mbeefvdw_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
