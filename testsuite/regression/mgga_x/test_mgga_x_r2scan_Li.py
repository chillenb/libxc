...
def test_mgga_x_r2scan_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.973315625948457e+00, -1.309794209194168e+00, -2.342832281820834e-01, -1.808641809759491e-01, -5.244988779359668e-02, -4.816589062986531e-03, -1.021140385176983e-06])
