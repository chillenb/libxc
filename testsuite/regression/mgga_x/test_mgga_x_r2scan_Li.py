...
def test_mgga_x_r2scan_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.669849803065874e+00, -2.672334538115724e+00, -1.827711850056424e+00, -1.829382592154799e+00, -2.559527083288819e-01, -3.063334379178975e-01, -2.430363744277021e-01, 3.100805914243296e-01, -8.163572429527081e-02, 3.397593803473437e-03, -9.520561243177409e-03, 3.236239318653542e-01, -4.692758558044223e-05, -4.832379935208682e-21])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
...
def test_mgga_x_r2scan_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-2.199738153658101e-04, 0.000000000000000e+00, -2.191860742504986e-04, -8.580655967056445e-04, 0.000000000000000e+00, -8.543053436078884e-04, -2.592110331075086e-01, 0.000000000000000e+00, -1.905499243838104e-01, -3.546015311365686e+00, 0.000000000000000e+00, -8.201847943569375e+03, -9.459806665932341e+01, 0.000000000000000e+00, -7.088048681693013e+06, 2.042826382252246e+01, 0.000000000000000e+00, -7.332775467524260e+03, 3.271620982293099e+04, 0.000000000000000e+00, 0.000000000000000e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
