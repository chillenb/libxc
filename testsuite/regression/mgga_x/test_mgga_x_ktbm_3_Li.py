...
def test_mgga_x_ktbm_3_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.027226631911706e+00, -1.424499693941641e+00, -3.117471093524529e-01, -1.816908128525661e-01, -7.030370981593287e-02, -1.108692078409390e-02, -2.007041551036333e-04])
