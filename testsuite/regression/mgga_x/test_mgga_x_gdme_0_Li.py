...
def test_mgga_x_gdme_0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([3.208061028711579e+01, -9.036463161125088e-01, -9.105138932324806e-01, -1.014110532688417e-01, -8.978408144611480e-02, -2.944845841389886e+01, 1.851128668722434e+02])
...
def test_mgga_x_gdme_0_Li_2_vlapl():
    ...
    ref_tgt = numpy.asarray([-2.128663886333459e-02, -2.126747629382624e-02, -3.065945887755229e-02, -3.063338549419230e-02, -1.276243353153691e-01, -1.276786334294296e-01, -2.353620224729970e-01, -3.396636789385828e+00, -5.937131331895656e-01, -1.070974376325344e+02, -3.230068637911486e+00, -3.253733301140237e+00, -1.603392940513488e+02, -2.255413506798399e+02])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
