...
def test_hyb_mgga_xc_wb97m_v_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.597712545616571e+00, -1.041104860622169e+00, -2.115583605629386e-01, 3.024363187280334e-02, -1.643346036471813e-02, -2.048828171531131e-02, -5.734761532274114e-04])
