...
def test_hyb_mgga_xc_x1b95_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.698284385032021e-01, -1.583899324891440e-01, -9.865140777510872e-02, -3.940021999305620e-02, -1.205322086149190e-02])
...
def test_hyb_mgga_xc_x1b95_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.262544531461877e-01, -2.638962389450027e-01, -2.008458763121744e-01, -2.439192485430375e-01, -1.150451276739618e-01, -1.780651619035293e-01, -3.125829291917970e-02, -3.716537509663860e-02, -3.091307116798698e-03, -8.062502798544739e-06])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
