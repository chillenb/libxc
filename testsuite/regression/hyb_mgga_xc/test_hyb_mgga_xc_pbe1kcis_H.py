...
def test_hyb_mgga_xc_pbe1kcis_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.568686177483735e-01, -4.659336392608358e-01, -2.794703835425853e-01, -8.118071600404225e-02, -4.769008711327520e-03]
...
def test_hyb_mgga_xc_pbe1kcis_H_2_vrho():
    ...
    ref_tgt = [-6.178743135329482e-01, -2.236903732303361e-01, -6.147585789763784e-01, -2.146767187768155e-01, -3.677690438577416e-01, -1.713347950604392e-01, -1.062609883146090e-01, -8.486840964027169e-02, -6.267287109763178e-03, -7.156556982179594e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
