...
def test_hyb_mgga_xc_pbe1kcis_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-4.851873431840106e-01, -4.504569109118118e-01, -2.803557695511251e-01, -1.048242214670624e-01, -5.769360265481765e-03])
...
def test_hyb_mgga_xc_pbe1kcis_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-6.779858233344062e-01, -2.236903732310476e-01, -5.817756047314019e-01, -1.870772614507488e-01, -3.258525077074750e-01, -1.295847842555172e-01, -1.098552081298012e-01, -2.851872973089982e-02, -7.691812260642582e-03, -9.920875263050817e-05])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
