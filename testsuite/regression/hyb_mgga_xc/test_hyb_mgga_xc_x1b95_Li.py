...
def test_hyb_mgga_xc_x1b95_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.372313195534234e-01, -3.906929858316699e-01, -1.267677776123253e-01, -4.393326502911342e-02, -2.213122055599656e-02, -2.700963636712182e-02, -1.085796074088893e-02]
...
def test_hyb_mgga_xc_x1b95_Li_2_vrho():
    ...
    ref_tgt = [-6.750993923323581e-01, -6.754760027651558e-01, -4.769952375516232e-01, -4.771757500329643e-01, -1.245844778627146e-01, -1.244896222991098e-01, -5.792204513153885e-02, -8.136499988383389e-03, -2.133144082586161e-02, -1.565365667105799e-03, -7.628876629630481e-03, -7.561922236591346e-03, -1.518535635004938e-03, -1.306753369441862e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
