...
def test_hyb_mgga_xc_bb1k_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-3.608389097865176e-01, -3.365149432736719e-01, -2.096348487769342e-01, -8.527800849077150e-02, -3.450967715815977e-02])
...
def test_hyb_mgga_xc_bb1k_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-4.804895264340932e-01, -2.638962389450027e-01, -4.215186256805061e-01, -2.439192485430376e-01, -2.391942850391486e-01, -1.780651619035293e-01, -6.084798247023671e-02, -3.716537509663863e-02, -8.800410864291319e-03, -8.062502798545303e-06])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
