...
def test_hyb_mgga_xc_mpw1kcis_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.286399183427462e-01, -4.933719286212540e-01, -3.073824503445168e-01, -1.213369251839308e-01, -3.256098407104042e-04])
...
def test_hyb_mgga_xc_mpw1kcis_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-7.359410479762732e-01, -2.236903732310476e-01, -6.321241249309393e-01, -1.870772614507488e-01, -3.570760532260106e-01, -1.295847842555173e-01, -1.022663452721873e-01, -2.851872973089984e-02, -1.204367396310769e-03, -9.920875263050760e-05])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
