...
def test_hyb_mgga_xc_mpw1kcis_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.100067551877129e-01, -5.049499398603505e-01, -3.022908623677883e-01, -8.727509362945045e-02, -5.056117976997661e-03]
...
def test_hyb_mgga_xc_mpw1kcis_H_2_vrho():
    ...
    ref_tgt = [-6.778795476728458e-01, -2.236903732303360e-01, -6.667803131090649e-01, -2.146767187768155e-01, -3.981963489580129e-01, -1.713347950604392e-01, -1.143868251484965e-01, -8.486840964027169e-02, -6.650099468460199e-03, -7.156556982179594e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
