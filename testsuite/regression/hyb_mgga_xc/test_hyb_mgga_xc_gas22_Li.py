...
def test_hyb_mgga_xc_gas22_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.605548607870510e+00, -9.963196970868249e-01, -1.998947703437708e-01, 5.017766640369382e-02, -1.045340475199775e-02, -1.474818710591447e-01, -3.197956570586095e-01]
...
def test_hyb_mgga_xc_gas22_Li_2_vrho():
    ...
    ref_tgt = [-2.391014899454584e+00, -2.384847340730384e+00, -1.557324785786492e+00, -1.558316778710080e+00, -3.115607029432377e-01, -3.129172296301713e-01, 1.078800047794012e-01, -1.450728424672001e-01, -2.664052593611583e-02, 1.339596311517455e+00, 2.679067880843937e-02, -1.825984269800577e-01, 1.550952237720839e-01, -9.675842651827241e-01]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
