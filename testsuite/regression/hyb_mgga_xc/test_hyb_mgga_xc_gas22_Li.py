...
def test_hyb_mgga_xc_gas22_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.634982648674824e+00, -1.045719057410006e+00, -2.104956253307045e-01, 3.542338322564220e-02, -1.235937166981149e-02, -6.653851774344402e-02, -9.500613254689257e-03]
...
def test_hyb_mgga_xc_gas22_Li_2_vsigma():
    ...
    ref_tgt = [-1.207602129084790e-04, 0.000000000000000e+00, -1.210031465231726e-04, -5.484341548747322e-04, 0.000000000000000e+00, -5.470708123100113e-04, -3.539638306782936e-03, 0.000000000000000e+00, -3.169018503391733e-03, -7.360093797550565e+00, 0.000000000000000e+00, 1.974881650153797e+04, -7.821086800429430e-01, 0.000000000000000e+00, 1.003965642699503e+10, -3.044929953285796e+02, 0.000000000000000e+00, -3.227991684858498e+02, -8.733827252815237e+06, 0.000000000000000e+00, -1.338733907563332e+08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_hyb_mgga_xc_gas22_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
