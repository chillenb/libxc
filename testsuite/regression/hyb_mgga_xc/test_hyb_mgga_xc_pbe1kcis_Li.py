...
def test_hyb_mgga_xc_pbe1kcis_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.440852005955473e+00, -1.035571910815716e+00, -3.351909717411675e-01, -1.255750986017700e-01, -6.279255012133005e-02, -1.606824015768978e-02, -2.994381869366008e-04])
