...
def test_hyb_mgga_xc_mpwb1k_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-4.018868034177912e-01, -3.210840254161496e-01, -2.050336806797325e-01, -2.178857815475435e-01, -1.214553385278369e+01])
...
def test_hyb_mgga_xc_mpwb1k_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-4.257306504151120e-01, -2.638962389447704e-01, -4.113267838324426e-01, -2.518762289127052e-01, -2.315941350569481e-01, -1.961133971744914e-01, 1.660178719713415e-02, -6.015799346401174e-03, 4.751642786045061e+00, -4.693930258717257e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
