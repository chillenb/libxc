...
def test_hyb_mgga_xc_pwb6k_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.026601586089037e+00, -7.445139857111680e-01, -2.420469869241837e-01, -8.728193690715962e-02, -4.478449529108966e-02, -1.414418202053475e-04, -9.600636696070276e-07]
...
def test_hyb_mgga_xc_pwb6k_Li_2_vsigma():
    ...
    ref_tgt = [-1.363339012072015e-04, 0.000000000000000e+00, -1.359522907179234e-04, -4.868240707370991e-04, 0.000000000000000e+00, -4.856716807691699e-04, -3.650639601805085e-02, 0.000000000000000e+00, -3.646287325819621e-02, -4.876020110929686e-01, 0.000000000000000e+00, 8.087115996685830e+00, -3.343350483424010e+01, 0.000000000000000e+00, 5.962477020028172e+02, 4.027913559198457e+00, 0.000000000000000e+00, 3.052172634753293e+00, 1.514295820929593e+04, 0.000000000000000e+00, 1.504574279092344e+01]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_hyb_mgga_xc_pwb6k_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
