...
def test_hyb_mgga_xc_revtpssh_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.848250387128550e+00, -1.287856258035703e+00, -3.461591105734357e-01, -1.637236085889078e-01, -6.696255955043325e-02, -1.848373318387932e-02, -3.454727313937018e-04])
