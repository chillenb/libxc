...
def test_hyb_mgga_xc_revtpssh_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.669235132977994e+00, -1.172303946522198e+00, -3.175698140076465e-01, -1.608083068349435e-01, -6.806820523328719e-02, -1.849260291612813e-02, -3.155077402183444e-04]
...
def test_hyb_mgga_xc_revtpssh_Li_2_vrho():
    ...
    ref_tgt = [-2.217257456862524e+00, -2.219015010053682e+00, -1.557919236089814e+00, -1.559058783848908e+00, -4.108995074687208e-01, -4.106280961609957e-01, -2.122168767792301e-01, -1.477929582237409e-01, -8.757702690988413e-02, -7.227409827040937e-02, -2.475581865554852e-02, -2.450939792054933e-02, -4.987407775570555e-04, -2.034027331084220e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
