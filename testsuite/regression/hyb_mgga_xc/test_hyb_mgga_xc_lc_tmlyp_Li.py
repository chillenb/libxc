...
def test_hyb_mgga_xc_lc_tmlyp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.837951051370580e+00, -1.249893512045301e+00, -2.078664056617846e-01, -5.597783951938470e-02, -5.622418239161213e-03, -2.131814233768707e-04, 7.108077144408422e-06]
...
def test_hyb_mgga_xc_lc_tmlyp_Li_2_vrho():
    ...
    ref_tgt = [-2.413774530041078e+00, -2.415998747130998e+00, -1.601829548524921e+00, -1.603220853919812e+00, -3.167680209311069e-01, -3.184406238202552e-01, -9.625437854966037e-02, -8.222252883897752e-02, -9.778074876596175e-03, -3.029946517814971e-02, 1.777102203461716e-03, -2.770549555181160e-03, 2.972267841815829e-05, -9.360849208453858e-05]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
