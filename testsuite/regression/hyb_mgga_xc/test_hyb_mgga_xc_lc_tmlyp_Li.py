...
def test_hyb_mgga_xc_lc_tmlyp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.781599704688474e+00, -1.168749812528588e+00, -7.870002542318121e-02, 1.863260106231263e+164, 2.017918590621531e+166, 2.623353823650982e+218, -1.050047488198356e-04]
...
def test_hyb_mgga_xc_lc_tmlyp_Li_2_vtau():
    ...
    ref_tgt = [1.209368006626644e-02, 1.208717184103747e-02, 1.701291832849439e-02, 1.699974819263177e-02, 4.048982096292891e-02, 4.048972663651196e-02, 2.864618489939052e-02, 2.486855527300091e-05, 4.479314341562526e-03, 9.452377746616706e-10, 1.570309856668946e-05, 2.798287213837665e-05, 2.450987886140704e-10, 1.014076897073678e-10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
