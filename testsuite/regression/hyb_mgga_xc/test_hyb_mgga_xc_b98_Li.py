...
def test_hyb_mgga_xc_b98_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-7.364573090182809e-01, -1.042420391468050e+00, -3.997945540744015e-01, -1.233027719298141e-01, -6.883414387420989e-02, -1.844233723353857e-02, -3.556296480252319e-04]
...
def test_hyb_mgga_xc_b98_Li_2_vrho():
    ...
    ref_tgt = [-1.138426306409952e+00, -1.139209656375862e+00, -1.438745472901003e+00, -1.439827798313529e+00, -3.596906284583564e-01, -3.602292293759148e-01, -2.026911831339334e-01, -1.109406332014742e-02, -5.859882767474245e-02, 6.978073229586340e-03, -2.511945276427074e-02, -2.474939517751691e-02, -5.241036992465109e-04, -3.514164492896394e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
