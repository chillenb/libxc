...
def test_hyb_mgga_xc_pw6b95_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.354546513897435e+00, -9.812972907401395e-01, -3.258984174837740e-01, -1.163442394922345e-01, -5.992932642560635e-02, -5.789750503790081e-04, -1.221316061300120e-06]
...
def test_hyb_mgga_xc_pw6b95_Li_2_vrho():
    ...
    ref_tgt = [-1.668768752484872e+00, -1.670092644228721e+00, -1.152390508539972e+00, -1.153174034597005e+00, -3.030595123640002e-01, -3.030206231049525e-01, -1.490130090616449e-01, -2.898531886005789e-03, -5.603576322750260e-02, -1.616875528940094e-06, -2.398550212163443e-03, -2.172179762779519e-03, -8.246193329593103e-06, -2.389944179704456e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
