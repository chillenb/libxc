...
def test_hyb_mgga_xc_b0kcis_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.488996949000196e+00, -1.071452031254633e+00, -3.162327380179664e-01, -6.490633722514921e+79, -8.678955028441579e+80, -2.787774984917546e+109, -1.738494685683479e+56])
...
def test_hyb_mgga_xc_b0kcis_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([-3.035840979248775e-05, -7.034103415349772e-43, -5.956394438999101e-42, -5.937080900939433e-42, -2.811532432615062e-38, -2.963870361282260e-38, -2.045216027895315e-32, -4.887621591907894e-06, -2.771312176320362e-31, -3.145742044558463e-08, -2.303942272539986e-09, -5.054936212203982e-06, -6.406980012320759e-19, -1.508226637418507e-20])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
