...
def test_hyb_mgga_xc_b0kcis_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.434294103644828e+00, -1.036853686646574e+00, -3.454924649522592e-01, -1.219542076477373e-01, -6.094684496633276e-02, -9.999133362320536e-02, -4.021055101377800e-02]
...
def test_hyb_mgga_xc_b0kcis_Li_2_vrho():
    ...
    ref_tgt = [-1.850761214489899e+00, -1.851991397345073e+00, -1.290405852303311e+00, -1.291094155338896e+00, -3.141291073755342e-01, -3.137017040284683e-01, -1.851193293552242e-01, -2.427606455416831e-01, -6.338110618580302e-02, -9.500907651421309e-02, -2.784391329404227e-02, -2.793728181360515e-02, -5.596121978651536e-03, -4.840079364276042e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
