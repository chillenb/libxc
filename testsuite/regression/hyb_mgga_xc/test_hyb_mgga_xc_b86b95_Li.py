...
def test_hyb_mgga_xc_b86b95_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.340319588223586e+00, -9.670577080297558e-01, -3.219466367876163e-01, -1.154799541446738e-01, -5.948641816491945e-02, -1.614111822757033e-02, -3.025072142865996e-04])
