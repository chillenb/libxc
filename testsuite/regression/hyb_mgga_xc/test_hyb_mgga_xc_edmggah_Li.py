...
def test_hyb_mgga_xc_edmggah_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.253858638348744e-01, -9.915354397200554e-01, -3.984250404002251e-01, -1.173065054595286e-01, -6.765469273554985e-02, -1.242503894762664e-01, -3.259401590620280e-02])
...
def test_hyb_mgga_xc_edmggah_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([-8.951873830065592e-04, -8.976053805254673e-04, 1.240924862090529e-02, 1.239288573873080e-02, 9.155820013258643e-03, 9.133144453853093e-03, 9.477067219535777e-02, 8.609146752862047e-03, 1.704191562552016e-01, 1.367456163054625e-02, 8.805206062461522e-03, 8.703184878288054e-03, 1.273005242051690e-02, 1.403381611745374e-02])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
