...
def test_hyb_mgga_xc_tpss1kcis_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.754179851265707e+00, -1.223806671620935e+00, -3.586533458982329e-01, -1.546116266962858e-01, -6.668551215640380e-02, -1.791723697959249e-02, -3.339854697409885e-04])
...
def test_hyb_mgga_xc_tpss1kcis_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.178661604513869e+00, -2.180371723265829e+00, -1.557948383285905e+00, -1.559302079983530e+00, -3.349367386272709e-01, -3.353694732165591e-01, -2.016533730323851e-01, -1.306682394621697e-01, -6.903616856306616e-02, -4.532973269272330e-02, -2.406019804885203e-02, -2.386921506011776e-02, -4.822124818713236e-04, -3.428680337553541e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
