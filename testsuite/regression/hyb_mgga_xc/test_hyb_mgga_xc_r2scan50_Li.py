...
def test_hyb_mgga_xc_r2scan50_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.027664187464626e+00, -7.111903575517674e-01, -1.821304081896372e-01, -9.277703725600933e-02, -4.141097551027171e-02, -2.620751165313680e-03, -5.371020912182091e-07])
...
def test_hyb_mgga_xc_r2scan50_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([4.831406615621505e-03, 4.820892587412764e-03, 6.377056619114739e-03, 6.359958047994805e-03, -8.976610258049902e-05, -2.477814696141985e-05, -3.223819977805611e-02, -6.837476715043227e-02, -1.885031156977729e-02, -4.767734640579578e-02, 6.289664780784506e-04, 5.344174127866363e-02, 2.927994619822703e-10, -6.324714924461792e-15])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
