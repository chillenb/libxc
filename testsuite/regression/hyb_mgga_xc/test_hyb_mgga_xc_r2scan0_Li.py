...
def test_hyb_mgga_xc_r2scan0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.520993093951740e+00, -1.038638909850309e+00, -2.407012152351580e-01, -1.379930824999966e-01, -5.452344745867088e-02, -3.824898431060312e-03, -7.923871875124550e-07])
...
def test_hyb_mgga_xc_r2scan0_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.081583906309191e+00, -2.083338682082220e+00, -1.466997079338614e+00, -1.467915151894629e+00, -3.122637415265397e-01, -3.126943299468267e-01, -1.838184372808560e-01, 7.539152113143308e-02, -7.016576369109429e-02, -5.466433811679944e-02, 1.368037809691398e-01, 2.413768612877522e-01, 7.612061504734248e-05, -1.610477432387999e-07])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
