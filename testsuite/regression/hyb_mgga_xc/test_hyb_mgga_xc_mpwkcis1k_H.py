...
def test_hyb_mgga_xc_mpwkcis1k_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.669382962764645e-01, -3.424581622229194e-01, -2.133595831817067e-01, -8.422210101012904e-02, -2.260115400404197e-04]
...
def test_hyb_mgga_xc_mpwkcis1k_H_2_vrho():
    ...
    ref_tgt = [-5.205953279427363e-01, -2.236903732310476e-01, -4.452415654894433e-01, -1.870772614507487e-01, -2.517377360884935e-01, -1.295847842555173e-01, -7.158818294924096e-02, -2.851872973089982e-02, -8.374213313682015e-04, -9.920875263050759e-05]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
