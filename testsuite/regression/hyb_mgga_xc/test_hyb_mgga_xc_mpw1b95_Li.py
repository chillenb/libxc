...
def test_hyb_mgga_xc_mpw1b95_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.289354553160868e+00, -9.294824635182010e-01, -3.043216899658682e-01, -1.109027572851677e-01, -5.590666878293452e-02, -1.194610839109312e-03, -1.172257067378601e-06]
...
def test_hyb_mgga_xc_mpw1b95_Li_2_vsigma():
    ...
    ref_tgt = [-1.491580712578006e-04, 0.000000000000000e+00, -1.487182027364827e-04, -5.535556092306597e-04, 0.000000000000000e+00, -5.521409115611365e-04, -6.063319622614918e-02, 0.000000000000000e+00, -6.065036025274956e-02, -5.719003200175394e-01, 0.000000000000000e+00, 2.925430368400773e+01, -4.393459510317179e+01, 0.000000000000000e+00, 9.813318716470668e+02, 2.463161599384900e+01, 0.000000000000000e+00, 2.231795988835737e+01, 1.805362572041166e+04, 0.000000000000000e+00, 4.070643524784727e+02]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_hyb_mgga_xc_mpw1b95_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
