...
def test_hyb_mgga_xc_mpwb1k_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.054943599711664e+00, -7.615833393759056e-01, -2.488145142187272e-01, -9.002606370188392e-02, -4.537352832871922e-02, -9.720410164926203e-04, -1.163729010154000e-06])
