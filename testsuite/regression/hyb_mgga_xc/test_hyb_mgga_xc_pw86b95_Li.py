...
def test_hyb_mgga_xc_pw86b95_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.292667102495397e+00, -9.206322399264787e-01, -4.082395886793075e-01, -inf, -inf, -inf, -inf])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-08

# test_hyb_mgga_xc_pw86b95_Li_2_vrho() not generated due to NaN in reference data

# test_hyb_mgga_xc_pw86b95_Li_2_vsigma() not generated due to NaN in reference data
