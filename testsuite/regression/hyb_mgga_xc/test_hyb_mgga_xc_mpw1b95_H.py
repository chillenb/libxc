...
def test_hyb_mgga_xc_mpw1b95_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.291312277915432e-01, -4.005019185211164e-01, -2.495222243952554e-01, -9.849703338477220e-02, -2.643185681049708e-04]
...
def test_hyb_mgga_xc_mpw1b95_H_2_vrho():
    ...
    ref_tgt = [-5.716557929786064e-01, -2.638962389450027e-01, -5.005396730009923e-01, -2.439192485430376e-01, -2.840451834466154e-01, -1.780651619035293e-01, -8.190101553071902e-02, -3.716537509663863e-02, -9.739240901648079e-04, -8.062502798544483e-06]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
