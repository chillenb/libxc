...
def test_hyb_mgga_xc_pw86b95_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.203717717485558e-01, -4.046903838436811e-01, -2.539347067337389e-01, -2.309451621734182e-01, -1.214614908692442e+01])
...
def test_hyb_mgga_xc_pw86b95_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-5.321282282960005e-01, -2.638962389447704e-01, -5.228019284024852e-01, -2.518762289127052e-01, -2.967955031289581e-01, -1.961133971744914e-01, -8.107203040533667e-04, -6.015799346401181e-03, 4.750822473847852e+00, -4.693930258717262e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
