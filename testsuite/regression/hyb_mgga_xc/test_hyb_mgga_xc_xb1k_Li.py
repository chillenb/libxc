...
def test_hyb_mgga_xc_xb1k_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-7.504564445900352e-01, -5.433855310281193e-01, -1.774942531442144e-01, -6.292954695970934e-02, -3.172141603568533e-02, -3.870805802127895e-02, -1.556258869840989e-02]
...
def test_hyb_mgga_xc_xb1k_Li_2_vsigma():
    ...
    ref_tgt = [-6.573540035964337e-05, 0.000000000000000e+00, -6.556995002601656e-05, -2.426193608084158e-04, 0.000000000000000e+00, -2.421721686845205e-04, -3.210998111571252e-02, 0.000000000000000e+00, -3.216119409698701e-02, 7.779524778345837e-01, 0.000000000000000e+00, -3.824310748495262e+02, -2.263051865271536e+01, 0.000000000000000e+00, -1.407733786683281e+07, -3.363874611878738e+02, 0.000000000000000e+00, -3.378604627073167e+02, -4.177827240104549e+07, 0.000000000000000e+00, -1.245059595372673e+08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_hyb_mgga_xc_xb1k_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
