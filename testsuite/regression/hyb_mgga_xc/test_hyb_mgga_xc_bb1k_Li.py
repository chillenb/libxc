...
def test_hyb_mgga_xc_bb1k_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.090594992926128e+00, -7.870089806463645e-01, -2.603846573369611e-01, -9.323777116416608e-02, -4.713221877123291e-02, -7.727256842426522e-02, -3.109724251406577e-02])
...
def test_hyb_mgga_xc_bb1k_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-1.175759909814642e-04, 0.000000000000000e+00, -1.172387916244061e-04, -4.382421896731071e-04, 0.000000000000000e+00, -4.371809305919185e-04, -5.680698776326668e-02, 0.000000000000000e+00, -5.686545811150685e-02, -5.518361508094083e-02, 0.000000000000000e+00, -7.713133744686176e+02, -3.790429472225554e+01, 0.000000000000000e+00, -2.813109590470000e+07, -6.746594535822554e+02, 0.000000000000000e+00, -6.766197400957878e+02, -8.350234026730312e+07, 0.000000000000000e+00, -2.487974491247112e+08])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
