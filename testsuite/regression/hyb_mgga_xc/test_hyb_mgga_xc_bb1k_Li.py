...
def test_hyb_mgga_xc_bb1k_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.066987340449006e+00, -7.639351423048065e-01, -3.706199493501207e-01, -5.019423412078206e+79, -6.711725221994821e+80, -2.155879321669569e+109, -1.344435890261890e+56])
...
def test_hyb_mgga_xc_bb1k_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.387659073288405e+00, -1.388712220580933e+00, -9.669508167211386e-01, -9.676204510534366e-01, -1.593936177368635e-01, -1.616196733355546e-01, 2.792852842238862e+66, -9.848142559886196e+80, 1.078569452337341e+71, -2.409368518039024e+85, -1.074057739152810e+107, -1.097595813315504e+107, -1.670484991869728e+54, -4.648373983428211e+40])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
