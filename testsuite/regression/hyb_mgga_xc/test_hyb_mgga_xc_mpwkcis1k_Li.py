...
def test_hyb_mgga_xc_mpwkcis1k_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.105092975254506e+00, -7.963680130802711e-01, -2.625871364119140e-01, -9.550400240376081e-02, -4.780425814596111e-02, -1.053664416655907e-03, -6.710685854965806e-08])
...
def test_hyb_mgga_xc_mpwkcis1k_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.407329350028336e+00, -1.408399631931309e+00, -9.732729316964734e-01, -9.739086120330523e-01, -2.415050752146080e-01, -2.413291664101570e-01, -1.366283147511176e-01, -1.112419216450001e-01, -4.820858650888341e-02, -4.460850787001481e-02, -3.983041162039891e-03, -3.777418443466264e-03, -2.610947554162450e-07, -2.033982051678768e-07])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
