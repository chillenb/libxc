...
def test_hyb_mgga_xc_b94_hyb_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.277844423089405e+00, -1.073866371020148e+00, -4.174266304703520e-01, -1.244127334388073e-01, -7.329045699456353e-02, -1.433071115604445e-01, -4.184977659415168e-02])
