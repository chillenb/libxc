...
def test_gga_c_wi0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.164346623774568e-02, -4.685540312193548e-02, 4.875898714721858e-04, -3.404445429015793e-02, -7.393166450511054e-05, -1.552990692053925e-09, -8.722642844107701e-17]
...
def test_gga_c_wi0_Li_2_vrho():
    ...
    ref_tgt = [-6.099808246265189e-02, -6.099808246265189e-02, -6.984281658271246e-02, -6.984281658271246e-02, -5.638096867317951e-03, -5.638096867317951e-03, -5.382719319795302e-02, -5.382719319795302e-02, -2.289550766215263e-03, -2.289550766215263e-03, -9.317942909063192e-09, -9.317942909063192e-09, -5.233585706462791e-16, -5.233585706462791e-16]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
