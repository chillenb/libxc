...
def test_gga_c_tm_pbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.242338989795505e-02, -4.204578890536159e-02, -1.682031816936040e-03, -1.997064484103751e-02, -1.766553936153176e-03, -8.968843149929906e-09, -2.851993814723119e-16])
...
def test_gga_c_tm_pbe_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.481659144896319e-01, -1.480204311779751e-01, -1.234006070051231e-01, -1.232971049496025e-01, -1.017357187055772e-02, -1.017702300937304e-02, -2.070101495927371e-02, -1.534833850815314e-01, -1.059427259419459e-02, 1.311593632448937e-01, -5.740509991134280e-08, -5.769815719204225e-08, -1.803062094161284e-15, -2.134069017421109e-15])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
