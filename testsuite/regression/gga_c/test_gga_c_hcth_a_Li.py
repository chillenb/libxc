...
def test_gga_c_hcth_a_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.609140258547082e-02, -5.913738465214774e-02, -1.172917668722112e-02, -2.617257324312230e-03, -7.561194445493260e-03, 1.298172851149942e-02, 1.881711414417168e-04])
