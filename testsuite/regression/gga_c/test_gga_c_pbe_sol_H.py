...
def test_gga_c_pbe_sol_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.218904080893924e-02, -2.105695116741650e-02, -1.086802659596534e-02, -3.119437149590818e-04, -4.901177499874038e-10]
...
def test_gga_c_pbe_sol_H_2_vrho():
    ...
    ref_tgt = [-3.681703832847154e-02, 1.014698796252341e+00, -4.166223086453444e-02, 5.660683950431883e+01, -3.163923290903242e-02, 3.977148618814145e+01, -1.798230216745867e-03, 6.346862779076641e-01, -3.188556943868950e-09, 2.244372685551894e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
