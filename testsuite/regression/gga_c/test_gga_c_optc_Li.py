...
def test_gga_c_optc_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.880406006524254e-02, -4.493011075647285e-02, -4.147859216339926e-03, -1.008617603171354e-02, -9.618127524879686e-04, -8.166063620299009e-09, -1.714394735606090e-16])
