...
def test_gga_c_pbe_erf_gws_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.723873479144241e-02, -4.125521695121536e-02, -5.048854861858292e-03, -2.172655147041317e-03, -5.861716530430343e-05, -1.141628619987541e-05, -5.041102820139185e-11]
...
def test_gga_c_pbe_erf_gws_Li_2_vrho():
    ...
    ref_tgt = [-1.098442340448478e-01, -1.097228740077402e-01, -9.446835784148656e-02, -9.437827201153039e-02, -2.119436711039607e-02, -2.120178124067217e-02, -4.427824752877531e-03, -3.095066844260547e-02, -1.461414560099423e-04, -3.370118460745902e-03, -2.277511945974944e-05, -2.326706310468423e-05, -6.852340482379549e-11, -1.907193707619031e-10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
