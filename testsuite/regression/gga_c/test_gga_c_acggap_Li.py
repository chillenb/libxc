...
def test_gga_c_acggap_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.162959935813039e-02, -4.551217750120349e-02, -4.269772803321074e-03, -1.571258051686454e-02, -2.402807427699548e-03, -3.720088347959616e-08, -1.161126316623351e-15]
...
def test_gga_c_acggap_Li_2_vrho():
    ...
    ref_tgt = [-1.149988842171879e-01, -1.148714649075837e-01, -1.009962166662632e-01, -1.008994734764397e-01, -2.023071257860209e-02, -2.023816738992298e-02, -2.353618621140318e-02, -1.025061305996638e-01, -9.868276047176792e-03, 5.077130028670657e-01, -2.326969235528113e-07, -2.338786518765141e-07, -7.262778974146539e-15, -8.593745561089744e-15]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
