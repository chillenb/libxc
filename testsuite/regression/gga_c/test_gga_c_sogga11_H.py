...
def test_gga_c_sogga11_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.215609861919697e-02, -2.168865826145234e-02, -3.033535084324958e-02, -5.294468977223730e-02, -1.680094792133735e-02]
...
def test_gga_c_sogga11_H_2_vrho():
    ...
    ref_tgt = [-3.664562482956496e-02, 4.383663180874075e+00, -4.457112759885549e-02, 1.518336173303479e+02, 5.536895878447094e-02, -3.941475208000655e+02, 5.315124093818791e-02, -1.331820986626311e+02, -2.123689604032047e-02, -8.481046891208931e-02]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
