...
def test_gga_c_bmk_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-8.581951705370196e-02, -4.672195536731544e-02, -5.840183648538782e-03, -2.482709434258187e-02, 1.216086196705140e-03, 1.103585927895628e-02, 2.004194824321805e-04]
...
def test_gga_c_bmk_Li_2_vrho():
    ...
    ref_tgt = [-2.494094523884693e-01, -2.493913658738989e-01, -1.356064740815593e-01, -1.355552662484592e-01, -6.513056277931424e-02, -6.546820097719988e-02, -7.768696036830908e-02, 3.900836603457248e-01, 2.892064091837825e-03, 2.398445532357359e-01, 1.378441498384796e-02, 1.417094517727067e-02, 1.464514613049552e-04, 6.009590363682180e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
