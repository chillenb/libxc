...
def test_gga_c_p86_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.331427216601507e-02, -4.670901392822047e-02, 3.681689640734326e-03, -1.591259549341341e-02, -2.434590245040283e-03, -6.749577227957240e-03, -1.672862342604614e-04])
