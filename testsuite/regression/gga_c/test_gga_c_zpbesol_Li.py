...
def test_gga_c_zpbesol_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.703038854967247e-02, -5.108206521841256e-02, -5.363806991765085e-03, -1.607161149585005e-02, -7.369504650861261e-03, -4.290713484707909e-04, -1.681738173367795e-04]
...
def test_gga_c_zpbesol_Li_2_vrho():
    ...
    ref_tgt = [-1.172911624863344e-01, -1.172219625438186e-01, -1.053537628477081e-01, -1.053762627817033e-01, -2.573715285085386e-02, -2.523427852643498e-02, -2.314743833632123e-02, -1.021828539409714e-01, -5.062045356749381e-04, 2.961198693911313e+00, -7.410051704422098e-02, 7.758262288615372e-02, -1.978391892536515e-04, -2.903012928114558e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
