...
def test_gga_c_p86_ft_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.217521646876693e-02, -1.852706915030256e-02, -6.729525474225508e-03, 7.725196263655024e-03, -1.551468681653548e-03]
...
def test_gga_c_p86_ft_H_2_vrho():
    ...
    ref_tgt = [-3.692949770222917e-02, -2.218122190599615e-01, -4.462536252717236e-02, -2.122216756948365e-01, -3.825623333227448e-02, -1.661917628949329e-01, 2.741903671040950e-03, -4.897082562749759e-02, -1.979020007809162e-03, -7.162845481729079e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
