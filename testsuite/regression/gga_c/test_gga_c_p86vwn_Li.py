...
def test_gga_c_p86vwn_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.412858422859917e-02, -4.768936266902273e-02, 3.875086737792903e-03, -1.577801434614419e-02, -2.432412263493292e-03, -6.794960882900992e-03, -1.629259198827822e-04]
...
def test_gga_c_p86vwn_Li_2_vrho():
    ...
    ref_tgt = [-1.178415980422796e-01, -1.177241821062459e-01, -1.051736600517363e-01, -1.050868102288706e-01, -2.448387347899375e-02, -2.448826637538694e-02, -2.327938744527257e-02, -1.293580889603090e-01, -1.432571187171524e-02, -6.848427264468007e-02, -8.545028099609225e-03, -8.639536931595125e-03, -1.914214508247163e-04, -2.832624807333714e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
