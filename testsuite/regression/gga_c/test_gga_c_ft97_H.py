...
def test_gga_c_ft97_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.194305041821948e-02, -2.953893914300077e-04, -8.804857125179791e-06, -8.804948945328980e-06, -8.804954623664334e-06]
...
def test_gga_c_ft97_H_2_vrho():
    ...
    ref_tgt = [-3.655891089137847e-02, 3.145067318711612e+06, -1.271755657725238e-02, 2.201429248136724e+06, -8.804997227993624e-06, 4.587340041527487e+05, -8.804920824165535e-06, 8.744863006198906e+03, -8.804954523969984e-06, 9.143728441156449e-01]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
