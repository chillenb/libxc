...
def test_gga_c_pbe_erf_gws_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.283412555957990e-02, -1.535597754783565e-02, -7.882089961704227e-03, -2.476668289717114e-04, -9.720218380193657e-11]
...
def test_gga_c_pbe_erf_gws_H_2_vrho():
    ...
    ref_tgt = [-2.878434327107222e-02, 1.143567132690991e+02, -2.992015482760224e-02, 9.717057788698861e+01, -1.756185041376101e-02, 2.694231733444943e+01, -5.895107920280748e-04, 1.582507919087009e-02, -2.572485880997927e-10, -1.076149053549479e-06]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
