...
def test_gga_c_pbeloc_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.223726131975330e-02, -1.769147803041506e-02, -4.117853623090181e-03, -5.301681702858316e-06, -1.033353090595934e-14]
...
def test_gga_c_pbeloc_H_2_vrho():
    ...
    ref_tgt = [-3.676418777347409e-02, 2.127043311962064e-01, -5.160098850728106e-02, 2.081843027777553e+01, -2.654515719525006e-02, 7.408157211478209e+00, -5.529088575856843e-05, 1.314762321038589e-04, -1.152363794665323e-13, -4.565544990675630e-13]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
