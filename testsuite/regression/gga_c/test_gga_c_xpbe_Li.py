...
def test_gga_c_xpbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.060898885461793e-02, -4.527799266858566e-02, -3.418514298632165e-03, -1.446947192500918e-02, -1.028163975438139e-03, -4.482135393737985e-09, -9.958396954279358e-17])
