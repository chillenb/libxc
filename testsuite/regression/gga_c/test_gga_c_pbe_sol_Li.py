...
def test_gga_c_pbe_sol_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.703036616384539e-02, -5.108202438662889e-02, -5.363725291271257e-03, -1.600564332618745e-02, -2.216562647125218e-03, -1.600309951395318e-08, -3.818017950407704e-16]
...
def test_gga_c_pbe_sol_Li_2_vsigma():
    ...
    ref_tgt = [4.028547001501965e-05, 8.057094003003931e-05, 4.028547001501965e-05, 1.373922762266883e-04, 2.747845524533765e-04, 1.373922762266883e-04, 4.882146493292004e-03, 9.764292986584010e-03, 4.882146493292004e-03, 2.489468031800216e+00, 4.978936063600431e+00, 2.489468031800216e+00, 1.594123656228095e+01, 3.188247312456189e+01, 1.594123656228095e+01, 3.529155396068316e-04, 7.058310792173810e-04, 3.529155396068316e-04, 3.380088498550873e-06, 6.759926358451161e-06, 3.380088498550873e-06]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
