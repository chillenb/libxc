...
def test_gga_c_zvpbeint_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.481249212962609e-02, -4.864024140214231e-02, -4.496995857153345e-03, -1.578711481768095e-02, -3.746686705966969e-03, -1.537287484462690e-08, 0.000000000000000e+00])
