...
def test_gga_c_regtpss_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.038653647892862e-02, -4.405609879116904e-02, -3.600994651649092e-03, -1.562523635986147e-02, -2.072351503042441e-03, -2.003205894392235e-08, -5.655198531684391e-16])
