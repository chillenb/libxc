...
def test_gga_c_p86vwn_ft_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-3.202368366850009e-02, -1.834278646004013e-02, -6.488505678974788e-03, 7.767047748883812e-03, -1.560270763521161e-03])
...
def test_gga_c_p86vwn_ft_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-3.685274334945465e-02, -2.703381432200373e-01, -4.454119273613588e-02, -2.567421119698116e-01, -3.799993252170022e-02, -1.950387240452968e-01, 2.830156652266439e-03, -5.799411406289971e-02, -1.992584993558445e-03, -6.955993051274208e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
