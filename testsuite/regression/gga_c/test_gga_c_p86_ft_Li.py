...
def test_gga_c_p86_ft_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.331938976238458e-02, -4.671643087095365e-02, 3.661159717066064e-03, -1.591271189964331e-02, -2.436273014941915e-03, -6.749577460215788e-03, -1.672862342604614e-04]
...
def test_gga_c_p86_ft_Li_2_vrho():
    ...
    ref_tgt = [-1.172348891132761e-01, -1.170761451792176e-01, -1.042958046524970e-01, -1.041764770190394e-01, -2.442504988419618e-02, -2.443795599903752e-02, -2.347771111920923e-02, -1.139515276187296e-01, -1.435761635607451e-02, -6.198429405861142e-02, -8.487071546414721e-03, -8.584808379014189e-03, -1.994023115233301e-04, -2.814219358193011e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
