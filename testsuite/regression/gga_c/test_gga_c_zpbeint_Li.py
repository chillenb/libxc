...
def test_gga_c_zpbeint_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.481250426096591e-02, -4.864026334566786e-02, -4.497037507838732e-03, -1.579304186413713e-02, -5.152615871683619e-03, -2.180468351039820e-04, -1.681738173367795e-04])
