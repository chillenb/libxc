...
def test_gga_c_p86_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.217521030080221e-02, -1.852558840415336e-02, -6.726524171924732e-03, 7.733526492633899e-03, -1.551468412646858e-03]
...
def test_gga_c_p86_H_2_vrho():
    ...
    ref_tgt = [-3.692951262872283e-02, -2.218122288464845e-01, -4.462821311704428e-02, -2.122232923295844e-01, -3.826131514755813e-02, -1.661943436249679e-01, 2.738668876769473e-03, -4.896711856436596e-02, -1.979015306779847e-03, -7.162840556528672e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
