...
def test_gga_c_p86vwn_ft_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.413370182496868e-02, -4.769677961175591e-02, 3.854556814124638e-03, -1.577813075237409e-02, -2.434095033394923e-03, -6.794961115159539e-03, -1.629259198827822e-04])
