...
def test_gga_c_scan_e0_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.209192242829097e-02, -2.146623832023406e-02, -1.427568895884108e-02, -4.770930985083006e-03, -1.715800527656941e-04]
...
def test_gga_c_scan_e0_H_2_vrho():
    ...
    ref_tgt = [-3.692621122888581e-02, 7.415270742969806e+00, -3.653576489694702e-02, 7.666490219011767e+01, -2.595917288710072e-02, 1.608118259395029e+01, -8.834986340322801e-03, -1.271208561786164e+00, -3.293877991411872e-04, 2.650979668268040e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
