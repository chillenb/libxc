...
def test_gga_c_regtpss_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.208863927633740e-02, -1.875338432262434e-02, -8.898355178054443e-03, -2.599113766272223e-04, -6.948119325982799e-10]
...
def test_gga_c_regtpss_H_2_vrho():
    ...
    ref_tgt = [-3.693879935431634e-02, 1.721624345323563e+01, -4.117163228020032e-02, 7.103853482010346e+02, -2.876189302040136e-02, 4.161403937222119e+02, -1.490419151712521e-03, 5.429911640212540e+00, -4.506701542115674e-09, 4.283130421737971e-07]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
