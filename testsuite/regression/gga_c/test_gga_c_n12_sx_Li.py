...
def test_gga_c_n12_sx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.221613486277920e-01, -8.072964913021405e-02, 6.365691594341875e-02, -3.667774372269773e-02, 1.021438236135225e-02, -2.662106244479953e-03, 2.130194179689505e-05])
