...
def test_gga_c_tm_lyp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.308802401244001e-02, -4.749551825045203e-02, 2.538289223896503e-02, -2.045646231218717e-05, -7.424887660998828e-09, -3.664830560077031e-03, -5.578954301464629e-05])
