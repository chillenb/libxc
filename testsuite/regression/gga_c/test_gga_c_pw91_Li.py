...
def test_gga_c_pw91_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.285424634539820e-02, -4.708577829899061e-02, -3.990548841963676e-03, -1.521984741125060e-02, -1.451865117542804e-03, -7.852165179352000e-09, -1.786494129712990e-16]
...
def test_gga_c_pw91_Li_2_vsigma():
    ...
    ref_tgt = [3.983663070495298e-05, 7.967326140990596e-05, 3.983663070495298e-05, 1.307708120093601e-04, 2.615416240187202e-04, 1.307708120093601e-04, 3.790454806682013e-03, 7.580909613364026e-03, 3.790454806682013e-03, 3.260964096831356e+00, 6.521928193662712e+00, 3.260964096831356e+00, 1.182151125193423e+01, 2.364302250386845e+01, 1.182151125193423e+01, 1.732042923415531e-04, 3.464085846831062e-04, 1.732042923415531e-04, 1.606953340538462e-06, 3.213906681076925e-06, 1.606953340538462e-06]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
