...
def test_gga_c_tau_hcth_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.926841276283806e-02, -7.183807296963320e-02, 1.269012084639545e-02, -2.776623423359934e-03, -1.147381093652308e-02, 2.978600699168261e-02, 4.807311556994247e-04])
...
def test_gga_c_tau_hcth_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([2.283845135741096e-03, 2.284668414089969e-03, -2.804499727942623e-03, -2.736335053506537e-03, -2.198160793275328e-01, -2.209845619535433e-01, 2.458606159543771e-03, 1.221928670079901e+00, -9.663047025510381e-03, 7.439987762524982e-01, 3.736150599856880e-02, 3.860622885550610e-02, 2.538346950894380e-04, 1.719679550588644e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
