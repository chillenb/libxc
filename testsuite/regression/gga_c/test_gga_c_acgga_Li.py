...
def test_gga_c_acgga_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.155181882468815e-02, -4.534982135558897e-02, -3.798094949056738e-03, -1.523930555047293e-02, -1.503265634489524e-03, -1.331092027399838e-08, -3.691166296226900e-16]
...
def test_gga_c_acgga_Li_2_vrho():
    ...
    ref_tgt = [-1.150256867650166e-01, -1.148983776346154e-01, -1.009950301840160e-01, -1.008985278419865e-01, -1.851454410466881e-02, -1.852125178772706e-02, -2.407309625157115e-02, -9.772839125403270e-02, -7.037075050878860e-03, 3.850288188804456e-01, -8.380096004960747e-08, -8.422391368786604e-08, -2.303990602903899e-15, -2.726964975444807e-15]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
