...
def test_gga_c_cs1_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.014824293955897e-02, -4.629220440120434e-02, -2.024194100705756e-03, -6.116507047468900e-03, 1.680896297866659e-03, 3.011777301041895e-03, 6.619951194421702e-05]
...
def test_gga_c_cs1_Li_2_vrho():
    ...
    ref_tgt = [-5.455286131471203e-02, -5.436251710042202e-02, -5.573133517944984e-02, -5.555759370215654e-02, -5.949506369906379e-02, -5.947744845847969e-02, -7.758202594282910e-03, -4.599278008790979e-02, -1.207391743015411e-02, -2.514087283122250e-02, 4.011695913533000e-03, 3.901281852111236e-03, 1.128752343153146e-04, 1.971740147922522e-05]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
