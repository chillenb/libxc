...
def test_gga_c_gam_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.062983289275057e-03, -7.254760395990823e-03, -2.444548979517482e-02, 1.032705037590332e-02, -6.914779699624141e-03, 4.827805603917291e-02, 8.190700694174063e-04])
