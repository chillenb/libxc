...
def test_gga_c_hyb_tau_hcth_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-8.006836321881308e-02, -7.117238660793022e-02, 1.330200899050856e-02, -1.469818134587231e-02, -6.182533055326352e-03, 1.426188091650230e-02, 2.301594012447062e-04])
...
def test_gga_c_hyb_tau_hcth_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-9.421443145787015e-02, -9.415619995585003e-02, -7.834769379255162e-02, -7.826571343529524e-02, -1.201992618551602e-01, -1.208403252359196e-01, -2.435554090534737e-02, 5.871901998924398e-01, -7.365194174156015e-03, 3.556453424691938e-01, 1.792030447557192e-02, 1.851802843711179e-02, 1.218537442194225e-04, 8.224024500168826e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
