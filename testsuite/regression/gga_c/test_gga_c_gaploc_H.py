...
def test_gga_c_gaploc_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.247068212624266e-02, -2.595263724563179e-02, -4.545634312484637e-03, -1.154125654603895e-03, -4.732562073224770e-06]
...
def test_gga_c_gaploc_H_2_vrho():
    ...
    ref_tgt = [-3.644682239873463e-02, -2.240088326344734e-01, -7.822887578451133e-02, -2.630951902497231e-01, -2.222243416090218e-02, -7.804425921346886e-02, -2.423632702738347e-03, -1.782930878466095e-02, -1.729356459220601e-05, -9.920026077805281e-05]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
