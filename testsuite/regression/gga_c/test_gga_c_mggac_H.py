...
def test_gga_c_mggac_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.228650861747501e-02, -2.382855897612306e-02, -1.405210303172670e-02, -6.530229730483655e-04, -1.151968923029933e-09]
...
def test_gga_c_mggac_H_2_vrho():
    ...
    ref_tgt = [-3.669047342899417e-02, 5.679502823194562e-01, -4.116543789142404e-02, 3.922565710404070e+01, -3.407958789335010e-02, 3.321707534383676e+01, -3.568765530482096e-03, 1.222549764899561e+00, -7.493434614784175e-09, 5.274198293771584e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
