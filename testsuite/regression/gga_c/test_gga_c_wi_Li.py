...
def test_gga_c_wi_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.259374702740577e-01, -8.861249385038167e-02, 1.566069915934520e-03, -1.526579017861598e-02, 1.666183621919468e-04, -1.679910921105222e-09, 0.000000000000000e+00])
