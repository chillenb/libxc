...
def test_gga_c_pbe_jrgx_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.224058370811983e-02, -2.245312517511208e-02, -1.240796872405720e-02, -4.462320378767620e-04, -7.363543947768586e-10]
...
def test_gga_c_pbe_jrgx_H_2_vrho():
    ...
    ref_tgt = [-3.675028405129285e-02, 7.777875047845768e-01, -4.153146815070007e-02, 4.785038155557844e+01, -3.308429020886354e-02, 3.708827835204593e+01, -2.515144355215311e-03, 8.766899102458282e-01, -4.790247424418803e-09, 3.371693189035095e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
