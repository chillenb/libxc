...
def test_gga_c_op_g96_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.352084493639449e-02, -4.635721575784840e-02, -1.173587712659869e-02, -4.351177682762987e-06, -4.924158875277586e-10, -1.804359080553705e-07, -1.673057496149299e-14]
...
def test_gga_c_op_g96_Li_2_vrho():
    ...
    ref_tgt = [-6.890553005313894e-02, -6.873533990186610e-02, -6.718693660977554e-02, -6.702146454573389e-02, -3.390086124464489e-02, -3.397720861238894e-02, -1.935664731696112e-06, -2.227151708032216e-02, -6.305758971434830e-10, -3.303735912993994e-03, -1.153671836754466e-06, -1.156623899086828e-06, -7.870429127688322e-14, -2.135408425448671e-13]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
