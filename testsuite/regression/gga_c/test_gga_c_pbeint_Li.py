...
def test_gga_c_pbeint_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.481249212961580e-02, -4.864024140212887e-02, -4.496995857151145e-03, -1.575579924670539e-02, -1.897411582425819e-03, -1.252548281673732e-08, -2.994295349861842e-16])
