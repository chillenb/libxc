...
def test_mgga_k_gea2_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([3.153251819383776e+00, 1.687464332401589e+00, 6.148959394071615e-01, 9.639340498542932e-02, 7.619949676053719e-02])
...
def test_mgga_k_gea2_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([3.388871680450207e+00, 4.239812737947641e-16, 2.673306887354116e+00, 4.650591113897583e-16, 8.769385073643794e-01, 1.152933514152392e-16, 1.000370885409721e-02, 3.943193004512873e-17, -7.596335982873278e-02, -2.106249092604617e-17])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
