...
def test_lda_x_rel_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.732890248232275e+00, -1.204272316871665e+00, -2.893667467981168e-01, -1.568996674851774e-01, -6.221852007736686e-02, -1.139515997998508e-02, -2.127820881238722e-04])
