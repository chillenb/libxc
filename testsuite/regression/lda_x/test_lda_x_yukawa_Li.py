...
def test_lda_x_yukawa_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.599090515080575e+00, -1.072459039100240e+00, -1.855466281829784e-01, -7.287521908398913e-02, -1.201774212846440e-02, -1.244781577550382e-04, -8.801054394122955e-10])
