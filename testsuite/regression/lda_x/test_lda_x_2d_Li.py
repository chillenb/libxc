...
def test_lda_x_2d_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-3.834246404850115e+00, -2.218082225646937e+00, -2.609204580024534e-01, -1.041838486753562e-01, -2.601247963402268e-02, -2.038844358730323e-03, -5.240589488369279e-06])
