...
def test_lda_x_rae_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.064414213916571e-01, -7.389965589678735e-02, -1.774173512837072e-02, -9.619467641586929e-03, -3.814566167392496e-03, -6.986268584350001e-04, -1.304547457106965e-05])
