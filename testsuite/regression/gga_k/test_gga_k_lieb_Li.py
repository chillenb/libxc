...
def test_gga_k_lieb_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [1.665015103925978e+01, 8.409957017239657e+00, 1.038640101114823e+00, 1.335414009487452e-01, 3.369908369591745e-02, 5.741152769360279e-01, 2.522599351623472e-01]
