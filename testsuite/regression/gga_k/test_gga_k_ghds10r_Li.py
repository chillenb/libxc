...
def test_gga_k_ghds10r_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([2.016063220859260e+01, 1.181807803827240e+01, 3.700765148920173e+00, 1.836356203314823e-01, 1.079599571025859e-01, 3.069854398322075e+00, 1.268174499514641e+00])
