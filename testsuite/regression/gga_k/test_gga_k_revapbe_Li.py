...
def test_gga_k_revapbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [1.645264609327986e+01, 8.201242892226375e+00, 6.913186935936576e-01, 1.324477729144583e-01, 2.768810126732575e-02, 1.532845269043814e-03, 5.452312965178888e-07]
...
def test_gga_k_revapbe_Li_2_vrho():
    ...
    ref_tgt = [2.587960714775697e+01, 2.592713869425544e+01, 1.226788964145916e+01, 1.228920415637111e+01, 7.890665961790164e-01, 7.891438154638981e-01, 2.134116636764148e-01, 2.323558101848670e-03, 3.226908605716674e-02, 2.343131834516740e-06, 2.568629247958795e-03, 2.531743792648414e-03, 1.045386035766431e-06, 5.283293025421091e-07]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
