...
def test_gga_k_fr_pw86_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([1.636341365580267e+01, 8.166431481103384e+00, 6.285860878715159e-01, 1.318090282161616e-01, 2.640619425395839e-02, 2.986314289362507e-03, 4.390617505891872e-06])
