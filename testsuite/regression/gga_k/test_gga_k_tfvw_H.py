...
def test_gga_k_tfvw_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [2.044257181173193e+00, 2.104865332347225e+00, 1.058560114349892e+00, 5.483493033503209e-01, 6.850870573883101e-01]
...
def test_gga_k_tfvw_H_2_vrho():
    ...
    ref_tgt = [3.379759869697645e+00, 3.461364019530318e-16, 2.255905887408478e+00, 4.257447695260347e-16, 4.332743324216389e-01, 1.513347654761960e-16, -4.419521895113461e-01, 2.571818608189923e-16, -6.848509275665903e-01, -1.303598203630978e-16]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
