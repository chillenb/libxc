...
def test_gga_k_ghds10_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([2.979969605369012e+00, 2.987230847451244e+00, 1.678664564617834e+00, 5.228311213584860e-01, -8.344527836686746e-01])
...
def test_gga_k_ghds10_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([4.478472293893468e+00, 3.447506658946765e-16, 3.301271402512501e+00, 5.706663397366814e-16, 1.216378782689595e+00, 1.880065105535239e-16, -3.044703715032122e-01, 2.709829965638825e-16, -2.041390786367502e+00, 7.289382042859648e-17])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
