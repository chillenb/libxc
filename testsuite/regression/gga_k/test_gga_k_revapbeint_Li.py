...
def test_gga_k_revapbeint_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([1.635108299798342e+01, 8.124369984141268e+00, 6.876337984867711e-01, 1.319055232519803e-01, 2.742704935727755e-02, 1.532845870680016e-03, 5.452312967211747e-07])
