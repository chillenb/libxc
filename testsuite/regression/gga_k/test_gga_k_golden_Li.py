...
def test_gga_k_golden_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [1.708445482251228e+01, 8.832161653382073e+00, 1.369798820944263e+00, 1.357128942357840e-01, 4.107854193457327e-02, 8.917533116741353e-01, 3.919928163749357e-01]
...
def test_gga_k_golden_Li_2_vrho():
    ...
    ref_tgt = [2.520129116934255e+01, 2.524894900195659e+01, 1.155129710032355e+01, 1.157235924075312e+01, -1.926374033483017e-01, -1.960320074784574e-01, 2.103069886752161e-01, -8.821146604654112e-01, 1.326005819637818e-02, -3.496202058459864e-01, -8.748065577186979e-01, -9.053895308591792e-01, -4.097731375441126e-01, -3.425025566712487e-01]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
