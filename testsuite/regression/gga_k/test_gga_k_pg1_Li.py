...
def test_gga_k_pg1_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([1.774452290925365e+01, 9.644112101748789e+00, 3.221303991474779e+00, 1.392081311793968e-01, 7.412979614079540e-02, 3.084472388730704e+00, 1.356897369842305e+00])
