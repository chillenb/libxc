...
def test_gga_k_meyer_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([1.633580987461021e+01, 8.105476547569589e+00, 8.231773564278445e-01, 1.328643978390465e-01, 2.859757762496560e-02, 3.063258465969247e+00, 1.356889842284533e+00])
