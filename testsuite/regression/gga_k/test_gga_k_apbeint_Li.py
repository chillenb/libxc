...
def test_gga_k_apbeint_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [1.634463860534681e+01, 8.111633244890548e+00, 6.387888109917754e-01, 1.318878369872935e-01, 2.649454721264879e-02, 1.232370526688642e-03, 4.381281428667161e-07]
...
def test_gga_k_apbeint_Li_2_vrho():
    ...
    ref_tgt = [2.593320584694168e+01, 2.598081569870889e+01, 1.229645832991399e+01, 1.231781008223680e+01, 8.259163343552550e-01, 8.259125935928092e-01, 2.137791140996131e-01, 1.869414778250361e-03, 3.351812952520139e-02, 1.882861029887014e-06, 2.066876498472942e-03, 2.037063769960733e-03, 8.400350322142691e-07, 4.245464347148940e-07]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
