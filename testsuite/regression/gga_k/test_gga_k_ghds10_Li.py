...
def test_gga_k_ghds10_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([2.152143424457730e+01, 1.300716264415231e+01, 4.218396178812181e+00, 4.129227577192973e-01, -9.777276152496937e-02, 2.065283327872815e+00, -1.614753878786764e+00])
