...
def test_gga_k_lgap_ge_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [2.036620030788646e+00, 1.699447008104956e+00, 6.260269972625329e-01, 1.199690448534504e-01, 8.099257263003803e-01]
...
def test_gga_k_lgap_ge_H_2_vrho():
    ...
    ref_tgt = [3.389338826754550e+00, -9.536047380478885e-17, 2.669094806404696e+00, 2.172761779280240e-16, 8.653025486671143e-01, 1.303396004674167e-17, -4.111347258901073e-02, 6.506139608430476e-17, -1.787728544565358e+00, -2.531966765997275e-16]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
