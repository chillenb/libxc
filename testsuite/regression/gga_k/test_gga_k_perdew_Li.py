...
def test_gga_k_perdew_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([1.633558506039394e+01, 8.104182978448975e+00, 7.988262005204988e-01, 1.319684209290910e-01, 2.835508800145245e-02, 3.440943104661968e-01, 1.510708819611323e-01])
