...
def test_gga_k_tw1_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([1.643131576408926e+01, 8.173997154944660e+00, 6.414746659992570e-01, 1.323607718307269e-01, 2.665090658114368e-02, 1.243876216185658e-03, 4.422325467242587e-07])
...
def test_gga_k_tw1_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([2.591992335626407e+01, 2.596741179861679e+01, 1.232697073685816e+01, 1.234827659488298e+01, 8.307821845178975e-01, 8.307460099114986e-01, 2.135546950469496e-01, 1.886785532385685e-03, 3.396275724041523e-02, 1.900499440852579e-06, 2.086064106930153e-03, 2.055982818858707e-03, 8.479044780527390e-07, 4.285235969081894e-07])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
