...
def test_gga_k_fr_b88_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([1.647532871554887e+01, 8.189235946127759e+00, 6.499113392259770e-01, 1.326657702882297e-01, 2.643988553994715e-02, 7.450861695526155e-03, 5.594458501715014e-05])
