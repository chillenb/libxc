...
def test_gga_k_absp1_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-8.277598472629092e-01, -2.041630285134136e-01, 2.686337747843717e-01, 4.920120315722982e-01, 6.849620224132335e-01]
...
def test_gga_k_absp1_H_2_vrho():
    ...
    ref_tgt = [-1.406935177695875e+00, -9.066003231378070e-17, -1.592474714025938e+00, -3.383055652413823e-17, -8.832695668542583e-01, 4.906772244245088e-17, -5.358476424748320e-01, 2.829820000402199e-16, -6.850593191941515e-01, -1.845836151142637e-16]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
