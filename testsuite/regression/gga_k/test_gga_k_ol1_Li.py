...
def test_gga_k_ol1_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [1.642713869251945e+01, 8.166571576288963e+00, 8.115612270933856e-01, 1.325407068063027e-01, 2.877092391495718e-02, 3.439215006094232e-01, 1.507730730264144e-01]
...
def test_gga_k_ol1_Li_2_vrho():
    ...
    ref_tgt = [2.598185387333169e+01, 2.602952266459156e+01, 1.230105293470095e+01, 1.232252405089874e+01, 3.826852632215777e-01, 3.809998097128194e-01, 2.140683392006728e-01, -3.384719928655450e-01, 2.614340445250297e-02, -1.344653883702626e-01, -3.355858606835486e-01, -3.473570726737177e-01, -1.576023950218727e-01, -1.317300665226420e-01]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
