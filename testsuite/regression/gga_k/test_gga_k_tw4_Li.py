...
def test_gga_k_tw4_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([1.642635658234033e+01, 8.170542629558899e+00, 6.454699201105014e-01, 1.323341098426040e-01, 2.671144645260153e-02, 1.269771739395747e-03, 4.514613911752276e-07])
