...
def test_gga_k_vsk_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([1.633120205121686e+01, 8.099018794028924e+00, 1.325749423263792e+00, 1.328567860422878e-01, 3.100492591430618e-02, 3.085221565699772e+00, 1.356897645817025e+00])
