...
def test_hyb_gga_xc_apbe0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.409950308272907e+00, -1.012325285077187e+00, -3.216404939519473e-01, -1.351249106843760e-01, -6.293088261053051e-02, -1.540981556183083e-02, -2.878940454918063e-04])
...
def test_hyb_gga_xc_apbe0_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.788317010545818e+00, -1.789799686590301e+00, -1.229425886272965e+00, -1.230359918072821e+00, -3.252768517469004e-01, -3.254388960102503e-01, -1.780745068634759e-01, -1.122483606714070e-01, -6.373147039324045e-02, 2.848468193820378e-01, -2.059889404575573e-02, -2.045060047837808e-02, -4.156167505288801e-04, -2.954656959069907e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
