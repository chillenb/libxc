...
def test_hyb_gga_xc_mpw1lyp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.407759916267564e+00, -1.018146698009047e+00, -3.060996230317823e-01, -1.204552241048576e-01, -6.076812033921984e-02, -3.362245292764437e-03, -3.008690882436738e-05])
