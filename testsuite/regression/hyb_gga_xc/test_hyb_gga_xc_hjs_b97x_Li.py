...
def test_hyb_gga_xc_hjs_b97x_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.397658555649017e+00, -9.913493627634820e-01, -3.224155746689635e-01, -1.473385672539712e-01, -6.995582662167887e-02, -2.874425652801429e-02, -1.790559887859811e-16])
