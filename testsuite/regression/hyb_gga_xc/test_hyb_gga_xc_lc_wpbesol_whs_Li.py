...
def test_hyb_gga_xc_lc_wpbesol_whs_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.516605633883708e+00, -9.880220111765085e-01, -1.244472220484205e-01, -3.402388377909610e-02, -3.509401759462614e-03, -8.041042295514813e-06, -5.500172210097695e-11])
