...
def test_hyb_gga_xc_sb98_2c_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.906278017474858e-01, -4.689364160401159e-01, -2.857547108266196e-01, -1.238845108448931e-01, -8.462504634443322e-03]
...
def test_hyb_gga_xc_sb98_2c_H_2_vrho():
    ...
    ref_tgt = [-6.460273246375394e-01, -2.443047008576216e-01, -6.070626018259345e-01, -2.408035493699647e-01, -3.397087310187656e-01, -1.938190414816162e-01, -8.744976136439267e-02, 1.855125383046134e-02, -1.125357154346658e-02, 2.291620491658496e-02]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
