...
def test_hyb_gga_xc_pbe_molb0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.417591146176008e+00, -1.020972613382489e+00, -3.251589111374465e-01, -1.359149929704032e-01, -6.388497728340911e-02, -1.541026830807861e-02, -2.878940523658045e-04])
