...
def test_hyb_gga_xc_b1wc_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.564515446502717e+00, -1.115056787323510e+00, -3.362269508901622e-01, -1.494923537727515e-01, -6.556929731013286e-02, -1.724988978347341e-02, -3.224411826015363e-04]
...
def test_hyb_gga_xc_b1wc_Li_2_vrho():
    ...
    ref_tgt = [-2.009652528333663e+00, -2.011297060188975e+00, -1.398370982604455e+00, -1.399408803640919e+00, -3.119122987368007e-01, -3.119272293640752e-01, -1.970189385140733e-01, -1.195524320923521e-01, -7.070374736161358e-02, 3.421216851398906e-01, -2.303476873306274e-02, -2.287050731459049e-02, -4.654900619621815e-04, -3.309212790834975e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
