...
def test_hyb_gga_xc_sb98_2b_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.427673820255559e+00, -1.018785722110850e+00, -3.303550938928393e-01, -1.320657418869295e-01, -6.478353686739005e-02, -1.453239026353124e-02, -3.022351186995870e-04]
