...
def test_hyb_gga_xc_b5050lyp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.586479950477204e-01, -6.946718723561545e-01, -2.026683297237869e-01, -8.344147313102325e-02, -4.119258852679527e-02, -5.983238088732315e-02, -2.259018579251501e-02])
