...
def test_hyb_gga_xc_pbeh_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.405781263674849e+00, -1.006160055032575e+00, -3.151180946641863e-01, -1.351808790258522e-01, -6.172558952419799e-02, -1.540837330258630e-02, -2.878940234018740e-04])
...
def test_hyb_gga_xc_pbeh_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.797970862121440e+00, -1.799445338702890e+00, -1.240699660455868e+00, -1.241631960445837e+00, -3.165001204466618e-01, -3.166383353315719e-01, -1.782016387654696e-01, -1.172273350187842e-01, -6.388275447587406e-02, 3.421963507501030e-01, -2.059298037638717e-02, -2.044500968968799e-02, -4.156166464907097e-04, -2.954656511859193e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
