...
def test_hyb_gga_xc_qtp17_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-7.271511216241662e-01, -5.186785051513698e-01, -1.122487018921780e-01, -6.659653855009298e-02, -2.852103540102904e-02, -8.791802601023585e-03, -2.184379574639887e-04])
