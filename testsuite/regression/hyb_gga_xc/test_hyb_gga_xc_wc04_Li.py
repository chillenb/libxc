...
def test_hyb_gga_xc_wc04_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.819812059250423e-01, -1.907796233847767e-01, -2.107755639393529e-01, -3.851636485216577e-02, -4.343307065678834e-02, -1.357923310204799e-01, -5.396353378617958e-02])
