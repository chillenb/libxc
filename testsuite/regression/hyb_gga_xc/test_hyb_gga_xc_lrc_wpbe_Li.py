...
def test_hyb_gga_xc_lrc_wpbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.687891647394192e+00, -1.160945139040140e+00, -2.595528982725687e-01, -6.488686908818239e-02, -6.828766818131004e-03, -3.259303628253769e-05, -2.200284682250894e-10])
