...
def test_hyb_gga_xc_pbe_sol0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.394163890312884e+00, -9.893131439338999e-01, -2.925410837068190e-01, -1.350143488547600e-01, -5.806158387717028e-02, -1.540117309993545e-02, -2.878939130213583e-04])
...
def test_hyb_gga_xc_pbe_sol0_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-7.138291075137597e-05, 8.057094003003931e-05, -7.099104968632221e-05, -3.206390575570424e-04, 2.747845524533765e-04, -3.191333637906462e-04, -4.936763287281101e-02, 9.764292986584010e-03, -4.929286422360783e-02, 7.866101269202956e-01, 4.978936063600431e+00, 2.119832755260273e+00, -2.452266741692966e+01, 3.188247312456189e+01, 1.357225358900635e+01, -3.751920898541450e-01, 7.058310792173810e-04, -3.503758508784056e-01, -1.724534135822350e+00, 6.759926358451161e-06, -2.468496472323308e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
