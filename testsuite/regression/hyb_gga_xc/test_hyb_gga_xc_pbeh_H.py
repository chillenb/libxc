...
def test_hyb_gga_xc_pbeh_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.985899874820065e-01, -4.513104070851983e-01, -2.776602454521577e-01, -1.009511225912967e-01, -5.547462015563375e-03]
...
def test_hyb_gga_xc_pbeh_H_2_vrho():
    ...
    ref_tgt = [-6.581889165538466e-01, 1.596983044605467e+00, -5.801999238146623e-01, 7.387469275550377e+01, -3.287024045088503e-01, 4.139501778593020e+01, -1.046760192102860e-01, 3.382974671448072e-01, -7.391420968212402e-03, 1.066995416439949e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
