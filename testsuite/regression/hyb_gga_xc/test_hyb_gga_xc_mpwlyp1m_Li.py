...
def test_hyb_gga_xc_mpwlyp1m_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.768392152343264e+00, -1.276453042843348e+00, -3.914952780273839e-01, -1.525732142329866e-01, -7.697295180724339e-02, -3.704660404482424e-03, -3.010002891240523e-05])
