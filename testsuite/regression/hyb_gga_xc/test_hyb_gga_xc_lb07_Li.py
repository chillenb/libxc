...
def test_hyb_gga_xc_lb07_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.378782769734866e+00, -9.016464599255523e-01, -7.602698240245094e-02, -2.151806930567649e-02, -1.624127735508418e-03, -2.088559670216724e-03, -3.003777978356361e-05])
