...
def test_hyb_gga_xc_relpbe0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.387204717537386e+00, -9.739246491525138e-01, -2.684240663182943e-01, -1.309516994612745e-01, -5.456073244750757e-02, -1.900509250665072e-02, -3.654759277742336e-04])
