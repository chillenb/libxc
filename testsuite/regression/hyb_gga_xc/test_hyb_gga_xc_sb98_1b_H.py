...
def test_hyb_gga_xc_sb98_1b_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.417475579950833e-01, -4.710700147321411e-01, -2.892261028431694e-01, -1.351206336965879e-01, -1.089190893803302e-02]
...
def test_hyb_gga_xc_sb98_1b_H_2_vrho():
    ...
    ref_tgt = [-7.196325624725876e-01, -2.558122895092313e-01, -6.113115923861556e-01, -2.502852916608891e-01, -3.477770688863794e-01, -1.995055430763656e-01, -8.010167480213512e-02, 8.447235334413069e-03, -1.438367482696152e-02, 2.011979105895014e-02]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
