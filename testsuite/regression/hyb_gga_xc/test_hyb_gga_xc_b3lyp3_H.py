...
def test_hyb_gga_xc_b3lyp3_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.038248303906421e-01, -4.682448858648194e-01, -2.910915530125324e-01, -1.153492591911472e-01, -4.346418835095610e-02])
...
def test_hyb_gga_xc_b3lyp3_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-6.694877618999318e-01, -2.422740255227088e-01, -5.836836142475654e-01, -2.510736540782595e-01, -3.315719059344060e-01, -1.972652439477766e-01, -8.720234145936633e-02, -4.651984540065803e-02, -1.174084263108945e-02, -1.618595547035828e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
