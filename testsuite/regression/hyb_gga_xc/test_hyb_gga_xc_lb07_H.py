...
def test_hyb_gga_xc_lb07_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-3.463261045726116e-01, -2.930630983868166e-01, -1.146754751871080e-01, -4.288274810193346e-03, -4.844675857590682e-07])
...
def test_hyb_gga_xc_lb07_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-5.195673679096423e-01, -2.361713832519294e-01, -4.456413611758731e-01, -2.499095375018396e-01, -1.897677804288501e-01, -1.966669686227200e-01, -8.364031979728940e-03, -3.555089138122554e-02, -9.683993274404356e-07, -2.453539843810769e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
