...
def test_hyb_gga_xc_pbe_molb0_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.986924062100522e-01, -4.554527066083851e-01, -2.835256220835430e-01, -1.034828075193716e-01, -5.547859952196314e-03]
...
def test_hyb_gga_xc_pbe_molb0_H_2_vrho():
    ...
    ref_tgt = [-6.580541152620697e-01, 1.488667052951133e+00, -5.764681322055993e-01, 7.109340134366469e+01, -3.263155002728901e-01, 4.147136778843169e+01, -1.108136529765509e-01, 3.750870898495544e-01, -7.393011285678605e-03, 1.201412311868046e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
