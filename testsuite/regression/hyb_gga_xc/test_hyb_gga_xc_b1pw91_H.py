...
def test_hyb_gga_xc_b1pw91_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.986171665950232e-01, -4.541729088481368e-01, -2.800858846139406e-01, -1.104561534984094e-01, -4.462458276706408e-02]
...
def test_hyb_gga_xc_b1pw91_H_2_vrho():
    ...
    ref_tgt = [-6.581101148153804e-01, 1.690083436176813e+00, -5.793981348690348e-01, 7.673802215393304e+01, -3.318948489104244e-01, 4.810944149310160e+01, -7.913849101605443e-02, 4.491607433521927e-01, -1.137970650813245e-02, 1.109794379893264e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
