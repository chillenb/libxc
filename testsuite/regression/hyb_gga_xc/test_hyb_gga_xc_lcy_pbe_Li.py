...
def test_hyb_gga_xc_lcy_pbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.528439059448808e+00, -1.007716772332751e+00, -1.336362141313898e-01, -4.603689628327745e-02, -4.363614194575233e-03, -2.046653948655451e-05, -1.408185527353601e-10]
...
def test_hyb_gga_xc_lcy_pbe_Li_2_vrho():
    ...
    ref_tgt = [-2.055099246497521e+00, -2.057041448464910e+00, -1.347029076056196e+00, -1.348238224453556e+00, -2.064498169695989e-01, -2.064023588491743e-01, -7.774972597251079e-02, -9.767608255958841e-02, -1.231737663405114e-02, 3.428185821027419e-01, -4.137202752956780e-05, -4.047930350711749e-05, -3.390582240715987e-10, -1.218201988824809e-10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
