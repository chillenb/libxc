...
def test_hyb_gga_xc_b3lyp_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.077238167868771e-01, -4.720990935276448e-01, -2.946959830700063e-01, -1.181400684335494e-01, -4.421822676694466e-02]
...
def test_hyb_gga_xc_b3lyp_H_2_vrho():
    ...
    ref_tgt = [-6.735205065611598e-01, -2.369695581302991e-01, -5.876777166136864e-01, -2.462535903065731e-01, -3.353469929275120e-01, -1.945527500319183e-01, -9.022799378598771e-02, -4.700866283526803e-02, -1.264922304873964e-02, -3.653359768481997e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
