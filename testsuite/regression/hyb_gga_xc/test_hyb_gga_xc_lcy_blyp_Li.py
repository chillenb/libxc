...
def test_hyb_gga_xc_lcy_blyp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.529811072352407e+00, -1.018463307216642e+00, -1.190282757812775e-01, -3.092502267281993e-02, -3.018104431813423e-03, -2.098694122987986e-03, -3.003784931274436e-05])
