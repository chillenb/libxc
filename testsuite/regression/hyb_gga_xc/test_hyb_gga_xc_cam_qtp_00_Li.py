...
def test_hyb_gga_xc_cam_qtp_00_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-8.304029784722133e-01, -5.865047083546117e-01, -1.135090604149705e-01, -3.692338299420490e-02, -1.139812646520108e-02, -1.502275182009831e-02, -4.881874742923615e-03])
