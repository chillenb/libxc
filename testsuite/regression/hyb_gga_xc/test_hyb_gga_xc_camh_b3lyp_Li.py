...
def test_hyb_gga_xc_camh_b3lyp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.464045225765634e+00, -1.041360493073447e+00, -2.712970024489673e-01, -9.725291621306251e-02, -4.396318063813389e-02, -6.958543153324218e-02, -2.686228266408265e-02]
...
def test_hyb_gga_xc_camh_b3lyp_Li_2_vrho():
    ...
    ref_tgt = [-1.835913673519691e+00, -1.837456308818370e+00, -1.257047571687862e+00, -1.257978990014321e+00, -3.407631508991054e-01, -3.410308852639434e-01, -1.299764162168446e-01, -1.090292514617879e-01, -4.156622772559825e-02, -4.253771077746920e-02, -2.214985429561798e-02, -2.232925881979698e-02, -3.783834092883557e-03, -3.356191790677743e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
