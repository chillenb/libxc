...
def test_hyb_gga_xc_hapbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.502570110086076e+00, -1.078982565857823e+00, -3.424903332002582e-01, -1.402166743561854e-01, -6.684625584442727e-02, -1.643713515263654e-02, -3.070869818578925e-04])
