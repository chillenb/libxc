...
def test_hyb_gga_xc_mb3lyp_rc04_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.119055981203096e-01, -4.759892979581590e-01, -2.969802079751910e-01, -1.171744399151011e-01, -4.341806559164973e-02])
...
def test_hyb_gga_xc_mb3lyp_rc04_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-6.785657536579330e-01, -8.832608842859714e+02, -5.924848570644260e-01, -7.599378562874307e+02, -3.386684583585245e-01, -3.469602595635906e+02, -8.973789351488634e-02, -3.778263439568536e+01, -1.169487812750298e-02, -1.042524766019141e-01])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
