...
def test_hyb_gga_xc_camy_pbeh_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-3.009343857658015e-01, -2.812157173735934e-01, -2.222037394424309e-01, -1.162553008161714e-01, -6.301627793964878e-02, -1.641676725914905e-02, -3.070868289721909e-04])
