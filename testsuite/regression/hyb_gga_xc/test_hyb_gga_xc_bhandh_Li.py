...
def test_hyb_gga_xc_bhandh_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.234612420002182e-01, -6.521790495791597e-01, -1.305568372951491e-01, -7.846335333986669e-02, -3.110930962920290e-02, -7.775769074628854e-03, -1.364287525690647e-04])
