...
def test_hyb_gga_xc_hse12s_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.378742216564590e-01, -3.984838406576163e-01, -2.640656608016861e-01, -1.177383287932637e-01, -7.397958288945742e-03]
...
def test_hyb_gga_xc_hse12s_H_2_vrho():
    ...
    ref_tgt = [-5.626258979086232e-01, 1.596983044605467e+00, -4.993093652010706e-01, 7.387469275550377e+01, -3.003320948683315e-01, 4.139501778593020e+01, -1.226430093869309e-01, 3.382974671448072e-01, -9.863088163697792e-03, 1.066995416336212e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
