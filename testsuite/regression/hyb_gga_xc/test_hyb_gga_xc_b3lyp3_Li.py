...
def test_hyb_gga_xc_b3lyp3_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.499383333374459e+00, -1.081921910294254e+00, -3.323293523522787e-01, -1.316183571903835e-01, -6.557132222936282e-02, -9.979407358434814e-02, -3.867766254971960e-02]
...
def test_hyb_gga_xc_b3lyp3_Li_2_vrho():
    ...
    ref_tgt = [-1.870965271146755e+00, -1.872491423303709e+00, -1.296417164493497e+00, -1.297342980823601e+00, -3.708167124095397e-01, -3.710651931472738e-01, -1.683948652080080e-01, -1.178943481347759e-01, -6.193696663003702e-02, -4.408758264187203e-02, -3.141789984854553e-02, -3.163077141306647e-02, -5.461217611585088e-03, -4.779087514063004e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
