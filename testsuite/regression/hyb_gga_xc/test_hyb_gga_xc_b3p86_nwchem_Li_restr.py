...
def test_hyb_gga_xc_b3p86_nwchem_Li_restr_1_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.527977207330730e+00, -1.101461184875199e+00, -3.589042171385283e-01, -1.497321653994133e-01, -7.782574325660342e-02, -1.108154940262212e-01, -3.900040764659256e-02]
...
def test_hyb_gga_xc_b3p86_nwchem_Li_restr_1_vrho():
    ...
    ref_tgt = [-1.937410449406200e+00, -1.351270076532279e+00, -3.251393816983700e-01, -1.877641442869621e-01, -8.575003114257031e-02, -4.465598066762728e-02, -5.874982155969982e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
