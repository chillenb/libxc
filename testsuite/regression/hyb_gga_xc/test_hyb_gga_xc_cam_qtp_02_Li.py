...
def test_hyb_gga_xc_cam_qtp_02_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.214915268209630e+00, -8.368370207166163e-01, -1.169630194458190e-01, -3.081189656201997e-02, -2.816250537925943e-03, -2.096691667271050e-03, -3.003783554145272e-05]
...
def test_hyb_gga_xc_cam_qtp_02_Li_2_vrho():
    ...
    ref_tgt = [-1.556394992050789e+00, -1.557735269158180e+00, -1.049159695663838e+00, -1.049952615294499e+00, -2.785551793173868e-01, -2.789294031568190e-01, -5.358058329273607e-02, -8.226105110928285e-02, -5.430567263984126e-03, -3.029946530784746e-02, -2.724821284191215e-03, -2.815089287183108e-03, -2.079716805595033e-05, -9.360850361890175e-05]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
