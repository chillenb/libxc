...
def test_hyb_gga_xc_hjs_b88_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.410285626035856e+00, -1.005868802270256e+00, -3.151069907188542e-01, -1.481877384401328e-01, -7.057739265299037e-02, -1.484051586680628e-01, -1.790559887859811e-16])
