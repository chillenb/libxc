...
def test_hyb_gga_xc_b1lyp_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.666020385167241e-01, -4.351486335403730e-01, -2.710795458301624e-01, -1.102732868413641e-01, -4.462458281738865e-02]
...
def test_hyb_gga_xc_b1lyp_H_2_vrho():
    ...
    ref_tgt = [-6.211139797160179e-01, -2.361713832519181e-01, -5.391420443201540e-01, -2.499095375018285e-01, -3.034924000610576e-01, -1.966669686227086e-01, -7.805442676006132e-02, -3.555089138121429e-02, -1.137970506488353e-02, -2.453539843799461e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
