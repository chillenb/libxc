...
def test_hyb_gga_xc_hse12s_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.140364830505516e+00, -8.328487800604243e-01, -2.928486108905610e-01, -1.455298092258504e-01, -7.714947119345091e-02, -2.052547552052057e-02, -3.838587057590288e-04])
