...
def test_hyb_gga_xc_pbe0_13_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.256248771460716e+00, -8.991934294987469e-01, -2.804470457789002e-01, -1.218454979279901e-01, -5.501698430987764e-02, -1.369633267004336e-02, -2.559057985794635e-04]
...
def test_hyb_gga_xc_pbe0_13_Li_2_vrho():
    ...
    ref_tgt = [-1.611086577407060e+00, -1.612383242358196e+00, -1.114117066416272e+00, -1.114935278634071e+00, -2.831030225474805e-01, -2.832265088839606e-01, -1.610924519905581e-01, -1.150510237465210e-01, -5.751600371561040e-02, 3.422654876934818e-01, -1.830487691782816e-02, -1.817334744602883e-02, -3.694370191029793e-04, -2.626361343876331e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
