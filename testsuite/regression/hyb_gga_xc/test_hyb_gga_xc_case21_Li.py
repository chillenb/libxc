...
def test_hyb_gga_xc_case21_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.405272597501974e+00, -1.008115586939650e+00, -3.183594213290265e-01, -1.354693753744905e-01, -6.411969327243389e-02, -1.480792702011819e-02, -2.765144167929175e-04])
...
def test_hyb_gga_xc_case21_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.795329649235259e+00, -1.796809798288105e+00, -1.232596289458779e+00, -1.233532950508821e+00, -3.437679931916900e-01, -3.438773095845825e-01, -1.772687093036066e-01, -1.233424340912079e-01, -6.937514698949591e-02, 2.365461046327527e-01, -1.981243153556756e-02, -1.967020636504388e-02, -3.991889576675891e-04, -2.837876649522570e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
