...
def test_hyb_gga_xc_hse03_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.428760647037197e+00, -1.032687028398627e+00, -3.416105832749333e-01, -1.555997060079399e-01, -7.826773707379764e-02, -2.053159051458186e-02, -3.838587476957801e-04])
