...
def test_hyb_gga_xc_wb97x_d_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-4.274903125183795e-01, -3.769718088762509e-01, -2.002182760359870e-01, -5.435405500464274e-02, -1.311817146684817e-03])
...
def test_hyb_gga_xc_wb97x_d_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-6.038040502725850e-01, -2.607781774937694e-01, -5.278334667664825e-01, -2.604026678384159e-01, -2.402175794506674e-01, -2.095617293812584e-01, 9.827234510421732e-03, 2.113313792951359e-02, -1.692194890867323e-03, 2.583380831405693e-02])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
