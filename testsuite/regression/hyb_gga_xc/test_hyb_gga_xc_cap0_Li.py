...
def test_hyb_gga_xc_cap0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.405317858371776e+00, -1.002833952525329e+00, -3.280294648125467e-01, -1.356856430304955e-01, -6.140742656525555e-02, -3.294107304255935e-01, -3.493944196403117e-01])
