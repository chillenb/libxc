...
def test_hyb_gga_xc_sb98_1a_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.505378550866849e+00, -1.066555369004608e+00, -3.244093534241815e-01, -1.212182156058945e-01, -5.928579314207293e-02, -1.208137884853928e-02, -2.189984220819855e-04])
