...
def test_hyb_gga_xc_b3p86_nwchem_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.502849901988850e-01, -5.033866469816163e-01, -3.153154960706221e-01, -1.237396727255799e-01, -4.869663037732603e-02]
...
def test_hyb_gga_xc_b3p86_nwchem_H_2_vrho():
    ...
    ref_tgt = [-7.205634680046488e-01, -2.404987151571411e-01, -6.407858807422696e-01, -2.297587360138205e-01, -3.822248464584557e-01, -1.805252493362234e-01, -1.008370206835118e-01, -6.663858525864355e-02, -1.813578218780569e-02, -8.767331898494404e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
