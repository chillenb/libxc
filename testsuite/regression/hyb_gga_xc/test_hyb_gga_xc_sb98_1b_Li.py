...
def test_hyb_gga_xc_sb98_1b_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.472945836902575e+00, -1.047686336688387e+00, -3.543538207535775e-01, -1.395549300773573e-01, -7.113018932445395e-02, -1.989169289673585e-02, -4.320063631582262e-04])
