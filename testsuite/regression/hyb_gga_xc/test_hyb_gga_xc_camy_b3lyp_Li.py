...
def test_hyb_gga_xc_camy_b3lyp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.447964126579745e+00, -1.026130951646818e+00, -2.588221442415757e-01, -9.080011219089505e-02, -3.562740989433884e-02, -4.964219531045006e-02, -1.882018408119269e-02])
...
def test_hyb_gga_xc_camy_b3lyp_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.820571650119619e+00, -1.822110426352926e+00, -1.243396804649632e+00, -1.244324472721535e+00, -3.356721874216762e-01, -3.359488090778553e-01, -1.239346926231333e-01, -1.037214526979308e-01, -3.676581753877056e-02, -4.137907476743857e-02, -1.672593130903466e-02, -1.687729302165578e-02, -2.664649189129744e-03, -2.388227293082789e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
