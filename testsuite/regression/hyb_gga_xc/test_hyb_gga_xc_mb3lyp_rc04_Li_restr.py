...
def test_hyb_gga_xc_mb3lyp_rc04_Li_restr_1_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.520197408363688e+00, -1.102323491686757e+00, -3.454783996680685e-01, -1.299931320118814e-01, -6.614453569831526e-02, -1.002090390737974e-01, -3.850751873723927e-02]
...
def test_hyb_gga_xc_mb3lyp_rc04_Li_restr_1_vrho():
    ...
    ref_tgt = [-1.892644403671976e+00, -1.317944492100871e+00, -3.864942786235191e-01, -1.645814903991109e-01, -6.417516275712326e-02, -3.214360781379781e-02, -5.232917131221019e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
