...
def test_hyb_gga_xc_mpw3pw_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.510029308816357e+00, -1.084461690689655e+00, -3.467185752577929e-01, -1.471206212073345e-01, -6.912495518730202e-02, -4.803449665952787e-03, -1.249428666821993e-04])
