...
def test_hyb_gga_xc_b3lyp_mcm1_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.900296569126211e-01, -4.536841677019925e-01, -2.776771353885687e-01, -1.051610114875379e-01, -3.947598091766946e-02]
...
def test_hyb_gga_xc_b3lyp_mcm1_H_2_vrho():
    ...
    ref_tgt = [-6.547651131628942e-01, -2.260716527337529e-01, -5.704088195222503e-01, -2.434362409011558e-01, -3.202282290812959e-01, -1.908585329142052e-01, -7.951890282049806e-02, -2.341498375790681e-02, -9.696168619439989e-03, -1.232969325979616e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
