...
def test_hyb_gga_xc_b97_k_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.055608022976873e+00, -7.824404782519889e-01, -2.464726178097618e-01, -9.608284010478127e-02, -4.855045879805438e-02, -9.781651056206030e-03, -1.593245336547453e-04])
