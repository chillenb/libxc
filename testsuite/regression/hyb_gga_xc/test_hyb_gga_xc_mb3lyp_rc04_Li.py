...
def test_hyb_gga_xc_mb3lyp_rc04_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.520197906236799e+00, -1.102323787981512e+00, -3.454783525876619e-01, -1.350738711774331e-01, -6.677260169693859e-02, -1.002085887263698e-01, -3.867248519136875e-02]
...
def test_hyb_gga_xc_mb3lyp_rc04_Li_2_vrho():
    ...
    ref_tgt = [-1.891900332865855e+00, -1.893387846517558e+00, -1.317499111114046e+00, -1.318389532837984e+00, -3.863646812853639e-01, -3.866242518277244e-01, -1.728437251506391e-01, -2.861674383765039e-01, -6.366943914931451e-02, -1.213305324409322e+00, -3.203625562511265e-02, -3.225282616952784e-02, -5.446607077523131e-03, -4.793959227682057e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
