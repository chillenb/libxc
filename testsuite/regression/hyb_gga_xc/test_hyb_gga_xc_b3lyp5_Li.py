...
def test_hyb_gga_xc_b3lyp5_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.499383333440698e+00, -1.081921910359517e+00, -3.323293523647791e-01, -1.316184109694939e-01, -6.557132226109511e-02, -9.979408246693502e-02, -3.867438347594714e-02])
...
def test_hyb_gga_xc_b3lyp5_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.870965173007670e+00, -1.872491521294050e+00, -1.296417062144387e+00, -1.297343083034471e+00, -3.708167515829523e-01, -3.710651539535300e-01, -1.683948762846193e-01, -1.180555686095869e-01, -6.193696662048850e-02, -4.427383763733175e-02, -3.141951149378303e-02, -3.162913796006971e-02, -5.449880627400850e-03, -4.793343603268787e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
