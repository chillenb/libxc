...
def test_hyb_gga_xc_mpw1k_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.094262441521900e+00, -7.858419245250905e-01, -2.482221221293842e-01, -1.070772991776995e-01, -4.779768311609019e-02, -9.793150716786237e-04, -3.752345196689400e-08])
