...
def test_hyb_gga_xc_wb97x_v_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.084729524342196e-01, -3.610987526384165e-01, -1.807608042227608e-01, -2.421967199950307e-02, -4.732989880741698e-04]
...
def test_hyb_gga_xc_wb97x_v_H_2_vrho():
    ...
    ref_tgt = [-5.790253302700991e-01, -3.223800209559336e-01, -4.924802924550467e-01, -2.935220986197878e-01, -2.297762193884631e-01, -2.072385312256086e-01, -2.751934725747721e-02, -1.297751448853505e-02, -6.063636536963867e-04, 4.437999670625950e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
