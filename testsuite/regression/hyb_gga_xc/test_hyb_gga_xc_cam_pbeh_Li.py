...
def test_hyb_gga_xc_cam_pbeh_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-3.581009070133417e-01, -3.368222084892204e-01, -2.438468937771865e-01, -1.321582105365963e-01, -6.498378472349968e-02, -1.643088365115779e-02, -3.070869259409224e-04])
