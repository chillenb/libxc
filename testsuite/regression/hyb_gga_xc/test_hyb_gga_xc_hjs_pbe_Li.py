...
def test_hyb_gga_xc_hjs_pbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.421256650110743e+00, -1.021641031258458e+00, -3.304970721287947e-01, -1.487658149704318e-01, -7.443193449677817e-02, -2.045988379791419e-02, -3.838580991593412e-04])
