...
def test_hyb_gga_xc_b3lyps_Li_restr_1_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.590277924276769e+00, -1.146180550054698e+00, -3.502688558909563e-01, -1.319804087678488e-01, -6.816427690007451e-02, -1.017323302181932e-01, -3.859174416309583e-02]
...
def test_hyb_gga_xc_b3lyps_Li_restr_1_vrho():
    ...
    ref_tgt = [-1.991642488647861e+00, -1.381323092599013e+00, -3.938557301826096e-01, -1.667715118463270e-01, -6.616106655867322e-02, -3.387650254117928e-02, -5.342349164385049e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
