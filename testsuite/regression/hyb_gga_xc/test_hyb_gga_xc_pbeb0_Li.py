...
def test_hyb_gga_xc_pbeb0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.411309855168113e+00, -1.012111858556563e+00, -3.167948397925163e-01, -1.358551569795824e-01, -6.237123763840238e-02, -1.540837921587698e-02, -2.878940234020134e-04])
...
def test_hyb_gga_xc_pbeb0_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.799151484222289e+00, -1.800618307242665e+00, -1.244001360411024e+00, -1.244924984625727e+00, -3.236584076923898e-01, -3.237993441690925e-01, -1.775978321622359e-01, -1.240523985035562e-01, -6.623960197357344e-02, 4.401022380089462e-01, -2.059301863347264e-02, -2.044504813897451e-02, -4.156166464915932e-04, -2.954656511869646e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
