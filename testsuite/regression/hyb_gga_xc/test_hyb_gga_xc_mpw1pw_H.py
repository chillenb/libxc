...
def test_hyb_gga_xc_mpw1pw_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.984621148079659e-01, -4.543524476106638e-01, -2.802261479073147e-01, -1.072448594665228e-01, -2.873030265736519e-04]
...
def test_hyb_gga_xc_mpw1pw_H_2_vrho():
    ...
    ref_tgt = [-6.581857121191821e-01, 1.690083436176813e+00, -5.793403966301184e-01, 7.673802215393304e+01, -3.322629790537327e-01, 4.810944149310160e+01, -8.957876326506621e-02, 4.491607433521927e-01, -1.058499801816587e-03, 1.109794380000143e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
