...
def test_hyb_gga_xc_cam_b3lyp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.435657892492902e+00, -1.012179471040247e+00, -2.341453365964142e-01, -7.970461878395260e-02, -3.237724229488886e-02, -4.960855320963862e-02, -1.882018384964290e-02]
...
def test_hyb_gga_xc_cam_b3lyp_Li_2_vrho():
    ...
    ref_tgt = [-1.810868346637321e+00, -1.812407245578579e+00, -1.233779674442883e+00, -1.234707392803685e+00, -3.263650204861978e-01, -3.266412262782189e-01, -1.105569761958850e-01, -1.036630625636044e-01, -3.172657107580328e-02, -4.137907289658152e-02, -1.665807935272181e-02, -1.681089985870628e-02, -2.664648631612824e-03, -2.388227092774256e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
