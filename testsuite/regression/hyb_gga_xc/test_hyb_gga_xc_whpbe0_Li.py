...
def test_hyb_gga_xc_whpbe0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-4.806122003462828e-01, -3.364062433219691e-01, -7.962600424507066e-02, -3.361759650517075e-02, -4.399239061647299e-03, -1.927364327235272e-05, -1.237669350381907e-10])
