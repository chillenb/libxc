...
def test_hyb_gga_xc_lc_wpbesol_whs_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.808246728927272e-01, -3.184451731080553e-01, -1.227756295084687e-01, -4.378106741549422e-03, -3.741597674804178e-07]
...
def test_hyb_gga_xc_lc_wpbesol_whs_H_2_vrho():
    ...
    ref_tgt = [-5.712526259501675e-01, 1.014698796252341e+00, -4.894394160586142e-01, 5.660683950431883e+01, -2.080975588821916e-01, 3.977148618814145e+01, -8.279610015408684e-03, 6.346862779076641e-01, -7.505946523648205e-07, 2.244372685751381e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
