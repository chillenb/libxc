...
def test_hyb_gga_xc_b3lyp_mcm2_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.505265109108313e+00, -1.084640760345599e+00, -3.257633636573516e-01, -1.300621406564171e-01, -6.456534436507058e-02, -1.002001376591727e-01, -3.913924693103873e-02]
...
def test_hyb_gga_xc_b3lyp_mcm2_Li_2_vrho():
    ...
    ref_tgt = [-1.879769048988180e+00, -1.881317610886241e+00, -1.301308489283402e+00, -1.302246579715716e+00, -3.777495935906595e-01, -3.780458892137653e-01, -1.667020864688201e-01, -1.068331922613555e-01, -6.049065251814383e-02, -3.552540208084665e-02, -3.075011287833672e-02, -3.095679128150483e-02, -5.496001659932294e-03, -4.820881775730148e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
