...
def test_hyb_gga_xc_wb97x_d3_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.396747679249838e+00, -9.701536043717317e-01, -2.567009839678090e-01, -5.826697485496091e-02, -1.119758229185084e-02, 8.145826695534287e-03, 1.265438915304352e-04]
...
def test_hyb_gga_xc_wb97x_d3_Li_2_vrho():
    ...
    ref_tgt = [-1.813979007517820e+00, -1.815608831740609e+00, -1.193665630740200e+00, -1.194655691045354e+00, -3.006478506304472e-02, -2.913439822049956e-02, -1.046399666279473e-01, 3.777252345457995e-01, -8.617596894535466e-03, 2.314265471100583e-01, 9.926715414995365e-03, 1.033386290701463e-02, 4.625820028673840e-05, 5.113612269840187e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
