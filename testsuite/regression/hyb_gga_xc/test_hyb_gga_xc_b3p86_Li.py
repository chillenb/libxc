...
def test_hyb_gga_xc_b3p86_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.509890692001683e+00, -1.083653761353919e+00, -3.442661584410233e-01, -1.476816335049517e-01, -7.009253021800974e-02, -1.049459902492281e-01, -3.886247192435321e-02])
...
def test_hyb_gga_xc_b3p86_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.918364759225273e+00, -1.919890415990906e+00, -1.332658288199264e+00, -1.333617788361417e+00, -3.097020897532736e-01, -3.096182285146276e-01, -1.907896454648468e-01, -1.430760808434812e-01, -7.636166958146873e-02, -7.065534664312743e-02, -3.771238476408995e-02, -3.792394605032970e-02, -5.704072614239887e-03, -5.017560160205725e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
