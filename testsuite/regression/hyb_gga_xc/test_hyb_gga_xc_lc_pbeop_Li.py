...
def test_hyb_gga_xc_lc_pbeop_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.660344581531115e+00, -1.137163827862788e+00, -1.938453012476010e-01, -4.393574647470831e-02, -4.030966499293993e-03, -6.919959086978611e-04, -1.075262710257885e-05])
