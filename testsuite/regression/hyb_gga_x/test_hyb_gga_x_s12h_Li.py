...
def test_hyb_gga_x_s12h_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.346512492422983e+00, -9.611737359997471e-01, -3.198208144484959e-01, -1.209537180723984e-01, -6.235350161486533e-02, -1.500969236547180e-02, -2.803935007493714e-04])
...
def test_hyb_gga_x_s12h_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.725181059327372e+00, -1.726941526638252e+00, -1.113654386994746e+00, -1.114771145685140e+00, -3.235305394085906e-01, -3.236941453400408e-01, -1.594991261279731e-01, -1.908618394792859e-02, -5.927476153173816e-02, -6.060221162957373e-04, -2.006776523095626e-02, -1.992303126464716e-02, -4.047886956381068e-04, -2.877679065799458e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
