...
def test_hyb_gga_x_n12_sx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.254445763111549e+00, -9.705947261818538e-01, -4.196983619507149e-01, -1.126293804092926e-01, -8.323494360256307e-02, -4.839144893597691e-02, -1.109549029528451e-03])
