...
def test_hyb_gga_x_cam_s12g_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.546033768676482e+00, -1.039435579476166e+00, -2.909605308679479e-01, -1.074630668752257e-01, -5.552192139373466e-02, -1.311272355332941e-02, -2.449329131270404e-04])
