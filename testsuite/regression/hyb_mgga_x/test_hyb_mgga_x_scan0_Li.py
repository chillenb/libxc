...
def test_hyb_mgga_x_scan0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.481295426735947e+00, -9.779013085367365e-01, -1.757124211365625e-01, -1.357290771342137e-01, -3.935195389404488e-02, -3.612441797238099e-03, -2.639775894306764e-05]
...
def test_hyb_mgga_x_scan0_Li_2_vrho():
    ...
    ref_tgt = [-2.069753381291439e+00, -2.071672100151825e+00, -1.505824004817491e+00, -1.506656812413736e+00, -2.440542701816893e-01, -2.444274896672222e-01, -1.855567901164771e-01, 1.415776247620468e+00, -5.824838738610781e-02, 5.087171915266292e+00, 3.084567006857779e+01, 1.406240207651677e+00, 5.045370851219140e+04, -1.284457988862074e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
