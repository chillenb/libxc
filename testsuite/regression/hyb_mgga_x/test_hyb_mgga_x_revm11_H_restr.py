...
def test_hyb_mgga_x_revm11_H_restr_1_zk():
    # Prepare the input
...
def test_hyb_mgga_x_revm11_H_restr_1_vrho():
    # Prepare the input
    inp = test_data["H_restr"]
...
def test_hyb_mgga_x_revm11_H_restr_1_vsigma():
    # Prepare the input
    inp = test_data["H_restr"]
...
def test_hyb_mgga_x_revm11_H_restr_1_vtau():
    # Prepare the input
    inp = test_data["H_restr"]
