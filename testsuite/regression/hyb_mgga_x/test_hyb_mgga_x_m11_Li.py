...
def test_hyb_mgga_x_m11_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-7.443232964408284e-01, -5.371049386222575e-01, -1.637897582223289e-01, -1.693942820248940e-02, -4.417812406293010e-03, -1.382231456138939e-04, -6.938117470463136e-10])
...
def test_hyb_mgga_x_m11_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([6.599432153391669e-04, 0.000000000000000e+00, 6.613447151466231e-04, 1.038788417665890e-03, 0.000000000000000e+00, 1.037635204071236e-03, 2.838571621095535e-02, 0.000000000000000e+00, 2.734227242747432e-02, 1.212248112944195e+01, 0.000000000000000e+00, -8.581386926439291e-03, -2.290218604312839e+01, 0.000000000000000e+00, -5.571325939642760e-05, -4.057139467802736e-06, 0.000000000000000e+00, -8.868283343561394e-03, -1.134548801656921e-15, 0.000000000000000e+00, 0.000000000000000e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
