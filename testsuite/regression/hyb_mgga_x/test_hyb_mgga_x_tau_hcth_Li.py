...
def test_hyb_mgga_x_tau_hcth_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.525659448450171e+00, -1.079981953781580e+00, -4.039377057091086e-01, -1.370713717899547e-01, -6.780044561801035e-02, -2.896053752363114e-02, -5.418168207094333e-04]
...
def test_hyb_mgga_x_tau_hcth_Li_2_vsigma():
    ...
    ref_tgt = [-1.173585732788481e-04, 0.000000000000000e+00, -1.168591704768317e-04, -6.404358837100165e-04, 0.000000000000000e+00, -6.382173526195598e-04, -1.992886909228825e-01, 0.000000000000000e+00, -2.006697877900722e-01, -1.515816673556191e+00, 0.000000000000000e+00, -1.244966432321287e+00, -1.043149819016673e+02, 0.000000000000000e+00, -7.977681503940691e+00, -1.264887555230684e+00, 0.000000000000000e+00, -1.181299432509990e+00, -5.807474257710752e+00, 0.000000000000000e+00, -8.312807558285295e+00]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_hyb_mgga_x_tau_hcth_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
