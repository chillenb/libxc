...
def test_hyb_mgga_x_tau_hcth_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.504835656782309e+00, -1.044779895773110e+00, -2.510846032747648e-01, -1.360340934690236e-01, -5.400322647966888e-02, -2.898880583316085e-02, -4.691314931259089e-04])
