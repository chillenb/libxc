...
def test_hyb_mgga_x_m08_so_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.026453230455548e-01, -3.341139106961014e-01, -1.124452344096898e-01, -4.095234191331540e-02, -2.496596412808236e-02, -1.353528495204439e-02, -2.491874646754534e-04]
...
def test_hyb_mgga_x_m08_so_Li_2_vtau():
    ...
    ref_tgt = [5.969307044623650e-02, 6.087710547615484e-02, -1.089813749757453e-01, -1.094534926364348e-01, 4.991049015078898e-03, 5.206619267555631e-03, 2.094316054847225e+00, 5.460765513200752e-06, -5.523999848140422e-03, 1.147231646023665e-09, 2.783845304411809e-09, 5.884569869615716e-06, 1.552088026431582e-20, -4.086487291142884e-10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
