...
def test_hyb_mgga_x_pjs18_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.754350995222188e+00, -1.172132627586892e+00, -1.981729908594685e-01, -4.559395853484988e-02, -4.125744430547497e-03, 1.011582958234584e-03, 1.925950250226003e-05])
...
def test_hyb_mgga_x_pjs18_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.322683414763438e+00, -2.325073564858407e+00, -1.510995019412049e+00, -1.512552430852698e+00, -1.929538850950943e-01, -1.940453464333592e-01, -8.071507865135179e-02, -6.291471206138412e-06, -7.420678877696095e-03, -8.757029976648602e-10, 2.380566883282505e-03, -6.509191303997562e-06, 2.618966604915218e-05, -9.501734640633163e-11])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
