...
def test_hyb_mgga_x_pjs18_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.696761867081864e+00, -1.088726782607713e+00, -5.028826422975879e-02, -4.533774732274014e-02, -3.815450776700051e-03, -1.897167097000193e-03, -4.020403785185744e-05])
...
def test_hyb_mgga_x_pjs18_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.405471107133630e+00, -2.407907606928768e+00, -1.622791789435073e+00, -1.624286121177686e+00, -2.441441999108932e-01, -2.441993154933640e-01, -8.099076361935914e-02, -6.291471206129785e-06, -7.627347743433000e-03, -8.757029977911763e-10, 7.605247051401049e-04, -6.509191303997044e-06, 2.172445081875864e-05, -9.499414337933800e-11])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
