...
def test_hyb_mgga_x_bmk_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.541037376549746e-01, -7.534538000923729e-01, -2.051716907556120e-01, -8.057219847798210e-02, -4.747460117418048e-02, -4.013576367901429e-02, -7.543110707328327e-04])
