...
def test_hyb_mgga_x_bmk_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-7.384026098294418e-01, -5.139513924593829e-01, -1.447141745195708e-01, -6.939814883289658e-02, -3.267865362838795e-02, -4.026816270858235e-02, -6.213798737981931e-04]
...
def test_hyb_mgga_x_bmk_Li_2_vrho():
    ...
    ref_tgt = [-1.066437032747284e+00, -1.068493843282656e+00, -5.978446609374672e-01, -5.988566414230594e-01, -2.082356486497381e-01, -2.087075527308471e-01, -1.018245904165282e-01, -5.049427547086362e-02, -4.618873441185232e-02, -1.630252094783762e-03, -5.403377465900800e-02, -5.265371761361911e-02, -1.088964055877729e-03, -1.035772989732260e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
