...
def test_hyb_mgga_x_m06_sx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.132985658673928e+00, -8.785000605607791e-01, -2.566698641326014e-01, -9.749748231018845e-02, -5.651588604458772e-02, -2.167079231124399e-02, -4.056681300925707e-04])
...
def test_hyb_mgga_x_m06_sx_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-2.863793601317622e-04, 0.000000000000000e+00, -2.853457697496460e-04, -1.192441858675314e-03, 0.000000000000000e+00, -1.188477157543912e-03, -9.967732695713413e-02, 0.000000000000000e+00, -9.959298165142694e-02, -4.340775960193646e+00, 0.000000000000000e+00, -7.839351174135163e-01, -8.719244544877296e+01, 0.000000000000000e+00, -5.031261013843191e+00, -3.128710755488361e-01, 0.000000000000000e+00, -7.437732719289286e-01, -1.366667006860442e+00, 0.000000000000000e+00, -5.242630082576518e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
