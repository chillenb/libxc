...
def test_hyb_mgga_x_m06_sx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.067919224818213e+00, -7.868877927246539e-01, -1.065637375655665e-01, -9.407627268302104e-02, -3.423732842242482e-02, -2.167970675152681e-02, -3.688840570173809e-04])
...
def test_hyb_mgga_x_m06_sx_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.243878024224076e+00, -1.245225619842230e+00, -9.990551864569429e-01, -9.992555836567567e-01, -2.680735679913861e-01, -2.717739103571096e-01, -1.280773990893943e-01, -2.737349701640090e-02, -6.366188376572024e-02, -8.767626108867393e-04, -2.906446680504325e-02, -2.855832944228061e-02, -5.856417718957299e-04, -2.307789698601301e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
