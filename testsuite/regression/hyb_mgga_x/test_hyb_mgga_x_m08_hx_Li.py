...
def test_hyb_mgga_x_m08_hx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.490724814737324e-01, -4.917208381822123e-01, -2.092524818229630e-01, -6.789801005218887e-02, -4.651659001164393e-02, 8.782188204610037e-03, 1.665204245147546e-04])
...
def test_hyb_mgga_x_m08_hx_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-9.728326722266164e-01, -9.766545018674019e-01, -4.577509704099885e-01, -4.587416103036082e-01, -3.193399460350922e-01, -3.215530986531058e-01, -9.032384812655848e-02, 1.068243821847402e-02, -4.509594065453242e-02, 3.598538948686681e-04, 1.179115461182117e-02, 1.110918360245439e-02, 2.403956422240150e-04, 1.708950230787451e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
