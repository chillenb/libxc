...
def test_hyb_mgga_x_revm11_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.042132544429555e+00, -6.499894494249630e-01, -1.899319750220592e-01, -2.492382869972625e-02, -3.631933510493349e-03, -7.742627382029859e-05, -3.879802602739144e-10]
...
def test_hyb_mgga_x_revm11_Li_2_vrho():
    ...
    ref_tgt = [-1.793144700237193e+00, -1.795827632783954e+00, -7.914795468758428e-01, -7.940886156242778e-01, -2.336271526938611e-01, -2.339471488854606e-01, -5.094369073072327e-02, -1.338672605072652e-04, -5.119201127378278e-03, -4.319475156690112e-09, -1.558255310330356e-04, -1.521731973684905e-04, -1.287229147011463e-09, -2.304502391352476e-25]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
