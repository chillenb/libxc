...
def test_hyb_mgga_x_revm11_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.088473543879806e+00, -6.932761758199022e-01, -8.438955981321120e-02, -2.503664094060359e-02, -2.154986501788712e-03, -7.755020207917398e-05, -3.879813342080731e-10])
...
def test_hyb_mgga_x_revm11_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([2.532132892108297e-02, 2.537288544514759e-02, -1.187839446896926e-02, -1.172757196891652e-02, 2.878454163075129e-03, 3.135410341798888e-03, 9.197182238773009e-02, -2.555801867216061e-08, 6.389735408466641e-03, -5.273310801238555e-15, -1.404445401121967e-11, -3.005726953252904e-08, -3.201782509762129e-26, 0.000000000000000e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
