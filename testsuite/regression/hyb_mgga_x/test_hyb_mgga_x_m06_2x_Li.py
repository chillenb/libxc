...
def test_hyb_mgga_x_m06_2x_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.073673989778461e-01, -4.880803213311879e-01, -1.816235450495002e-01, -5.814590280119643e-02, -3.307630256271601e-02, -3.436163441638698e-02, -5.848435809027615e-04])
...
def test_hyb_mgga_x_m06_2x_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([5.930691979364243e-03, 6.254846006163292e-03, -2.700746545177632e-02, -2.716706125539010e-02, -3.857138472575722e-03, -3.959651962695479e-03, 1.026312736564376e-01, -4.168412036591906e-05, -1.834494445520515e-01, -8.534771703338501e-09, -2.072098175370550e-08, -4.499159496359889e-05, -1.158475360276895e-19, -5.278207091827588e-10])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
