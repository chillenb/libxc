...
def test_hyb_mgga_x_mn15_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([9.071253858470841e-03, -5.544711986122137e-01, -4.686695950164392e-01, 1.117063790917585e-01, -7.188290250219971e-02, 1.431154910788963e-02, 3.384121619431041e-04])
...
def test_hyb_mgga_x_mn15_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([-1.550013120549297e-01, -1.553326590174859e-01, -5.178933343646332e-02, -5.191676078408072e-02, -7.714931935425724e-04, -1.805863627291106e-03, -6.163706201848801e+00, 2.632897231497640e-05, 3.659233641414082e-01, 5.712495257468468e-09, 1.299186997155816e-08, 2.834408246321334e-05, 7.774190989830327e-20, 6.379796061438055e-10])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
