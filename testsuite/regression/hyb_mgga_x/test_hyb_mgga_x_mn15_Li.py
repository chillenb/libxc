...
def test_hyb_mgga_x_mn15_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [4.756877456529259e-01, -3.083768008183639e-01, -1.214417108151338e-01, 1.152115394350684e-01, 3.027580929399462e-03, 1.431150292365179e-02, 3.511532844538299e-04]
...
def test_hyb_mgga_x_mn15_Li_2_vrho():
    ...
    ref_tgt = [2.663748691161103e+00, 2.670663581493427e+00, 6.791624603803814e-01, 6.835112138240702e-01, -2.640251738894407e-01, -2.640558307620485e-01, 3.237756174369060e-01, 1.710243469682537e-02, -5.833326010083834e-02, 7.284341260649005e-04, 1.792079985432428e-02, 1.757992350004363e-02, 4.878904606206281e-04, 4.118217397028135e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
...
def test_hyb_mgga_x_mn15_Li_2_vtau():
    ...
    ref_tgt = [-2.485617129892103e-01, -2.489926615631363e-01, -1.467604631090586e-01, -1.471606549309747e-01, 5.750623921177201e-03, 5.994880656107111e-03, -6.303767371612231e+00, 2.632897231497640e-05, 4.832241763695231e-01, 5.712495257468740e-09, 1.300033591347480e-08, 2.834408246321334e-05, 7.774196261055195e-20, 1.699474514460982e-10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
