...
def test_hyb_mgga_x_m05_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.217188005140602e+00, -8.120832934894909e-01, -2.539421648933490e-01, -1.193122740773571e-01, -4.903845005413603e-02, -1.330993032888760e-03, -2.049777557841214e-05])
...
def test_hyb_mgga_x_m05_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-1.947124636064147e-04, 0.000000000000000e+00, -1.941844121773641e-04, -8.059097703101548e-04, 0.000000000000000e+00, -8.027226583133592e-04, -3.164884137247013e-01, 0.000000000000000e+00, -3.142040921094830e-01, -3.158178281765474e+00, 0.000000000000000e+00, -1.944863430452055e-02, -1.325399689550626e+02, 0.000000000000000e+00, -1.043702328456849e-01, -6.979422624464286e-06, 0.000000000000000e+00, -1.863902279483957e-02, -4.761502962110945e-12, 0.000000000000000e+00, -2.056777779582271e+11])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
