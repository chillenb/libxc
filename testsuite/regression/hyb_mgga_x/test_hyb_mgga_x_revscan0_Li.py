...
def test_hyb_mgga_x_revscan0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.485105048062696e+00, -9.830550275060947e-01, -1.706608994594492e-01, -1.359342300974178e-01, -3.825676405147014e-02, -3.612441797238261e-03, -2.566332187339385e-05])
