...
def test_hyb_mgga_x_revscan0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.528059007466110e+00, -1.059806424749198e+00, -2.447289389325787e-01, -1.380431247608255e-01, -5.388042162188120e-02, -4.422245030613760e-03, -1.620948927786289e-05])
...
def test_hyb_mgga_x_revscan0_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-1.410486523754864e-04, 0.000000000000000e+00, -1.405379748659025e-04, -5.512098747785739e-04, 0.000000000000000e+00, -5.487659238395152e-04, -1.747781040912267e-01, 0.000000000000000e+00, -1.260433459820657e-01, -2.257003079322410e+00, 0.000000000000000e+00, -3.317481859583368e+04, -6.124672549396816e+01, 0.000000000000000e+00, -1.010222637113118e+10, 1.509106393662558e+01, 0.000000000000000e+00, -2.822736288751075e+04, 2.416323468972164e+04, 0.000000000000000e+00, -1.177232519499346e+11])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
