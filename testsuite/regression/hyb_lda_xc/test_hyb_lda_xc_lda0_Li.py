...
def test_hyb_lda_xc_lda0_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.372220903614626e+00, -9.668078340131278e-01, -2.542349270400178e-01, -1.312405232080622e-01, -5.488329614580634e-02, -1.363035937194762e-02, -2.857169291148435e-04])
