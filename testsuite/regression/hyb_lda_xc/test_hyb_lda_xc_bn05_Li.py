...
def test_hyb_lda_xc_bn05_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.447307348688094e+00, -9.353045966852145e-01, -1.218187305366437e-01, -2.546760464086229e-02, -2.209399101433014e-03, -2.631825561474588e-05, -1.929964819468595e-10])
