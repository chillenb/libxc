...
def test_lda_c_1d_csc_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.912505747455010e-05, -4.989343518712614e-04, -6.196506730483305e-02, -1.318882691160258e-03, -9.548311964528598e-05, -2.356079010965352e-05, -2.178453324631966e-10])
