...
def test_lda_c_epc18_2_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.321169665695134e-02, -8.142397593830238e-02, -3.975052013990836e-03, -4.095209882501757e-07, -1.305933400649539e-11, -2.353941451669200e-07, -1.028612419795515e-12])
