...
def test_lda_c_mcweeny_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.169892054581030e-02, -8.728200864536331e-02, -5.823849663015496e-02, -4.904579072594838e-05, -1.268774258592265e-08, -4.984515051548318e-03, -7.234725334359089e-05])
