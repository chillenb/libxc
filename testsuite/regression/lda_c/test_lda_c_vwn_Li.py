...
def test_lda_c_vwn_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.400974967430613e-02, -8.420806866583493e-02, -4.968925336996970e-02, -1.805962574706621e-02, -1.097300126798731e-02, -6.795015886534831e-03, -1.629259198827822e-04])
