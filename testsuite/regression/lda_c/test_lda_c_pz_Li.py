...
def test_lda_c_pz_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.319543761172203e-02, -8.322771992503267e-02, -4.988265046702828e-02, -1.819420689433543e-02, -1.097517924953430e-02, -6.749632231591079e-03, -1.672862342604614e-04])
