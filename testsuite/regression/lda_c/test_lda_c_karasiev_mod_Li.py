...
def test_lda_c_karasiev_mod_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.222333207986144e-02, -8.234683902468486e-02, -4.866874251758126e-02, -1.865328957897602e-02, -1.147229362871514e-02, -6.845891189368122e-03, -1.407872839960134e-04])
