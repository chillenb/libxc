...
def test_gga_xc_pbe1w_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.863224178458176e+00, -1.337654318927865e+00, -4.312499969751179e-01, -1.759402882359517e-01, -8.435386842205386e-02, -2.231119735219223e-02, -4.262194370385825e-04])
