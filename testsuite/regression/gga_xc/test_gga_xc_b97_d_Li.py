...
def test_gga_xc_b97_d_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.909859433511796e+00, -1.344456779430025e+00, -4.723430211770033e-01, -1.675647951310278e-01, -8.558050681128926e-02, -1.956118289078445e-02, -4.112155329813335e-04])
...
def test_gga_xc_b97_d_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.521711934995198e+00, -2.523989866502515e+00, -1.727782318198439e+00, -1.729280009233815e+00, -2.796045200101603e-01, -2.804323126861537e-01, -2.214490068393271e-01, 8.807770922520125e-01, -4.836741604605811e-02, 5.669178779180125e-01, -2.788520556733707e-02, -2.654010771443865e-02, -9.308228831123842e-04, 5.152418757517257e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
