...
def test_gga_xc_hcth_147_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.955964347991519e-01, -6.098429811979603e-01, -3.665220820597553e-01, -1.773037763775590e-01, -1.436419764983324e-02]
...
def test_gga_xc_hcth_147_H_2_vrho():
    ...
    ref_tgt = [-9.247900487542136e-01, -1.347103764269252e-01, -8.171263446501571e-01, -1.770352886235747e-01, -4.421004963169914e-01, -1.861917352750491e-01, -1.083277029152893e-01, 3.824549665742088e-02, -1.899327362999798e-02, 4.368473050026817e-02]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
