...
def test_gga_xc_opwlyp_d_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.218927501481654e-01, -5.793434100154549e-01, -3.603015555896765e-01, -1.461613518488168e-01, -5.947303918344496e-02]
...
def test_gga_xc_opwlyp_d_H_2_vrho():
    ...
    ref_tgt = [-8.283765204955421e-01, -2.536263398274878e-01, -7.195184653293717e-01, -2.714960714397611e-01, -4.050841112549066e-01, -2.191208227877763e-01, -1.032757169730805e-01, -4.144071456083203e-02, -1.512860039057851e-02, -2.495678472386845e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
