...
def test_gga_xc_ncap_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.859782300358997e+00, -1.333916990646094e+00, -4.449505098788209e-01, -1.762263706144553e-01, -8.521769187657077e-02, -6.193023449003521e-01, -1.181656451644269e+00])
