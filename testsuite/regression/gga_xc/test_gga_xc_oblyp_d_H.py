...
def test_gga_xc_oblyp_d_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.221129311959495e-01, -5.792981926889832e-01, -3.602388019165267e-01, -1.461121566940916e-01, -5.947161007012587e-02]
...
def test_gga_xc_oblyp_d_H_2_vrho():
    ...
    ref_tgt = [-8.281822745355694e-01, -2.515898863879487e-01, -7.195830079689985e-01, -2.688963089662590e-01, -4.051098565078508e-01, -2.167335723037147e-01, -1.032314139336100e-01, -4.235490467398996e-02, -1.512609833492756e-02, -2.421952677946944e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
