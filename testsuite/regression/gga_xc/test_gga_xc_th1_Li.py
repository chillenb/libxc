...
def test_gga_xc_th1_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.935098106703837e+00, -1.336822998301763e+00, -4.700600305396275e-01, -1.619695945342129e-01, -7.284680501723481e-02, -1.469449017325280e-01, 4.005764647767726e-01])
