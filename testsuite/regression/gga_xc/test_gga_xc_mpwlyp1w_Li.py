...
def test_gga_xc_mpwlyp1w_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.863184697605063e+00, -1.345194848706173e+00, -4.205029921648875e-01, -1.627683355197419e-01, -8.234091954631199e-02, -4.356283453937463e-03, -4.604989430104149e-05]
...
def test_gga_xc_mpwlyp1w_Li_2_vrho():
    ...
    ref_tgt = [-2.310698991977647e+00, -2.312650737992905e+00, -1.593251591718343e+00, -1.594445431478922e+00, -4.577122748586604e-01, -4.580752219489920e-01, -2.075703622507017e-01, -9.341826019016999e-02, -7.618840374541445e-02, -3.559060212555062e-02, -9.849104927293129e-03, -9.624863077011799e-03, -4.154964804015498e-05, -1.164948838440626e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
