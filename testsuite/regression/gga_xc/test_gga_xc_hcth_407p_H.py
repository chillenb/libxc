...
def test_gga_xc_hcth_407p_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.963308327759332e-01, -6.076437612494550e-01, -3.651290375719724e-01, -1.911828193292820e-01, -1.521225855275990e-02])
...
def test_gga_xc_hcth_407p_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-9.258501577563938e-01, -1.899871755578935e-01, -8.206666969484370e-01, -2.025456703629675e-01, -4.377486292481509e-01, -1.817663484212870e-01, -8.897890061066797e-02, 1.995436585695850e-02, -2.011501545965729e-02, 1.060985445974538e-01])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
