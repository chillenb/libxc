...
def test_gga_xc_kt2_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.853912642114547e-01, -6.364799646338403e-01, -3.728378631781573e-01, -1.011622647597157e-01, -5.295682550606291e-03]
...
def test_gga_xc_kt2_H_2_vrho():
    ...
    ref_tgt = [-9.088275853018767e-01, -1.558213058937731e-01, -8.007801473925058e-01, -1.487182378131797e-01, -4.808202006663351e-01, -1.160557780618610e-01, -1.334657326138260e-01, -5.424693882670206e-02, -7.010911518594762e-03, -4.012453526819535e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
