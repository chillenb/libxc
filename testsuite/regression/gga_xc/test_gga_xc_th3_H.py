...
def test_gga_xc_th3_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.644130743488462e-01, -6.027928468922871e-01, -3.731003276625762e-01, -1.303106116562443e-01, -1.607837121805542e-02]
...
def test_gga_xc_th3_H_2_vrho():
    ...
    ref_tgt = [-9.171437323873148e-01, -1.013240336755476e-01, -7.725867809032061e-01, -7.584396035264933e-02, -4.313065783949777e-01, -2.238899120809243e-02, -1.198948304798290e-01, -7.215653541628397e-03, -1.298989820317209e-02, -6.970378169481201e-02]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
