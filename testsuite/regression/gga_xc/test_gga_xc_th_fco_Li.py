...
def test_gga_xc_th_fco_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.155760114255701e+00, -1.521679921089201e+00, -6.641514648956015e-01, -3.117433932063836e-01, -2.053520502499509e-01, -3.594890223709508e-01, 4.503815673602923e-01])
