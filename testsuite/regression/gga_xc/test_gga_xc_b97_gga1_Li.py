...
def test_gga_xc_b97_gga1_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.930746857391761e+00, -1.348596135927326e+00, -4.981047418529934e-01, -1.709605594217768e-01, -8.747627994608087e-02, -2.590000864172848e-02, -5.352494608673188e-04]
...
def test_gga_xc_b97_gga1_Li_2_vrho():
    ...
    ref_tgt = [-2.599989870958519e+00, -2.602293958278725e+00, -1.782955497079763e+00, -1.784478377213218e+00, -1.923870937253413e-01, -1.931887110686779e-01, -2.303814189436954e-01, 9.304522475837043e-01, -3.833776404019909e-02, 6.023655721727902e-01, -3.639052838030089e-02, -3.491576748179485e-02, -1.130959578574161e-03, 4.468885847061827e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
