...
def test_gga_xc_mpwlyp1w_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.258179795101766e-01, -5.841715461261363e-01, -3.646419753984503e-01, -1.443421032129541e-01, -5.703110817973283e-04])
...
def test_gga_xc_mpwlyp1w_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-8.326181872488674e-01, -2.402526679939283e-01, -7.229815008357384e-01, -2.508643032703871e-01, -4.085864087031209e-01, -1.972147412601594e-01, -1.198771979713068e-01, -4.257198383426508e-02, -1.650589588844149e-03, -2.993989141992457e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
