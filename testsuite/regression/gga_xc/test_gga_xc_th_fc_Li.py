...
def test_gga_xc_th_fc_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.131437108792289e+00, -1.508011558981075e+00, -6.849127017116712e-01, -3.586610597245229e-01, -2.681015234438642e-01, -3.407475746968527e-01, 1.615039880816763e+00]
...
def test_gga_xc_th_fc_Li_2_vrho():
    ...
    ref_tgt = [-2.926817043148511e+00, -2.929313297159362e+00, -1.954834709497309e+00, -1.956389852283069e+00, -4.288520835837963e-01, -4.285957855238133e-01, -3.973036561745414e-01, -7.748239165769184e-02, -2.313077436407880e-01, 6.802159950221834e-02, -3.594262920053592e-01, -3.565499030384595e-01, -2.090282662687657e+00, -3.228576670727889e+00]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
