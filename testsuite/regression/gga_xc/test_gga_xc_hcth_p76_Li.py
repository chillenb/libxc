...
def test_gga_xc_hcth_p76_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.785056957580824e+00, -1.189802579457745e+00, -3.595280454413737e-01, -1.003361545130080e-01, -3.853078681785949e-02, -3.900210860536203e-02, -5.342984723304277e-04])
...
def test_gga_xc_hcth_p76_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.498228559413345e+00, -2.500672774470165e+00, -1.629520454307771e+00, -1.631190026179060e+00, -1.436651414563571e-01, -1.446853777574735e-01, -1.595359438987652e-01, -1.263194664163735e+00, 5.480178505363260e-03, -7.931167533328088e-01, -5.010124202268830e-02, -5.126067116108080e-02, -3.086500911465748e-04, -1.855058017485864e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
