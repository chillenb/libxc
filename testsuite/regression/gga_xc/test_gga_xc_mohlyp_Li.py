...
def test_gga_xc_mohlyp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.818124301282109e+00, -1.290656683895239e+00, -4.590276508067057e-01, -1.661762452017006e-01, -8.403866120595666e-02, -3.162149626084685e-02, -6.047033425809060e-04])
