...
def test_mgga_c_rppscan_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.565505986010903e-02, -2.438854299236690e-02, -1.481762904283233e-02, -2.012621562903424e-04, -3.846315914119575e-08, -1.067638503069928e-03, -5.788917053522302e-06])
...
def test_mgga_c_rppscan_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-3.481108043040237e-02, -3.473828000250047e-02, -3.781899381156490e-02, -3.775361074584977e-02, -4.931938850677482e-02, -4.933936153499957e-02, -1.594402626466464e-03, -1.591277537839823e-01, -1.343048660198849e-02, -9.393543880072111e-02, -2.008547655874807e-03, -2.023105915393410e-03, -1.075222065182060e-05, -1.347139219250738e-05])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
