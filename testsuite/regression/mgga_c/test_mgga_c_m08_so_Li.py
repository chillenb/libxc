...
def test_mgga_c_m08_so_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.139024636468379e-01, -1.181134693864477e-01, -1.995992848245685e-01, -4.182667836673438e-02, -3.796055151246079e-02, -3.948869978531433e-02, -9.799458568975964e-04])
...
def test_mgga_c_m08_so_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([-3.173316397585907e-02, -3.173316397585900e-02, 4.580072822454370e-02, 4.580072822454370e-02, -3.845037815996159e-02, -3.845037815996159e-02, -1.056870093623146e+00, -1.056870093622921e+00, -2.308661976871572e-01, -2.308661975280074e-01, -1.356981622033984e-07, -1.356981620874713e-07, -3.569246435322067e-19, -3.585789871870490e-19])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
