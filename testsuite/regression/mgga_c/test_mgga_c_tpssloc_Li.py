...
def test_mgga_c_tpssloc_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.347144678185146e-02, -8.371482262002407e-02, -4.959806172627841e-02, -1.808614940689015e-02, -1.095911360424974e-02, -8.827962574675379e-35, -8.300292557722951e-19])
