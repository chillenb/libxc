...
def test_mgga_c_revtm_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.346251621985899e-02, -8.371482262002407e-02, -4.959806172627841e-02, -1.808613505659574e-02, -1.095911360424506e-02, -1.550193581521006e-11, -8.300292557722951e-19])
...
def test_mgga_c_revtm_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([-2.665101733471457e-09, -2.665101733471456e-09, -9.588257702779593e-77, -9.588257702779591e-77, -3.056880835874814e-69, -3.056880835874812e-69, -3.821009485070113e-10, -3.821009485069267e-10, -2.940021288672253e-25, -2.940021286296991e-25, 0.000000000000000e+00, 0.000000000000000e+00, 0.000000000000000e+00, 0.000000000000000e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
