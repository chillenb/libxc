...
def test_mgga_c_tpss_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-9.346210087180268e-02, -8.371482262002407e-02, -4.959806172627841e-02, -1.808612568820412e-02, -1.095911360423736e-02, -5.892600477133273e-12, -8.300292557722951e-19]
...
def test_mgga_c_tpss_Li_2_vrho():
    ...
    ref_tgt = [-1.026712119270149e-01, -1.025093296667022e-01, -9.254539378426754e-02, -9.240668603323736e-02, -5.664537600732751e-02, -5.668890672673786e-02, -2.101631195727098e-02, -1.243108863835546e-01, -1.310473963822716e-02, -7.152742107203552e-02, -4.266538431360686e-11, -3.375403352018220e-11, -1.026864148341892e-18, -7.910146580446758e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
