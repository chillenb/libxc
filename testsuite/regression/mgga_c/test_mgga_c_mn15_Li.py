...
def test_mgga_c_mn15_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.607716086290737e-01, -8.471418769751494e-02, 6.837382934087993e-02, -4.312154479343108e-02, 1.289448759925678e-02, -1.922901299375069e-03, -4.775266028068120e-05]
...
def test_mgga_c_mn15_Li_2_vrho():
    ...
    ref_tgt = [-4.039142010341299e-01, -4.035588787436167e-01, -2.921465244755226e-01, -2.919799028605005e-01, 5.813521120835001e-02, 5.817455827319325e-02, -1.160567024251476e-01, -3.174192749366093e-01, -4.627616708033183e-03, 2.329721052491062e+00, -2.414497837420723e-03, -2.441621474998957e-03, -5.617609056740022e-05, -8.243054259892993e-05]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
