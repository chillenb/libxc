...
def test_mgga_c_hltapw_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-8.989752028284360e-02, -8.208377173650026e-02, -5.392545355676064e-02, -1.712024840949796e-02, -1.179012968246655e-02, -1.367612787930996e-02, -1.421569667513670e-03])
...
def test_mgga_c_hltapw_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-9.441263239007738e-02, -9.435151781932882e-02, -8.646053394078490e-02, -8.640910074440111e-02, -5.753232081073753e-02, -5.766328062839544e-02, -1.828958323144582e-02, -9.184520471891885e-01, -1.291844298086811e-02, -1.736142557620382e+00, -1.386846436083982e-02, -1.659950346155157e-02, -1.662506329353912e-03, -1.505834212314919e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
