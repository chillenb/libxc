...
def test_mgga_c_rmggac_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.565339837219293e-02, -2.438245090193295e-02, -1.449665727637643e-02, -2.724260402241904e-04, -1.371567822417214e-08, -7.957649910248841e-04, -3.756670063267504e-06])
...
def test_mgga_c_rmggac_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([1.790176763892149e-06, 3.580353527784298e-06, 1.790176763892149e-06, 9.572333137373725e-06, 1.914466627474745e-05, 9.572333137373725e-06, 2.750705800493730e-03, 5.501411600987460e-03, 2.750705800493730e-03, 8.006246877374045e+00, 1.601249375474809e+01, 8.006246877374045e+00, 1.494206453628675e-05, 2.988412907257351e-05, 1.494206453628675e-05, 2.218472388834460e+00, 4.436944777668919e+00, 2.218472388834460e+00, 4.200359363129391e+03, 8.400718726258781e+03, 4.200359363129391e+03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
