...
def test_mgga_c_rmggac_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-8.700145806999472e-02, -8.305310452030418e-02, -4.923612906978183e-02, -1.641673835967545e-02, -1.083086779353643e-02, -2.952311010867517e-04, -1.338090129662321e-07]
...
def test_mgga_c_rmggac_Li_2_vsigma():
    ...
    ref_tgt = [1.796621077421929e-04, 3.593242154843858e-04, 1.796621077421929e-04, 6.326656347713163e-04, 1.265331269542633e-03, 6.326656347713163e-04, 1.761908193140355e-01, 3.523816386280709e-01, 1.761908193140355e-01, 1.115941136766236e+01, 2.231882273532472e+01, 1.115941136766236e+01, 1.616698549557133e+02, 3.233397099114266e+02, 1.616698549557133e+02, 3.948417877596048e-02, 7.896835755192096e-02, 3.948417877596048e-02, -2.259652799794801e-03, -4.519305599589602e-03, -2.259652799794801e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
