...
def test_mgga_c_r2scan01_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-4.100636804569064e-02, -5.629325295468333e-02, -6.498879409859544e-02, -2.344946743553334e-03, -1.518603161347360e-02, -2.549715731629722e-04, -2.994175370304462e-08])
