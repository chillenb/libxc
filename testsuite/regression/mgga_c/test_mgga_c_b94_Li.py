...
def test_mgga_c_b94_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-9.490310332403873e-02, -4.625153314305778e-02, -7.435489068897475e-03, -7.957127468107150e-05, -3.793249656734052e-09, -1.059415131174904e-03, -3.794362067238579e-03]
...
def test_mgga_c_b94_Li_2_vrho():
    ...
    ref_tgt = [-1.086597628280329e-01, -1.084583513721225e-01, -4.403912463763657e-02, -4.401362019197232e-02, -2.416561631391298e-02, -2.389227187649082e-02, -1.248941899498990e-03, -5.933462446985951e-02, -2.940502972831827e-03, -4.178243148157026e-02, -7.164969022514718e-03, -6.298425357089565e-05, -2.517318841781176e-02, -2.726961579828643e-08]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
...
def test_mgga_c_b94_Li_2_vlapl():
    ...
    ref_tgt = [1.916017025680366e-06, 1.912231848704955e-06, 5.677158580750868e-04, 5.648368491340944e-04, 2.471899566683088e-04, 2.367650056872445e-04, 5.229083439298317e-05, 7.342727697471237e-04, 2.745686181240986e-09, 2.603657800727735e-03, 1.705732685749077e-04, 2.593630705339738e-07, 2.028799729524078e-03, 2.891791128346501e-10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
