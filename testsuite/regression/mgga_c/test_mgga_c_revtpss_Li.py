...
def test_mgga_c_revtpss_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.346251970582074e-02, -8.371482262002407e-02, -4.959806172627841e-02, -1.808613505662302e-02, -1.095911360424506e-02, -1.550193581524719e-11, -8.300292557722951e-19])
...
def test_mgga_c_revtpss_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([-1.012374542424982e-09, -1.012374542424981e-09, -3.623645871820187e-77, -3.623645871820187e-77, -1.123345276918218e-69, -1.123345276918216e-69, -3.796317011289467e-10, -3.796317011288629e-10, -2.940008682004267e-25, -2.940008679629012e-25, 0.000000000000000e+00, 0.000000000000000e+00, 0.000000000000000e+00, 0.000000000000000e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
