...
def test_mgga_c_cf22d_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.204401075112164e-01, -7.651678134693722e-02, 1.350199214350398e-02, -3.405271925996166e-02, 4.309223716588094e-03, -1.333776715303643e-02, -3.309387292994891e-04])
...
def test_mgga_c_cf22d_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.550394357449999e-01, -2.547636558406089e-01, -2.201167500928329e-01, -2.199657939550189e-01, 8.226705332103655e-02, 8.226577437745698e-02, -7.356759901823032e-02, -2.284365001126445e-01, 6.443468353770535e-03, 1.634058970235388e+00, -1.676496391333800e-02, -1.695309093380731e-02, -3.893153579584796e-04, -5.712657444360053e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
