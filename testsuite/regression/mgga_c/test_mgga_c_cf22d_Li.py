...
def test_mgga_c_cf22d_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.229711442247070e-01, -1.198060841469819e-01, -1.931229797705034e-01, -4.284362660428810e-02, -3.894013191924937e-02, -1.333774619301220e-02, -3.309387292989996e-04]
...
def test_mgga_c_cf22d_Li_2_vtau():
    ...
    ref_tgt = [2.156077385232313e-02, 2.156077385232312e-02, 3.026046339861434e-02, 3.026046339861433e-02, -1.547168687704779e-02, -1.547168687704777e-02, 8.164737457301386e-01, 8.164737457299610e-01, -2.155435100643654e-01, -2.155435099157890e-01, -2.010399497785979e-08, -2.010399497731639e-08, -5.310701623239670e-20, -5.310378509244584e-20]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
