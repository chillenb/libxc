...
def test_mgga_c_vsxc_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-7.266304328285467e-02, -4.679608288602948e-02, -8.448662068097615e-01, -2.923984944547002e-02, -6.237265979229468e-02, 8.359561434618888e-07, -3.373280763332118e-08])
...
def test_mgga_c_vsxc_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([6.464690451272410e-03, 6.493921538529039e-03, 5.681747790222633e-03, 5.705462551314264e-03, -3.560238477936857e-01, -3.570106251010904e-01, 4.119264657102072e-01, 3.904624238217849e-05, -2.038295404750724e+00, 2.638258718169071e-07, -1.542193855175163e-08, -3.747288159335614e-05, -1.540481646926016e-19, 1.076429708450036e-07])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
