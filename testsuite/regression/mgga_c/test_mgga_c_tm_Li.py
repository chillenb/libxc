...
def test_mgga_c_tm_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.447834352001868e-02, -2.764059596275451e-02, -2.654662973748058e-03, -2.453417410541883e-03, -5.294125595584699e-09, -7.607968796421618e-09, -1.790424362528482e-16]
...
def test_mgga_c_tm_Li_2_vtau():
    ...
    ref_tgt = [-1.089846531422426e-02, -1.089846531422426e-02, -7.241125689473858e-03, -7.241125689473857e-03, -2.623033533272320e-04, -2.623033533272318e-04, -1.138569462618429e+00, -1.138569462618177e+00, -3.762626910431491e-02, -3.762626907391640e-02, -4.525376246325964e-14, -4.525376246325965e-14, -9.070442358332183e-32, -9.070442358332188e-32]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
