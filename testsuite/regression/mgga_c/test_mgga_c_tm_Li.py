...
def test_mgga_c_tm_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.346209774030460e-02, -8.371482262002407e-02, -4.959806172627841e-02, -1.808612568817779e-02, -1.095911360423736e-02, -5.892600477120597e-12, -8.300292557722951e-19])
...
def test_mgga_c_tm_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.026712147700619e-01, -1.025093324919725e-01, -9.254539378426754e-02, -9.240668603323736e-02, -5.664537600732751e-02, -5.668890672673786e-02, -2.101631195730691e-02, -1.243108862723517e-01, -1.310473963822716e-02, -7.152742107203552e-02, -4.266538431791472e-11, -3.375403351533873e-11, -1.026864148341892e-18, -7.910146580446758e-19])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
