...
def test_mgga_c_m08_hx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.418245736167636e-01, -6.459429179231520e-02, -2.372331373617051e-01, -2.659625753818623e-02, -4.221084099441874e-02, -4.716355061333927e-02, -1.170169207492127e-03]
...
def test_mgga_c_m08_hx_Li_2_vrho():
    ...
    ref_tgt = [-5.895367096438454e-01, -5.892910080002951e-01, -4.574472432931383e-02, -4.563769753688342e-02, 2.012493789267630e-02, 1.991672553965351e-02, -1.128017805269013e-01, -2.646996332164540e-01, 2.851414017814797e-03, -2.221732193231304e-01, -5.928619710944097e-02, -5.995142989154484e-02, -1.376583649954237e-03, -2.019943645919528e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
