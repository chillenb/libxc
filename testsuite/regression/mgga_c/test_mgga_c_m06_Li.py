...
def test_mgga_c_m06_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.672793734505156e-02, -6.896498763574202e-02, -1.308032100366321e-01, 1.677724006257281e-02, -5.780269126113900e-02, -3.228149230304574e-04, -1.730232014659572e-05])
...
def test_mgga_c_m06_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-5.689402191500964e-02, -5.603511425380245e-02, -4.716829119372767e-02, -4.666892514304874e-02, -4.774942634370191e-02, -4.064395254065925e-02, 3.174115192211870e-02, -1.799298997262614e-02, 1.677731137960869e-02, -8.119806781196982e-03, -2.193834791581557e-02, -2.186609208092342e-02, -7.274757403837339e-04, -7.516522783245633e-05])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
