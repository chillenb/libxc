...
def test_mgga_c_revscan_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.707755030080274e-02, -2.553135770780387e-02, -1.309719987772237e-02, -3.061718063394891e-04, -4.784515158194613e-08, -1.111893021074258e-03, -6.455763794533750e-06])
...
def test_mgga_c_revscan_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([-2.307503569113028e-03, -2.307503569113027e-03, -2.809784119280092e-03, -2.809784119280092e-03, -6.832048288837600e-03, -6.832048288837597e-03, -1.366335957196810e-01, -1.366335957196508e-01, -2.758487640013235e-01, -2.758487637784634e-01, -7.885507414394226e-11, -7.885507414394227e-11, -6.740990255132599e-23, -6.740990255132604e-23])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
