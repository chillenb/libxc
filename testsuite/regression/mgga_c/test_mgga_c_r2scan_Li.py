...
def test_mgga_c_r2scan_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.565506528762366e-02, -2.438854336082034e-02, -1.481762904283233e-02, -2.019636864178317e-04, -3.846315914119575e-08, -1.067638503069930e-03, -5.788917053522284e-06]
...
def test_mgga_c_r2scan_Li_2_vrho():
    ...
    ref_tgt = [-3.483265355579254e-02, -3.475985308204445e-02, -3.781956381493292e-02, -3.775418074621841e-02, -4.931938850677482e-02, -4.933936153499956e-02, -1.605381494675234e-03, -1.591399194310048e-01, -1.343048660198849e-02, -9.393543880072112e-02, -2.008547655874808e-03, -2.023105915393412e-03, -1.075222065182059e-05, -1.347139219250734e-05]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
