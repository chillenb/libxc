...
def test_mgga_c_mn15_l_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-7.979359276939758e-02, -8.807261581537042e-02, -4.005912614072262e-01, -1.566560528088560e-02, -6.903043906775334e-02, -1.796635978177092e-02, -4.458778983378974e-04])
