...
def test_mgga_c_mn15_l_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.414260818930498e-01, -1.471142815563226e-01, 7.005251117172916e-02, -2.118750486838162e-02, 1.228036871377705e-02, -1.796651930943270e-02, -4.458778983416237e-04])
...
def test_mgga_c_mn15_l_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-8.461415181789415e-05, -1.692283036357883e-04, -8.461415181789415e-05, -2.186131623227922e-04, -4.372263246455844e-04, -2.186131623227922e-04, 3.161583093370020e-02, 6.323166186740042e-02, 3.161583093370020e-02, -6.385892787148883e+00, -1.277178557429777e+01, -6.385892787148883e+00, 9.554530350373531e+01, 1.910906070074706e+02, 9.554530350373531e+01, 3.524560428017689e-03, 7.049120856194453e-03, 3.524560428017689e-03, 3.373860385305643e-05, 6.747731460900911e-05, 3.373860385305643e-05])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
