...
def test_mgga_c_bc95_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.517333869970402e-02, -3.832557383986378e-02, -9.706680231042746e-03, -9.569134312279086e-05, -2.182532448212174e-10, -1.327870368225530e-05, -1.126992763648026e-06]
...
def test_mgga_c_bc95_Li_2_vsigma():
    ...
    ref_tgt = [4.132575779267206e-05, 0.000000000000000e+00, 4.113737666855524e-05, 1.594551976290499e-04, 0.000000000000000e+00, 1.586449484834225e-04, 9.709021590385846e-03, 0.000000000000000e+00, 9.630978071103387e-03, 2.502270307487512e+00, 0.000000000000000e+00, 5.648708779456898e+00, 6.520909806496228e+00, 0.000000000000000e+00, 6.632484764765807e+02, 9.633536558453863e-01, 0.000000000000000e+00, 8.121669096347492e-02, 1.778945379389083e+04, 0.000000000000000e+00, 1.857317276782201e+00]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_mgga_c_bc95_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
