...
def test_mgga_c_bc95_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.999257936936117e-02, -6.482501445426840e-02, -2.027784815737483e-01, -2.934998413999233e-03, -3.853961990161335e-02, -1.313477194378342e-07, -1.895103513987220e+02]
...
def test_mgga_c_bc95_Li_2_vsigma():
    ...
    ref_tgt = [1.093130027654306e-04, 0.000000000000000e+00, 1.088952905248786e-04, 8.373428660375165e-04, 0.000000000000000e+00, 8.326756155872380e-04, 4.959454231912993e+00, 0.000000000000000e+00, 4.856401913746009e+00, 5.260941534372241e+00, 0.000000000000000e+00, 5.649063800257172e+00, 2.416488231143508e+03, 0.000000000000000e+00, 6.632508543915026e+02, 1.193814816847380e-04, 0.000000000000000e+00, 8.771345115992075e-03, 5.497290808982469e-11, 0.000000000000000e+00, 3.225550206069089e+20]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
