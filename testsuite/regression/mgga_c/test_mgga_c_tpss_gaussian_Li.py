...
def test_mgga_c_tpss_gaussian_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-9.346210030555922e-02, -8.371482262002407e-02, -4.959806172627841e-02, -1.808612568676710e-02, -1.095911360423736e-02, -5.892287584479840e-12, -8.300292557722951e-19]
...
def test_mgga_c_tpss_gaussian_Li_2_vrho():
    ...
    ref_tgt = [-1.026712126809282e-01, -1.025093304209565e-01, -9.254539378426754e-02, -9.240668603323736e-02, -5.664537600732751e-02, -5.668890672673786e-02, -2.101631195919127e-02, -1.243108863726644e-01, -1.310473963822716e-02, -7.152742107203572e-02, -4.266311410392269e-11, -3.375223960418613e-11, -1.060211934891276e-18, -4.836050979090974e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
