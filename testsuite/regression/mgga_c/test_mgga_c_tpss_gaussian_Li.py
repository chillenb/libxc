...
def test_mgga_c_tpss_gaussian_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.934998883632613e-02, -4.020232965266050e-02, -4.001281559425683e-03, -2.468452642756615e-03, -6.150191457942031e-09, -7.610292449094138e-09, -1.790424362528482e-16]
...
def test_mgga_c_tpss_gaussian_Li_2_vsigma():
    ...
    ref_tgt = [8.317711165706782e-05, 1.933547508966203e-04, 8.320973591704655e-05, 2.081294986967723e-04, 3.188333859070188e-04, 2.080357672027582e-04, 1.724627919416701e-02, -2.337011064695352e-02, 1.729639531707931e-02, 3.293810122958886e+01, 8.871827059292728e+01, 4.555383480053485e+02, 1.573295984388997e+01, 3.144461526301395e+01, 6.253977066112035e+04, 4.337572391372139e-04, -2.079030226697707e-04, 4.456754269432319e-04, 1.606375526063325e-06, 3.212751052298149e-06, 1.606375526071368e-06]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_mgga_c_tpss_gaussian_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
