...
def test_mgga_c_b88_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.621597218845438e-02, -5.779821309743782e-02, -1.242859003931817e-01, -1.643733878539518e-03, -1.746796153344852e-02, -9.482258564519751e-05, -4.022888232979444e+01])
...
def test_mgga_c_b88_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-4.973533520428060e-02, -4.959921356784270e-02, -4.345456363878107e-02, -4.337799304421693e-02, 1.849111331577167e-02, 1.724392510736829e-02, 6.179248613556778e-04, -3.882742529238692e-01, 7.164737623460782e-03, -3.368791850331554e+00, -1.376531351942599e-01, -3.610078983135199e-02, -1.303626492712442e-01, 5.085371622446052e+01])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
