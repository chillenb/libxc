...
def test_mgga_c_revm06_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-7.175302394191925e-02, -6.503247594912004e-02, -1.344636918403049e-01, -8.872311886379173e-04, -2.644561266435018e-02, 1.910519372512543e-02, 3.225932487966175e-04])
...
def test_mgga_c_revm06_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-7.857971664614295e-02, -7.827263241422362e-02, -6.773543845701885e-02, -6.744652582822691e-02, 3.723272567891679e-02, 3.660502088244253e-02, 3.029439314496633e-03, 6.914288548868508e-01, 3.753300211000526e-03, 4.174968764435884e-01, 3.304218301656967e-02, 3.369077493626815e-02, 5.471545540246952e-04, 9.377303008948020e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
...
def test_mgga_c_revm06_Li_2_vtau():
    ...
    ref_tgt = numpy.asarray([-2.233018426880456e-05, -3.132927026407638e-05, -6.069212618413016e-04, -6.176572518614914e-04, -3.483010170066237e-02, -3.531534023132490e-02, -1.219546844198712e-01, 2.753647212827356e-03, -2.962076206041587e-01, 3.631734391555109e-04, 6.033898811395014e-05, 2.831300034566004e-03, 1.676886258295104e-09, 4.552792679096311e-09])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
