...
def test_mgga_c_m06_2x_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.916551642429998e-02, -7.035261411589139e-02, -1.182938674369627e-01, 1.468918225053278e-02, -5.469541796564105e-02, 1.541025490975264e-02, 2.697223242270711e-04]
...
def test_mgga_c_m06_2x_Li_2_vrho():
    ...
    ref_tgt = [-6.091143706157705e-02, -6.011588558009946e-02, -5.129941465694382e-02, -5.081867747994210e-02, -5.663485407814688e-02, -4.961626602230133e-02, 2.832911778252075e-02, 5.297023659328500e-01, 1.472902318192816e-02, 3.356106682941292e-01, 3.282388119400161e-03, 4.163137738511171e-03, -3.431978144901863e-04, 8.030014582193025e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
