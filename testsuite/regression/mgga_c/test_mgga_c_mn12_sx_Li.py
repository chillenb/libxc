...
def test_mgga_c_mn12_sx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.236520272154800e-02, -4.553569612073346e-02, -5.903875755703740e-01, -1.780971771938535e-02, -1.057116672953833e-01, -1.401226086732070e-01, -3.476903582622099e-03])
...
def test_mgga_c_mn12_sx_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-1.217186691443571e-01, -1.215587865814881e-01, -1.294236618327339e-01, -1.293482133780538e-01, -4.624280989012244e-02, -4.676097521757783e-02, -2.591048342083157e-02, -1.276271269154960e-01, 2.556692533473513e-02, -5.379785671961739e-01, -1.761161966739689e-01, -1.780925990524860e-01, -4.090219255075959e-03, -6.001823714128680e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
