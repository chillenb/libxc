...
def test_mgga_c_mn12_sx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.976999332356414e-01, -1.086861804557150e-01, -2.044425181192019e-02, -2.684848379508842e-02, 4.777987077476829e-03, -1.401226093589840e-01, -3.476903582622115e-03]
...
def test_mgga_c_mn12_sx_Li_2_vtau():
    ...
    ref_tgt = [2.875836983057559e-02, 2.875836983057556e-02, 3.310503723872344e-02, 3.310503723872343e-02, -9.794811216784674e-02, -9.794811216784671e-02, 5.598764307333973e-01, 5.598764307332750e-01, -7.236455894757288e-01, -7.236455889769130e-01, -2.925367940153313e-07, -2.925367940127048e-07, -7.729234110004035e-19, -7.729379511301825e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
