...
def test_mgga_c_m06_l_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.938727145795362e-02, -3.979161498179351e-02, 2.311279694031998e-02, 7.454321734617630e-04, 1.105142429460965e-07, 4.412790887992715e-02, 1.258657752993939e-03]
...
def test_mgga_c_m06_l_Li_2_vrho():
    ...
    ref_tgt = [-1.322861546608589e-02, -1.311913009316190e-02, -2.419638220839304e-02, -2.424772090917005e-02, -1.156954693825214e-01, -1.134346401028973e-01, 7.658485537172056e-03, 1.113369661165436e+00, -1.038554713612288e-02, 6.607666334539675e-01, 7.251609369639631e-02, 6.611617815487840e-02, 1.672351392168945e-03, 2.346414414012601e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
