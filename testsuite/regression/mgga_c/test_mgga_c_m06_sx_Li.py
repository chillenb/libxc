...
def test_mgga_c_m06_sx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-8.937083903044821e-02, -8.315282886817477e-02, -1.422800403231489e-01, -8.472026014762008e-03, -2.989636414436519e-02, 1.471465681374013e-02, 2.375939242875677e-04]
...
def test_mgga_c_m06_sx_Li_2_vrho():
    ...
    ref_tgt = [-9.326689684670325e-02, -9.298572264748334e-02, -8.054532146538068e-02, -8.027678695128454e-02, -6.220700740922125e-03, -7.113233536054947e-03, -4.923527951189204e-03, 5.312654625124931e-01, -1.035246298056083e-02, 3.213786077230789e-01, 2.199969817388147e-02, 2.253094616773277e-02, 3.055466941972838e-04, 6.680085896769630e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
