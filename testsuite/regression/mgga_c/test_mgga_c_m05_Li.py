...
def test_mgga_c_m05_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-5.593075819810847e-02, -5.312835608757441e-02, 3.172466139429175e-02, -6.911693296844165e-04, -1.259011089808138e-08, -3.902664384046117e-03, -8.267900129372722e-05])
...
def test_mgga_c_m05_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-5.706410673905634e-02, -5.695227778525173e-02, -3.200384496756575e-02, -3.175949808042276e-02, -4.270963569610033e-02, -4.366948632921999e-02, -1.539196967355446e-02, -1.144197166910400e-01, 4.826288272394301e-03, -7.929786201910576e-02, -5.152275823561595e-03, -5.097322052038485e-03, -7.819596986600185e-05, -2.147358840740951e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
