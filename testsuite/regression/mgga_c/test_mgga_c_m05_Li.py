...
def test_mgga_c_m05_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-9.352896657886006e-02, -8.371482262002408e-02, -4.959806172627838e-02, -1.808781036521564e-02, -1.095911493760681e-02, -3.629454026131921e-03, -8.776912343101520e-05])
