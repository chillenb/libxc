...
def test_mgga_c_m06_hf_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-7.883580834794238e-02, -7.566274191679782e-02, -9.775319363174437e-02, 1.611235804420147e-02, -5.753949090564558e-02, -4.234804117235515e-02, -7.625564167078678e-04]
...
def test_mgga_c_m06_hf_Li_2_vrho():
    ...
    ref_tgt = [-7.807162696120901e-02, -7.711299606299396e-02, -6.806296060242845e-02, -6.747450831651358e-02, -4.895135346639140e-02, -4.095180693334458e-02, 3.141114891833419e-02, -1.540275185089506e+00, 1.649245593956741e-02, -9.271260638155655e-01, -1.061934797749586e-01, -1.071087403552734e-01, -2.320013253364070e-03, -2.315735039705950e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
