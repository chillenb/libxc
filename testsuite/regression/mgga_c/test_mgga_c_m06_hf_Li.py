...
def test_mgga_c_m06_hf_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.104542202517969e-01, -7.929860055989407e-02, 4.013848159447697e-02, 2.914984687019699e-04, -1.461661165880812e-07, -6.853314608597164e-02, -2.064600333197206e-03]
...
def test_mgga_c_m06_hf_Li_2_vtau():
    ...
    ref_tgt = [8.599000514773117e-03, 8.611710059261063e-03, 2.333752349068988e-03, 2.322035817984073e-03, -4.976608224065369e-03, -3.198581450771360e-03, 7.521923119380192e-01, -2.028217371079227e-02, 8.323593825461403e-01, -2.159004626926246e-03, -7.588634558453035e-06, -1.661115042989395e-02, -7.837079475212251e-14, -1.080087038459936e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
