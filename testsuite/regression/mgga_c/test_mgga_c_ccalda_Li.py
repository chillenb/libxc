...
def test_mgga_c_ccalda_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-9.348338102074970e-02, -8.371471638070770e-02, -4.959804183630557e-02, -1.623891792089766e-03, -9.936863716637719e-03, -6.778618829599305e-03, -1.681734331556010e-04]
...
def test_mgga_c_ccalda_Li_2_vsigma():
    ...
    ref_tgt = [-3.708518535064570e-07, -7.417037069227792e-07, -3.708518535064570e-07, -2.479791261100118e-07, -4.959582523002765e-07, -2.479791261100118e-07, 1.198962750719163e-08, 2.397925466816814e-08, 1.198962750719163e-08, 2.019779391651691e+01, 4.039558783303379e+01, 2.019779391651691e+01, -2.935314184277399e+06, -5.870628368554799e+06, -2.935314184277399e+06, 3.615729876660514e-04, 7.231459753322404e-04, 3.615729876660514e-04, 1.718112593986905e+00, 3.436225187973809e+00, 1.718112593986905e+00]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05


def test_mgga_c_ccalda_Li_2_vlapl():
    # Prepare the input
    inp = test_data["Li"]
