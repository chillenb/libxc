...
def test_mgga_xc_b97m_v_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.215768791965622e+00, -1.550744085725783e+00, -3.163256303627867e-01, -8.442820538750141e-02, -9.570670421904892e-02, -2.614247816295617e-02, -7.054520468291065e-04])
