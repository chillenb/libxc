...
def test_mgga_xc_otpss_d_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.869750463880407e+00, -1.314106061392590e+00, -3.400337038569259e-01, -1.779317101928757e-01, -7.336051939451567e-02, -2.025758111267412e-02, -3.448291517559102e-04])
...
def test_mgga_xc_otpss_d_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.433154773803373e+00, -2.435109660764938e+00, -1.863615931851175e+00, -1.864370610618406e+00, -4.436856006563820e-01, -4.435510344948900e-01, -2.326845361918236e-01, -1.500713179408352e-01, -9.616282794180964e-02, -7.234510894678461e-02, -2.711112573216636e-02, -2.689057646959459e-02, -5.461696861964034e-04, -2.193028551551951e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
