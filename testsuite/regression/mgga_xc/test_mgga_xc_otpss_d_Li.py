...
def test_mgga_xc_otpss_d_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.955779700375937e+00, -1.380647603956610e+00, -4.098775230087877e-01, -1.724679672634004e-01, -7.740820477382797e-02, -2.025446091581154e-02, -3.783264591946212e-04]
...
def test_mgga_xc_otpss_d_Li_2_vrho():
    ...
    ref_tgt = [-2.450392821488229e+00, -2.452504524173403e+00, -1.727147933637122e+00, -1.728654835279766e+00, -3.588349793504446e-01, -3.552549444856414e-01, -2.399534854315344e-01, -1.306119211836810e-01, -7.895713558229316e-02, -7.249284503877009e-03, -2.708640558042903e-02, -2.689060480404915e-02, -5.461692456692833e-04, -3.882765574663403e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
