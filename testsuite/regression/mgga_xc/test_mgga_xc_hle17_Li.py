...
def test_mgga_xc_hle17_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.485813004204159e+00, -1.729070259301069e+00, -5.019768590095663e-01, -2.222912666123025e-01, -9.581251290439707e-02, -2.568060314802715e-02, -4.798233723307655e-04]
...
def test_mgga_xc_hle17_Li_2_vtau():
    ...
    ref_tgt = [6.055120031546056e-02, 6.071151676084023e-02, 3.205510197396630e-02, 3.215526556674562e-02, 9.258978217400113e-04, 8.208634251389729e-04, 6.967974286405925e-01, -5.685772307638325e-01, -2.856598836117063e-03, -1.881312249715314e-02, 1.308317788976601e-14, 9.622610712040926e-11, -4.535211274036836e-32, 7.551374569862903e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
