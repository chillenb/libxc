...
# test_mgga_xc_cc06_Li_2_zk() not generated due to NaN

# test_mgga_xc_cc06_Li_2_vrho() not generated due to NaN
...
# test_mgga_xc_cc06_Li_2_vlapl() not generated due to NaN


def test_mgga_xc_cc06_Li_2_vtau():
    # Prepare the input
    inp = test_data["Li"]
