...
# test_mgga_xc_cc06_Li_2_zk() not generated due to NaN in reference data

# test_mgga_xc_cc06_Li_2_vrho() not generated due to NaN in reference data


def test_mgga_xc_cc06_Li_2_vsigma():
    # Prepare the input
    inp = test_data["Li"]
...
# test_mgga_xc_cc06_Li_2_vlapl() not generated due to NaN in reference data
