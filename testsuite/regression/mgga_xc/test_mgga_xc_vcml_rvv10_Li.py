...
def test_mgga_xc_vcml_rvv10_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.925519908960271e+00, -1.373865992660458e+00, -4.090583851162406e-01, -1.821269680672470e-01, -8.323066037987976e-02, -9.533028422783170e-03, -1.451703973314537e-04])
