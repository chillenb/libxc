...
def test_mgga_xc_tpsslyp1w_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-7.127008271485483e-01, -6.402119459890344e-01, -3.771624731075351e-01, -1.349020783051429e-01, -7.802302529290104e-03]
...
def test_mgga_xc_tpsslyp1w_H_2_vrho():
    ...
    ref_tgt = [-8.388240621642412e-01, -2.450141668596068e-01, -7.840856234589246e-01, -2.519781966670389e-01, -4.708402625998552e-01, -1.978538093371852e-01, -1.294574185938628e-01, -5.076325836282430e-02, -1.037361273669463e-02, -3.624513323217621e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
