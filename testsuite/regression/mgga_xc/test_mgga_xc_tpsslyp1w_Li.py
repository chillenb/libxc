...
def test_mgga_xc_tpsslyp1w_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.817772691168516e+00, -1.271148996349392e+00, -3.337358466409343e-01, 1.378812478611135e+164, 1.493259757059933e+166, 1.941281829501726e+218, -4.151527992541478e-04])
...
def test_mgga_xc_tpsslyp1w_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-3.385912964314803e-04, 3.864883412170266e-06, -3.360184450499240e-04, -9.317694317665013e-04, 2.698736924043955e-05, -9.302460976158754e-04, -1.417096355447712e-02, 3.532584519053778e-02, -1.476480934803540e-02, -7.459481074705663e+00, 3.401139729395250e+00, 2.273874498182499e+00, -3.256405952267047e+01, 1.744135403403949e+01, 1.130451879999684e+01, 3.012497094755041e-02, 5.872712018115467e-02, -2.334805152723543e-01, -8.108568371384401e-11, 0.000000000000000e+00, -1.557397863841548e+11])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
