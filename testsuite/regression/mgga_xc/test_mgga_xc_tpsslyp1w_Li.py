...
def test_mgga_xc_tpsslyp1w_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.034340730986371e+00, -1.425697692064457e+00, -4.024408943337484e-01, -1.815505725590388e-01, -7.950298992028136e-02, -2.384904318627060e-02, -4.484473413197910e-04])
...
def test_mgga_xc_tpsslyp1w_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.481193976975682e+00, -2.483199996484361e+00, -1.778402341874489e+00, -1.779988371350260e+00, -4.428945708348844e-01, -4.439086755737135e-01, -2.192567702233132e-01, -1.204903826988055e-01, -7.794925082678848e-02, -4.259116523058908e-02, -3.166787726749169e-02, -3.156255780717258e-02, -6.193147838418892e-04, -5.368726579089803e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
