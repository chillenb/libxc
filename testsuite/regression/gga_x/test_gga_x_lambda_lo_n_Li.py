...
def test_gga_x_lambda_lo_n_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.794390152295906e+00, -1.283600144998251e+00, -4.160595595717208e-01, -1.600245812720761e-01, -8.050393831203528e-02, -2.054541146396936e-02, -3.838759960700823e-04])
