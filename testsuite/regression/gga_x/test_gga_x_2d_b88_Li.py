...
def test_gga_x_2d_b88_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-3.911513566737549e+00, -2.325519582615999e+00, -3.963996001024804e-01, -1.132423307659920e-01, -4.540466555149302e-02, -7.176648990972942e-02, -2.845462609622332e-02])
...
def test_gga_x_2d_b88_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-5.662119587688783e+00, -5.669927293987840e+00, -3.237260223828666e+00, -3.241465734491750e+00, -4.083529900082496e-01, -4.081790173105227e-01, -1.511870044430038e-01, -1.432309436697474e-02, -4.254690361408922e-02, -3.134122274337332e-03, -1.469951082384231e-02, -1.479468880848459e-02, -3.070304227635527e-03, -2.646697302620789e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
