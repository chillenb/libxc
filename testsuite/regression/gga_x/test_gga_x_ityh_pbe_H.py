...
def test_gga_x_ityh_pbe_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-4.555554925528068e-01, -4.048916225298282e-01, -1.891843563846040e-01, -1.055564175766020e-02, -1.234970096964348e-06]
...
def test_gga_x_ityh_pbe_H_2_vrho():
    ...
    ref_tgt = [-6.556676388512660e-01, 2.600400733225541e-17, -5.602639824587036e-01, -2.088455129566532e-16, -2.673613525203619e-01, -4.449679506540602e-17, -2.001576217979734e-02, -5.518993361232821e-18, -2.469754381809127e-06, 1.779471827407868e-22]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
