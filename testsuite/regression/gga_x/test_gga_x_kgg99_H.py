...
def test_gga_x_kgg99_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-5.823280762192744e-01, -5.484648579646536e-01, -3.491226706454594e-01, -1.573794606602811e-01, 2.071660745775305e-04]
...
def test_gga_x_kgg99_H_2_vrho():
    ...
    ref_tgt = [-7.749707615049871e-01, -2.380689221989511e-16, -6.633573905112378e-01, -3.517572849834282e-16, -3.647367471220935e-01, -1.449340321173858e-17, -9.470107289489245e-02, -2.838754459786543e-17, 2.762214359955256e-04, -2.609776596602565e-20]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
