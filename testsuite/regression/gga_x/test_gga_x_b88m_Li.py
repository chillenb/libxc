...
def test_gga_x_b88m_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.806548847707896e+00, -1.295672318220003e+00, -4.362276423346982e-01, -1.608261739518918e-01, -8.195840920201838e-02, -1.333226804661893e-01, -5.361494935528503e-02])
...
def test_gga_x_b88m_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.239080027379213e+00, -2.241199494007153e+00, -1.522142949061213e+00, -1.523500958966748e+00, -3.426130946717470e-01, -3.424959985217574e-01, -2.048451036587874e-01, -3.600704817022713e-02, -7.359324009240371e-02, -7.727024854237556e-03, -3.686432373956571e-02, -3.703763262131878e-02, -7.462904379212655e-03, -6.454223130829584e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
