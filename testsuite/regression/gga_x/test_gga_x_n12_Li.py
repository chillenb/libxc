...
def test_gga_x_n12_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.883343725746543e+00, -1.334755615519181e+00, -3.929303419444996e-01, -1.543917024838317e-01, -6.979365546232059e-02, -1.339978430693879e-02, -3.813347576241127e-04])
