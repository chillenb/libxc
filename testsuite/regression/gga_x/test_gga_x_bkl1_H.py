...
def test_gga_x_bkl1_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.226286043006586e-01, -6.058944809140545e-01, -4.042517560692773e-01, -1.538723326264232e-01, -4.101571076394583e-03]
...
def test_gga_x_bkl1_H_2_vrho():
    ...
    ref_tgt = [-8.274920485942753e-01, -6.618071898855587e-17, -6.859662965994736e-01, -1.917176857448182e-16, -3.663235772683844e-01, -1.391027420457566e-17, -2.037354371079692e-01, -7.000904758030024e-17, -5.469104096308115e-03, -3.539622183030311e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
