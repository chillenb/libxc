...
def test_gga_x_pbefe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.821207400434294e+00, -1.312280568891243e+00, -3.875235366456694e-01, -1.616004916209878e-01, -7.922717629405851e-02, -1.637252327396429e-02, -3.057678252181200e-04])
