...
def test_gga_x_pbetrans_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.795105210953902e+00, -1.285660751695045e+00, -4.450323821296815e-01, -1.600441864682590e-01, -8.310372455678466e-02, -2.065809966577179e-02, -3.859865135599423e-04])
