...
def test_gga_x_hjs_b88_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.717954109618783e+00, -1.200796887441963e+00, -3.340577015956990e-01, -1.052253100260016e-01, -2.668766095947228e-02, -1.183177689407661e-01, 0.000000000000000e+00])
...
def test_gga_x_hjs_b88_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-1.841317134702886e-04, 0.000000000000000e+00, -1.835124216293197e-04, -7.085454537475069e-04, 0.000000000000000e+00, -7.062983049082914e-04, -9.073699699435836e-02, 0.000000000000000e+00, -9.072558411681471e-02, -1.992837452918304e+00, 0.000000000000000e+00, -4.521667352607999e+03, -3.480816929728348e+01, 0.000000000000000e+00, 0.000000000000000e+00, -2.904496060746623e+03, 0.000000000000000e+00, -3.337044993092453e+03, 0.000000000000000e+00, 0.000000000000000e+00, 0.000000000000000e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
