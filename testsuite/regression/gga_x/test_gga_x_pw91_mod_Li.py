...
def test_gga_x_pw91_mod_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.802292281768179e+00, -1.290407603983884e+00, -4.191030146225423e-01, -1.605409548305722e-01, -8.051009952727987e-02, -3.174853753615858e-04, -4.457470496142169e-09])
