...
def test_gga_x_hcth_a_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.824151424638513e-01, -5.962003836204821e-01, -3.496448351465187e-01, -1.730242177328983e-01, -1.414649769628707e-01]
...
def test_gga_x_hcth_a_H_2_vrho():
    ...
    ref_tgt = [-9.114884169689813e-01, -7.775829933941734e-17, -8.141503057943221e-01, -2.093216493701156e-16, -4.374435485345093e-01, 4.680371955111937e-17, -2.904512603660843e-02, -9.863658283787037e-17, -2.670230287587340e-02, -1.407520518507138e-17]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
