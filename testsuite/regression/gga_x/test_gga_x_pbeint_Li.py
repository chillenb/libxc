...
def test_gga_x_pbeint_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.770282867310317e+00, -1.252985734009023e+00, -4.005040159911846e-01, -1.587027331996041e-01, -7.646046868558441e-02, -2.054447744523240e-02, -3.838586978687961e-04]
