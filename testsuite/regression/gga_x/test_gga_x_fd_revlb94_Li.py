...
def test_gga_x_fd_revlb94_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.789871420816002e+00, -1.280042904843905e+00, -5.134543437589503e-01, -1.603446541496591e-01, -8.632174534324567e-02, -1.805045259341135e+00, -3.750525449751413e+00])
...
def test_gga_x_fd_revlb94_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.243295836570098e+00, -2.245443087735829e+00, -1.509515739306659e+00, -1.510910639364221e+00, -1.237500883626320e-01, -1.228177075522562e-01, -2.055207330725236e-01, 1.057344459971963e+00, -5.351998535700343e-02, 1.051046953591922e+00, 1.039312245187890e+00, 1.063579189393912e+00, 1.192425359101189e+00, 1.115194252258477e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
