...
def test_gga_x_ityh_optx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-3.967756803109901e+00, -2.652293089856148e+00, -3.821988295307177e-01, -1.139664268576974e-01, -1.068279758218167e-02, -7.188245085305396e-05, -4.950644795794764e-10]
...
def test_gga_x_ityh_optx_Li_2_vrho():
    ...
    ref_tgt = [-5.230527879931643e+00, -5.235069756895559e+00, -3.607590257712104e+00, -3.610898511647862e+00, -5.988569923551561e-01, -5.984657358715240e-01, -1.941822175676734e-01, -1.248853405468680e-04, -2.071870681060199e-02, -3.999971706892925e-09, -1.451576994621207e-04, -1.420225352958896e-04, -1.191997183069890e-09, -4.282693416971015e-10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
