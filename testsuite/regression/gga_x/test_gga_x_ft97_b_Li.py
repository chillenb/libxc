...
def test_gga_x_ft97_b_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.788665298481220e+00, -1.278408096940544e+00, -4.689994942217263e-01, -1.597140804304665e-01, -8.411608302516130e-02, -1.416958137514063e-01, -5.549363010696781e-02])
...
def test_gga_x_ft97_b_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.244514804218471e+00, -2.246660697478437e+00, -1.512020266296748e+00, -1.513411383053372e+00, -2.867836328249905e-01, -2.867666540814990e-01, -2.055887635830687e-01, -4.128427773298325e-02, -6.296232835072547e-02, -8.315552029989718e-03, -4.237006295559853e-02, -4.252240592006448e-02, -7.999542530343944e-03, -6.905651943529886e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
