...
def test_gga_x_pbepow_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.796926167107225e+00, -1.290468594455765e+00, -4.465868300587331e-01, -1.601037247982297e-01, -8.588137267458233e-02, -2.055061142898511e-02, -3.838587912306229e-04])
...
def test_gga_x_pbepow_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.232735658577486e+00, -2.234895235573318e+00, -1.493020201721337e+00, -1.494423495633903e+00, -4.434647759773491e-01, -4.438440730767789e-01, -2.049987595271397e-01, -2.613718363011415e-02, -7.486501727613304e-02, -8.296450600378438e-04, -2.748237701140453e-02, -2.728371318618403e-02, -5.541559657459855e-04, -3.939544285007911e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
