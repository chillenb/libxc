...
def test_gga_x_optb88_vdw_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.789781105497965e+00, -1.274825708745828e+00, -4.086216391230124e-01, -1.598791251652218e-01, -7.798897094991206e-02, -1.159758941648124e-01, -4.610685898715405e-02])
...
def test_gga_x_optb88_vdw_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.255220092324656e+00, -2.257335252823017e+00, -1.538690496770865e+00, -1.540053626272181e+00, -3.439275264074395e-01, -3.437888651727409e-01, -2.058482254177222e-01, -3.265251948050180e-02, -7.452249775509283e-02, -6.700596473818025e-03, -3.347213768413099e-02, -3.361038443682237e-02, -6.454101579909755e-03, -5.575687921099839e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
