...
def test_gga_x_vmt84_pbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.794886727759138e+00, -1.284874947665236e+00, -4.308220838761798e-01, -1.600371169640247e-01, -8.190043907451384e-02, -9.314659151975629e-03, -6.423415171602323e-11])
