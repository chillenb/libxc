...
def test_gga_x_hjs_pbe_sol_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.707734201957082e+00, -1.189223367586742e+00, -3.214798575516389e-01, -1.047901905109490e-01, -2.588263043172699e-02, -3.382975786530186e-04, -1.636588659304272e-09])
