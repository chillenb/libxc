...
def test_gga_x_airy_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.215766116602851e-01, -5.543795861143498e-01, -3.305524432496381e-01, -1.203007218929786e-01, -3.929670400707882e-02]
...
def test_gga_x_airy_H_2_vrho():
    ...
    ref_tgt = [-8.289374585025269e-01, -1.084702196749642e-16, -7.385024759999679e-01, -1.889762048844721e-16, -4.034994681409911e-01, 2.943215011961694e-17, -9.692593085020201e-02, -5.044780559585815e-17, -9.855366976960730e-03, -4.770505059840833e-18]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
