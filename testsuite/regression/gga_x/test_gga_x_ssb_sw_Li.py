...
def test_gga_x_ssb_sw_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.831141672859305e+00, -1.286643479472680e+00, -4.161010870154249e-01, -1.651668092476625e-01, -8.052780026924379e-02, -2.054423373337063e-02, -3.838584531770702e-04]
