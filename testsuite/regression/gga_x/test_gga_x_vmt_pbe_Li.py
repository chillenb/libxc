...
def test_gga_x_vmt_pbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.794844335692114e+00, -1.284786785034670e+00, -4.294802992820262e-01, -1.600360684953139e-01, -8.179984655842720e-02, -1.140169316237562e-02, -2.127820881496785e-04]
...
def test_gga_x_vmt_pbe_Li_2_vrho():
    ...
    ref_tgt = [-2.240885954987007e+00, -2.243024015732266e+00, -1.514718980851490e+00, -1.516093135321285e+00, -3.865243503057760e-01, -3.867364661557853e-01, -2.052543973939975e-01, -1.457374231382936e-02, -7.368365447798923e-02, -4.598929181543204e-04, -1.540893048609124e-02, -1.525323445524431e-02, -3.071820507310970e-04, -2.183783727950879e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
