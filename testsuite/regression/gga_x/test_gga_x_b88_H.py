...
def test_gga_x_b88_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.221360513556216e-01, -5.801981780538151e-01, -3.614393944401555e-01, -1.470310491212401e-01, -5.949944337451282e-02]
...
def test_gga_x_b88_H_2_vrho():
    ...
    ref_tgt = [-8.281519729546887e-01, -4.505804617919519e-17, -7.188560590935401e-01, -2.384731682985170e-16, -4.046565334147572e-01, 1.523414843467698e-17, -1.040725690126497e-01, -8.145563390778286e-17, -1.517293996076435e-02, -1.494580917562652e-18]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
