...
def test_gga_x_eb88_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.799237929095074e+00, -1.287005750504451e+00, -4.288588795724324e-01, -1.604053559271746e-01, -8.069252657933322e-02, -1.331034729576340e-01, -5.361315485905242e-02])
