...
def test_gga_x_b88_6311g_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.814527227624112e+00, -1.304959395854140e+00, -4.433742134121196e-01, -1.612902298644427e-01, -8.322269386363011e-02, -1.335158913062690e-01, -5.361652579338440e-02])
