...
def test_gga_x_b86_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.798814235449836e+00, -1.289905741930406e+00, -4.336666063285744e-01, -1.602559205577097e-01, -8.262002492592530e-02, -2.239977711651121e-02, -4.185836410040993e-04])
