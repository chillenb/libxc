...
def test_gga_x_beefvdw_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.841398169795189e+00, -1.318249083232812e+00, -4.633862659538325e-01, -1.645702490219179e-01, -8.713616966269781e-02, -2.129879106124885e-02, -3.978661426364077e-04])
