...
def test_gga_x_ssb_d_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.882744714255456e+00, -1.341446861531542e+00, -4.379162486170957e-01, -1.674803958659026e-01, -8.198138082369380e-02, -2.054643184354645e-02, -3.838586620717250e-04])
...
def test_gga_x_ssb_d_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.436899285180764e+00, -2.439398114114784e+00, -1.531438274499287e+00, -1.533135487244578e+00, -4.130526804388020e-01, -4.132441388382551e-01, -2.276011930624341e-01, -2.611913575899812e-02, -7.732467968109337e-02, -8.296434795043973e-04, -2.746122741616271e-02, -2.726371534534610e-02, -5.541555211040217e-04, -3.939541765597661e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
