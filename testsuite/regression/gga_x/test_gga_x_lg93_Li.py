...
def test_gga_x_lg93_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.781484886198315e+00, -1.282574809452178e+00, -4.197106094618034e-01, -1.591097018578452e-01, -8.224432487263038e-02, -4.119180478082922e-02, -2.163640711066722e-03]
...
def test_gga_x_lg93_Li_2_vrho():
    ...
    ref_tgt = [-2.229524626815494e+00, -2.231769726554365e+00, -1.439865232693390e+00, -1.441295039945973e+00, -4.161825288411279e-01, -4.161966554577296e-01, -2.056105611411315e-01, -3.720432544894249e-02, -8.197814309153684e-02, -2.946296052445107e-03, -3.849428990640659e-02, -3.849360238033492e-02, -2.344521417220034e-03, -1.848610873526514e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
