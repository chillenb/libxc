...
def test_gga_x_sogga_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.769438598058587e+00, -1.250780953300703e+00, -3.787548684302743e-01, -1.586750795982348e-01, -7.418432382929400e-02, -1.768010207612664e-02, -3.302377215401792e-04])
