...
def test_gga_x_hcth_a_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.858850379993745e+00, -1.283578824922108e+00, -4.583074910332054e-01, -1.692774871395018e-01, -7.873364389810000e-02, -3.119533726723810e-01, -1.343098208280208e-01])
