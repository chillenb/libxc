...
def test_gga_x_bcgp_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.801845142971644e+00, -1.293156238866647e+00, -4.232754336767574e-01, -1.604319918000603e-01, -8.198860695343792e-02, -2.054595212136102e-02, -3.838587202672339e-04]
...
def test_gga_x_bcgp_Li_2_vrho():
    ...
    ref_tgt = [-2.234434840868734e+00, -2.236571723870413e+00, -1.510616759762293e+00, -1.511982146604556e+00, -4.126925583306000e-01, -4.128950725330600e-01, -2.048241155899875e-01, -2.612086393062142e-02, -7.743374434527453e-02, -8.296437354427622e-04, -2.746325152792056e-02, -2.726562968526569e-02, -5.541556341433909e-04, -3.939542469250965e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
