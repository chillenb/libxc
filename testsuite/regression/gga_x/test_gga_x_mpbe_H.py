...
def test_gga_x_mpbe_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.220351053607058e-01, -5.776649919948096e-01, -3.601522733099099e-01, -1.377016174987226e-01, -7.339167550928664e-03]
...
def test_gga_x_mpbe_H_2_vrho():
    ...
    ref_tgt = [-8.282813511647703e-01, 1.295108869065993e-17, -7.181511269947538e-01, -1.277561299171034e-16, -3.991411376122803e-01, 8.907389546102680e-18, -1.413428131502964e-01, -5.401776371403133e-17, -9.782821581533501e-03, -8.650979878654357e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
