...
def test_gga_x_sogga_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.218547197390710e-01, -5.688986803859855e-01, -3.457801960742267e-01, -1.219086564389054e-01, -6.364533093860246e-03]
...
def test_gga_x_sogga_H_2_vrho():
    ...
    ref_tgt = [-8.285214300987612e-01, -1.167723852412438e-16, -7.286652927805551e-01, -1.753243698619074e-16, -4.126428043345029e-01, -1.736518038123264e-17, -1.278076309881964e-01, -5.745092824953500e-17, -8.483141734585030e-03, -6.379559901507060e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
