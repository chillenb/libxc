...
def test_gga_x_bkl2_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.764420970400042e+00, -1.244513558228558e+00, -3.872032759935986e-01, -1.583965992088430e-01, -7.396156117999916e-02, -1.140066209733568e-02, -2.127820881496785e-04])
