...
def test_gga_x_sg4_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.800599950250208e+00, -1.287282114155849e+00, -3.983443701992958e-01, -1.604500394029768e-01, -7.764139326757738e-02, -2.055572349606353e-02, -3.838588695208896e-04])
