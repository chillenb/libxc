...
def test_gga_x_optx_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.833640870733615e+00, -1.287885778807687e+00, -4.725759945629842e-01, -1.652478579200030e-01, -8.352300996006172e-02, -2.947903197691907e-02, -5.511246082170061e-04])
