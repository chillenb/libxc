...
def test_gga_x_b88m_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.221725377995588e-01, -5.815972737684227e-01, -3.632786578551815e-01, -1.483734583305738e-01, -5.953865313870006e-02]
...
def test_gga_x_b88m_H_2_vrho():
    ...
    ref_tgt = [-8.281042025927954e-01, 5.536744461435570e-18, -7.177637461752068e-01, -2.746069765311492e-16, -4.040387652672917e-01, -5.865209002896391e-18, -1.053587664186709e-01, -5.921370090707260e-17, -1.523899846503237e-02, -1.743372129172939e-18]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
