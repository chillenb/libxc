...
def test_gga_x_lv_rpw86_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.762250246967406e+00, -1.241864682711432e+00, -4.073163055143236e-01, -1.582882636182263e-01, -7.455575297422203e-02, -4.918352573946064e-02, -3.814340998249729e-03]
...
def test_gga_x_lv_rpw86_Li_2_vrho():
    ...
    ref_tgt = [-2.279073534166326e+00, -2.281190070092713e+00, -1.558080833422335e+00, -1.559463212284620e+00, -2.723224889488571e-01, -2.726804516994477e-01, -2.074343592266472e-01, -3.848088253570509e-02, -6.604147093119192e-02, -3.991677138757686e-03, -3.963880861634144e-02, -3.971677892849024e-02, -3.234305074551117e-03, -2.542679096333791e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
