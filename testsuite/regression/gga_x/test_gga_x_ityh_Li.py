...
def test_gga_x_ityh_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.685917512975307e+00, -1.170119054921031e+00, -2.609141721466337e-01, -7.323555238178965e-02, -9.812870377883027e-03, -7.206693265920491e-05, -4.950651026357798e-10]
...
def test_gga_x_ityh_Li_2_vrho():
    ...
    ref_tgt = [-2.140284167736527e+00, -2.142389442800043e+00, -1.429789126503317e+00, -1.431134822069540e+00, -2.885981646780387e-01, -2.885397870588355e-01, -1.151675796596350e-01, -1.252355610314151e-04, -1.785137542625547e-02, -3.999987436450727e-09, -1.455995262028283e-04, -1.424521839012475e-04, -1.191999292489478e-09, -4.282697259569788e-10]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
