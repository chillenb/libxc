...
def test_gga_x_sfat_pbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.590267423842571e+00, -1.079254281057896e+00, -1.993356395492061e-01, -5.473883648820900e-02, -7.500326800519080e-03, -5.914124656723177e-05, -4.091434833117526e-10])
...
def test_gga_x_sfat_pbe_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.056307217652926e+00, -2.058405387459034e+00, -1.349410434134879e+00, -1.350743533171446e+00, -2.585660501456384e-01, -2.585583803770857e-01, -8.783664923070868e-02, -1.026508006866747e-04, -1.335245343514099e-02, -3.305743452137759e-09, -1.192459823862101e-04, -1.166805663088918e-04, -9.851192069848016e-10, -3.539411631185194e-10])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
