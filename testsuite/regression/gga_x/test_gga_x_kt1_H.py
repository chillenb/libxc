...
def test_gga_x_kt1_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.221131169032341e-01, -5.785536636528638e-01, -3.349604197098459e-01, -8.726227791301532e-02, -4.101589095587792e-03])
...
def test_gga_x_kt1_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-8.283951297344117e-01, -1.126140149090695e-16, -7.272756284696048e-01, -2.165673699569037e-16, -4.331127031663195e-01, -1.102495747423006e-18, -1.160831794100329e-01, -3.693591097067323e-17, -5.468747981385866e-03, -1.233551026296600e-19])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
