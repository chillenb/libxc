...
def test_gga_x_pbe_sol_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.769511365532051e+00, -1.250974826063028e+00, -3.829031445540636e-01, -1.586782740380967e-01, -7.446002830672675e-02, -2.053487612911458e-02, -3.838585506946353e-04])
