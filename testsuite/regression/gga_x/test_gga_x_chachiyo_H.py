...
def test_gga_x_chachiyo_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.221603087702338e-01, -5.797307337689652e-01, -3.608720717339752e-01, -1.548336621740331e-01, -8.273537407030712e-02]
...
def test_gga_x_chachiyo_H_2_vrho():
    ...
    ref_tgt = [-8.281386310693509e-01, 1.946495311414801e-18, -7.197774395762869e-01, -2.315769328756017e-16, -4.035268421943612e-01, -6.052032138283361e-17, -8.870777890929003e-02, -6.841803940968695e-17, -2.054872636622185e-02, -1.511258722176309e-18]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
