...
def test_gga_x_pw91_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.802292587779567e+00, -1.290406189213285e+00, -4.190057744484081e-01, -1.605410020570628e-01, -8.050461088072250e-02, -3.150226553409883e-04, -4.422816966140539e-09]
