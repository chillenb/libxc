...
def test_gga_x_pw86_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.217901718216854e-01, -5.760617576782532e-01, -3.662704971984817e-01, -1.372078475364612e-01, -1.995783335803571e-02])
...
def test_gga_x_pw86_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-8.285939263051959e-01, -6.466583167072988e-17, -7.020406379114308e-01, -2.223063962950696e-16, -3.883609919936109e-01, 5.165441107798378e-17, -1.321014663407949e-01, -5.505120096047750e-17, -1.601898512431819e-02, -2.856333925360420e-18])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
