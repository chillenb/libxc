...
def test_gga_x_rpbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.795621817795890e+00, -1.286840269641162e+00, -4.516234599031203e-01, -1.600634888252786e-01, -8.412448185373707e-02, -2.055687026651119e-02, -3.838588870220200e-04])
