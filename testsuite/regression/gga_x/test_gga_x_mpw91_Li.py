...
def test_gga_x_mpw91_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.803161180378499e+00, -1.291531724171503e+00, -4.269782749780079e-01, -1.605899506406449e-01, -8.102415734011781e-02, -1.712075558589937e-03, -6.560044018923878e-08])
