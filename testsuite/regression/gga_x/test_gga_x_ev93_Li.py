...
def test_gga_x_ev93_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.785084672209537e+00, -1.286844622306498e+00, -5.259702703760052e-01, -1.592008331514968e-01, -9.404529436798273e-02, -1.772601304563659e-02, -3.281529986071412e-04])
...
def test_gga_x_ev93_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.217960003638580e+00, -2.220190130469353e+00, -1.444206980016660e+00, -1.445662103434581e+00, -3.909022591275487e-01, -3.917526518978740e-01, -2.050562344769761e-01, -2.289392209090059e-02, -5.824700912231676e-02, -7.092864029373260e-04, -2.413731345351567e-02, -2.393292327848781e-02, -4.737445203434044e-04, -3.367859525695424e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
