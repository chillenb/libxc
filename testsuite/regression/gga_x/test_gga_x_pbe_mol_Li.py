...
def test_gga_x_pbe_mol_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.808557208788272e+00, -1.301675968127581e+00, -4.290424040396070e-01, -1.608003857945516e-01, -8.322432598882758e-02, -2.054701298665067e-02, -3.838587364874669e-04])
...
def test_gga_x_pbe_mol_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.227255292673350e+00, -2.229394434533376e+00, -1.503575176561923e+00, -1.504936682005551e+00, -4.230761225852329e-01, -4.232957544970982e-01, -2.043905971784653e-01, -2.612457953552514e-02, -7.847216577635698e-02, -8.296440358997409e-04, -2.746760587137359e-02, -2.726974682921844e-02, -5.541557105367900e-04, -3.939542797631680e-04])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
