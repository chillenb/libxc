...
def test_gga_x_lsrpbe_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.795474778064990e+00, -1.286434386283164e+00, -4.408493459406833e-01, -1.600524121255813e-01, -8.341539690077332e-02, -2.229214849805885e-10, 0.000000000000000e+00]
