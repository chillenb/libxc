...
def test_gga_x_s12g_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.811056432974672e+00, -1.280861061896330e+00, -4.262256770678194e-01, -1.631265034676636e-01, -8.291746842193241e-02, -2.001293290238877e-02, -3.738580011480452e-04])
