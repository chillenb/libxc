...
def test_gga_x_ssb_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.871167062762021e+00, -1.334203172828440e+00, -4.206537677214646e-01, -1.659713098286200e-01, -7.831759138568378e-02, -2.054145939410726e-02, -3.838589125278786e-04])
...
def test_gga_x_ssb_Li_2_vsigma():
    ...
    ref_tgt = numpy.asarray([-1.378373126963095e-04, 0.000000000000000e+00, -1.369474063356403e-04, -1.353069541537172e-03, 0.000000000000000e+00, -1.347383145144583e-03, -9.480740481542441e-02, 0.000000000000000e+00, -9.466954657244422e-02, 2.302350713241714e+00, 0.000000000000000e+00, -3.967298811868181e-01, -6.118378279723761e+01, 0.000000000000000e+00, -2.403930104917542e+00, -4.027054660267887e-01, 0.000000000000000e+00, -3.777484784592750e-01, -1.756850002646122e+00, 0.000000000000000e+00, -2.503849358375010e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
