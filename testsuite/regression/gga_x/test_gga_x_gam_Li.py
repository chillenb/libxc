...
def test_gga_x_gam_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.946290780393604e+00, -1.351315737322114e+00, -4.372124873461359e-01, -1.832397330986335e-01, -7.019184116526883e-02, -5.648189427750568e-02, -1.079832553922620e-03])
...
def test_gga_x_gam_Li_2_vrho():
    ...
    ref_tgt = numpy.asarray([-2.672499694784970e+00, -2.675100027253914e+00, -1.778045355686204e+00, -1.779752901839821e+00, -1.192718848996661e-01, -1.178895166708977e-01, -2.386297879113820e-01, -7.106275610958734e-02, -9.700940762148084e-02, -2.332820012457109e-03, -7.454715737260705e-02, -7.406565720442848e-02, -1.558662561343970e-03, -1.108255323431368e-03])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
