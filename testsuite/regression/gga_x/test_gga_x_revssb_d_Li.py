...
def test_gga_x_revssb_d_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.887625499846360e+00, -1.341834901975175e+00, -4.304992304220207e-01, -1.683582890406738e-01, -8.139789028453875e-02, -2.054512430528483e-02, -3.838585467975121e-04]
...
def test_gga_x_revssb_d_Li_2_vrho():
    ...
    ref_tgt = [-2.446492648611130e+00, -2.448966325451823e+00, -1.560578964339051e+00, -1.562237646112697e+00, -4.097258317393199e-01, -4.098811081208936e-01, -2.274419034076523e-01, -2.611531237463836e-02, -7.832640298379370e-02, -8.296429588359809e-04, -2.745674817514866e-02, -2.725947951057180e-02, -5.541553011545962e-04, -3.939540422767455e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
