...
def test_gga_x_gg99_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.137256716342201e-01, -5.766173936234114e-01, -3.655889766253873e-01, -1.617769094388917e-01, 0.000000000000000e+00])
...
def test_gga_x_gg99_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-8.168342220582482e-01, -2.421254032745716e-16, -7.008941047229150e-01, -3.508309892348804e-16, -3.866918217619978e-01, -1.444211996919331e-17, -1.005643379330471e-01, -2.864274407949880e-17, 0.000000000000000e+00, 0.000000000000000e+00])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
