...
def test_gga_x_pbeint_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-6.218548370736585e-01, -5.692130329757759e-01, -3.472732699552213e-01, -1.313555070676623e-01, -7.396528183270574e-03]
...
def test_gga_x_pbeint_H_2_vrho():
    ...
    ref_tgt = [-8.285209612201281e-01, 5.220112136182131e-17, -7.274780824521015e-01, 1.413736516187801e-16, -4.076647123937560e-01, -2.312518421305014e-16, -1.262514184226576e-01, -7.480113047142533e-17, -9.855217659232961e-03, -4.214778676823770e-19]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
