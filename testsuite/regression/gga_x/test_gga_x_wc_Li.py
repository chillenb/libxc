...
def test_gga_x_wc_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.791103110422692e+00, -1.275709954875462e+00, -3.966051145161323e-01, -1.599165531281650e-01, -7.645375561287858e-02, -2.053557401639712e-02, -3.838585507159015e-04]
...
def test_gga_x_wc_Li_2_vrho():
    ...
    ref_tgt = [-2.254333605525768e+00, -2.256441176890871e+00, -1.543946033934467e+00, -1.545294023215452e+00, -3.523643564080611e-01, -3.523753953107210e-01, -2.057142627652462e-01, -2.608559348087644e-02, -7.633541634299107e-02, -8.296405959784656e-04, -2.742228509965085e-02, -2.722673549742257e-02, -5.541548356679115e-04, -3.939539036692309e-04]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
