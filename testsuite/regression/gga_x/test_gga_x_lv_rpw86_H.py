...
def test_gga_x_lv_rpw86_H_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-6.218001155456225e-01, -5.664288214758859e-01, -3.424059861944526e-01, -1.381627413277570e-01, -1.969758250338571e-02])
...
def test_gga_x_lv_rpw86_H_2_vrho():
    ...
    ref_tgt = numpy.asarray([-8.285939224027405e-01, -9.567176417111014e-17, -7.311288355591808e-01, -2.800216303510097e-16, -4.129986553220240e-01, 2.330895616006498e-17, -1.196238516967727e-01, -5.064639894749758e-17, -1.583649350337168e-02, -1.368466877415612e-18])
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
