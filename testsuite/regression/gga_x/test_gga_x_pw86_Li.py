...
def test_gga_x_pw86_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-1.788659607193134e+00, -1.293191982933969e+00, -4.224726023436478e-01, -1.591917603136986e-01, -8.242583765267496e-02, -4.981568975466691e-02, -3.866713786712611e-03]
...
def test_gga_x_pw86_Li_2_vrho():
    ...
    ref_tgt = [-2.196396791857767e+00, -2.198624723982786e+00, -1.456723333474594e+00, -1.458056372386369e+00, -4.107347600946448e-01, -4.107473670984644e-01, -2.040379408901762e-01, -3.887821697466316e-02, -8.121007642257914e-02, -4.046451166911972e-03, -4.003357148883172e-02, -4.011903588462037e-02, -3.278704769482822e-03, -2.577587840211097e-03]
    error = numpy.max(numpy.abs(tgt-ref_tgt))/(1.0+numpy.max([numpy.abs(tgt), numpy.abs(ref_tgt)]))
    assert error < 5e-05
