...
def test_gga_x_q1d_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.739167484982684e+00, -1.129906558229384e+00, -7.953235367639281e-03, -1.582188126356061e-01, -6.809903541078323e-03, -2.747492035203748e-07, -4.191278198031468e-12])
