...
def test_lda_xc_gdsmfb_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.824102284628247e+00, -1.285156292748977e+00, -3.388008446267026e-01, -1.749223334171319e-01, -7.323877188498651e-02, -1.820599182080379e-02, -3.791920361842860e-04])
