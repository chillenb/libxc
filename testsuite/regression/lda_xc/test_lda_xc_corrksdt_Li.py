...
def test_lda_xc_corrksdt_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-1.823552518556801e+00, -1.284773088203150e+00, -3.387468890046067e-01, -1.749552528185666e-01, -7.322549592417335e-02, -1.820342299305641e-02, -3.744627435232740e-04])
