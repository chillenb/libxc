...
def test_lda_xc_lp_b_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = numpy.asarray([-2.025080255824628e+00, -1.427410335156581e+00, -3.519563486289996e-01, -2.025040678013933e-04, -4.122254572956769e-08, -1.397180983871876e-02, -1.932726656087427e-04])
