...
def test_lda_xc_lp_a_Li_2_zk():
    ...
    tgt = out["zk"].flatten()
    ref_tgt = [-2.027726033610240e+00, -1.407800554977624e+00, -3.379834661787608e-01, -1.935186330097218e-04, -3.930556726102178e-08, -1.330703261947269e-02, -1.840154599238317e-04]
